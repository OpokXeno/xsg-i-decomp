...
/*
 * Public declarations of the translation unit main/tu219 (src/main/m_math.c):
...
/* canon: config/header-canon.json chose src/main/m_math.c over 2 other accepted spellings */
/*
