...
class ST0600
    ...
    public void KickEvent(int n, int n2) {
        ...
        switch (n2) {
            ...
            case 2: {
                ...
                if (Runtime.getFlags(7142, 1) == 1) {
                    return;
                }
                if (Runtime.getFlags(7142, 1) == 0) {
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                if (this.S2030 == 1) {
                    Runtime.jumpCF(520, 5);
                    break;
                }
                if (this.S2028 == 1) {
                    Runtime.jumpCF(670, 5);
                    break;
                }
                Runtime.jumpCF(520, 5);
                break;
            ...
            case 1: {
                if (this.S2030 == 1) {
                    Runtime.jumpCF(520, 6);
                    break;
                }
                if (this.S2028 == 1) {
                    Runtime.jumpCF(670, 6);
                    break;
                }
                Runtime.jumpCF(520, 6);
                break;
    ...
    class NPC_NORMAL
        ...
        void ANNAI() {
            ...
            Runtime.setPlayerControl(false);
            Runtime.enable(65536);
            ST0600.this.cam0.setMode(-1);
            ST0600.this.EV_Camera01();
            ST0600.this.npc10.kickEnepc(0, 9);
            ST0600.this.npc6.kickEnepc(1, 27);
            ST0600.this.npc7.kickEnepc(1, 27);
            ST0600.this.npc6.setVisible(true);
            ST0600.this.npc7.setVisible(true);
            ST0600.this.npc10.setVisible(true);
            System.sleep(10);
            ST0600.this.win = Window.create();
            ST0600.this.win.setSize(4, 45);
            ST0600.this.win.setLocation(15, 305);
            ST0600.this.win.print(ST0600.this.msg0436E842, 0);
            ST0600.waitPage(ST0600.this.win, 64);
            ST0600.this.npc10.moveEnepc(17, 240.0f, 0.1f, 20);
            ST0600.this.win.print(ST0600.this.msg1436E842, 0);
            ST0600.waitPage(ST0600.this.win, 64);
            ST0600.this.npc6.moveEnepc(17, 100.0f, -0.1f, 20);
            ST0600.this.npc6.kickEnepc(1, 10);
            ST0600.this.win.print(ST0600.this.msg0436E843, 0);
            ST0600.waitPage(ST0600.this.win, 64);
            ST0600.this.npc10.kickEnepc(0, 10);
            ST0600.this.win.print(ST0600.this.msg0436E844, 0);
            ST0600.waitPage(ST0600.this.win, 64);
            ST0600.this.npc6.kickEnepc(0, 9);
            ST0600.this.win.print(ST0600.this.msg1436E844, 0);
            ST0600.waitPage(ST0600.this.win, 64);
            ST0600.this.npc10.kickEnepc(0, 9);
            ST0600.this.win.print(ST0600.this.msg0436E845, 0);
            ST0600.waitPage(ST0600.this.win, 64);
            ST0600.this.npc6.kickEnepc(0, 9);
            ST0600.this.win.print(ST0600.this.msg0436E846, 0);
            ST0600.waitPage(ST0600.this.win, 64);
            System.sleep(10);
            ST0600.this.fade.call(0);
            System.sleep(30);
            ST0600.this.npc6.setVisible(false);
            ST0600.this.npc7.setVisible(false);
            ST0600.this.npc10.setVisible(false);
            ST0600.this.npc11.setVisible(false);
            ST0600.this.player.setTranslate(0.28f, 0.0f, -0.17f);
            ST0600.this.cam0.setMode(0);
            System.sleep(10);
            ST0600.this.win = Window.create();
            ST0600.this.win.print(ST0600.this.msgoyasumi, 0);
            System.waitFor(ST0600.this.win);
            ST0600.this.menu = Menu.create();
            ST0600.this.menu.addItem("Yeah, I'm a little sleepy\nNo, I have to show them around properly");
            System.waitFor(ST0600.this.menu);
            ST0600.this.selected = ST0600.this.menu.getSelected();
            switch (ST0600.this.selected) {
                case 0: {
                    ST0600.this.win = Window.create();
                    ST0600.this.win.print(ST0600.this.msgoyasumi2, 0);
                    ST0600.waitPage(ST0600.this.win, 64);
                    ST0600.this.fade.call(0);
                    System.sleep(33);
                    Runtime.disable(65536);
            ...
            ST0600.this.win = Window.create();
            ST0600.this.win.print(ST0600.this.msgoyasumi3, 0);
            ST0600.waitPage(ST0600.this.win, 64);
            Runtime.disable(65536);
            Runtime.setPlayerControl(true);
        }
