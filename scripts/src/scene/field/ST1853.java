...
class ST1853
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(1773, 1);
                break;
            }
            case 1: {
                Runtime.jumpCF(1773, 2);
                break;
            }
        }
    }
    ...
    class Mapunits
        ...
        void Chijimi() {
            int n = 0;
            ST1853.this.Step.getTranslate();
            while (true) {
                if (n >= 0 && n < 60) {
                    ST1853.this.Step.setTranslate(ST1853.this.Step.px + 0.016666668f, ST1853.this.Step.py, ST1853.this.Step.pz);
                }
                if (n == 60) break;
                ++n;
                System.sleep(1);
        ...
        void Evt() {
            ...
            Runtime.disable(524288);
            Runtime.setPlayerControl(false);
            ST1853.this.EXP0.setTranslate(-13.0f, -1.0f, -45.0f);
            ST1853.this.cam0.setMode(-1);
            Sound.effectPlay(196742);
            ST1853.this.EV_Camera01();
            System.sleep(1);
            ST1853.this.EXP0.kickEnepc(4, 1);
            ST1853.this.win = Window.create();
            ST1853.this.win.setSize(4, 45);
            ST1853.this.win.setLocation(15, 305);
            ST1853.this.win.print("Park");
            int n = 0;
            int n2 = 150;
            float f = -45.0f;
            ...
            while (n < n2) {
                ...
                ST1853.this.EXP0.getTranslate();
                ST1853.this.EXP0.setTranslate(ST1853.this.EXP0.px, ST1853.this.EXP0.py, ST1853.this.EXP0.pz + f3);
                ++n;
                System.sleep(1);
            }
            ST1853.this.win.close();
            ST1853.this.player.setLocation(1, 3);
            ST1853.this.EXP0.kickEnepc(0, 1);
            ST1853.this.Step.start(1, "Nobi");
            System.sleep(30);
            ST1853.this.doorA.DoorOpen();
            System.sleep(15);
            ST1853.this.EXP0.kickEnepc(3, 1, 45, 45, 1, 100);
            Runtime.enable(65536);
            ST1853.this.player.mtn(2, 9, 1.0f, true);
            ST1853.this.player.move(90, -7.0f, -1.0f, true);
            System.sleep(30);
            ST1853.this.Step.start(1, "Chijimi");
            ST1853.this.EXP0.kickEnepc(0, 2);
            System.sleep(45);
            ST1853.this.EXP0.kickEnepc(4, 0);
            ST1853.this.EXP0.kickEnepc(4, 2);
            ST1853.this.doorA.DoorClose();
            System.sleep(15);
            Runtime.disable(65536);
            System.sleep(15);
            ST1853.this.cam0.setMode(0);
