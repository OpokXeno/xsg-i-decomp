...
class ST0541
    ...
    String[] msg011CB2F8 = new String[]{"No, I'll be fine. I may not look it, but I did develop KOS-MOS after all! A problem or two on a passenger-cargo ship should be a piece of cake, you know?", "/[waitkey(64)]/[clear()]"};
    ...
    String[] msg0107DF99 = new String[]{"/[label(Ziggy)]", "The enemy units that invaded the ship are the U-TIC Organization's Auto-Techs. Basically, they're unmanned craft. We escaped from their base, and they are the last of pursuit. Unfortunately, the mother ship has a transport system. The combat units will continue to arrive unless we destroy the mother ship.", "/[waitkey(64)]/[clear()]"};
    ...
    String[] msgkankin1 = new String[]{"/[label(Shion)]", "There's no time to lose. We have to hurry to the maintenance lab.", "/[waitkey(64)]/[close()]"};
    String[] msgkankin2 = new String[]{"/[label(chaos)]", "There's no time to lose. Let's hurry to the maintenance lab.", "/[waitkey(64)]/[close()]"};
    String[] msgkankin3 = new String[]{"/[label(MOMO)]", "We have to meet up with KOS-MOS quickly. Umm, the maintenance lab is...", "/[waitkey(64)]/[close()]"};
    String[] msgkankin4 = new String[]{"/[label(Ziggy)]", "We don't have much time. We must hurry to the maintenance lab.", "/[waitkey(64)]/[close()]"};
    String[] msgkankin5 = new String[]{"/[label(Jr.)]", "There's no time to lose. We have to find KOS-MOS.", "/[waitkey(64)]/[close()]"};
    ...
    void init() {
        ...
        if (Runtime.getFlags(7154, 1) == 1) {
            this.npc21 = new NPC_NORMAL(3, 21, 0, 14, 3, 100.0f, 100.0f, 100.0f, 0.0f);
            this.npc21.talkto("TalkNPC21");
            this.npc21.setInvalidID(1);
            this.npc21.disableDTKFlag(131072);
            this.npc21.disableDTKFlag(8);
            this.npc21.start(1, "kankin");
        }
    }
    ...
    class Obj
        ...
        void Up() {
            ST0541.this.cam0.setMode(-1);
            ST0541.this.EV_Camera04();
            Runtime.setPlayerControl(false);
            ST0541.this.player.setTranslate(-10.5f, 5.5f, 0.0f);
            Sound.effectPlay(196745);
            ST0541.this.ele.setArgs(4, 100.0f);
            ST0541.this.ele.setArgs(12, 5.0f);
            System.sleep(1);
            ST0541.this.ele.setArgs(4, 0.083333336f);
            ST0541.this.ele.setArgs(12, 0.0f);
            ST0541.this.doorR2.start(1, "MoveU");
            System.sleep(90);
            Sound.effectPlay(196713);
            ST0541.this.doormove = 1;
            System.sleep(40);
            Runtime.enable(65536);
            ST0541.this.player.mtn(2, 9, 1.0f, true);
            ST0541.this.player.move(30, -8.0f, 0.0f, true);
            System.sleep(35);
            Runtime.disable(65536);
            Runtime.setFlags(3039, 1, 0);
            ST0541.this.cam0.setMode(0);
            ST0541.this.epass = 1;
            Runtime.setPlayerControl(true);
        }
    }
    ...
    class NPC_NORMAL
        ...
        void kankin() {
            ...
            if (Runtime.getLeader() == 1) {
                ST0541.this.win = Window.create();
                ST0541.this.win.setSize(4, 45);
                ST0541.this.win.setLocation(15, 305);
                ST0541.this.win.print(ST0541.this.msgkankin1, 0);
                ST0541.waitPage(ST0541.this.win, 64);
            } else if (Runtime.getLeader() == 3) {
                ST0541.this.win = Window.create();
                ST0541.this.win.setSize(4, 45);
                ST0541.this.win.setLocation(15, 305);
                ST0541.this.win.print(ST0541.this.msgkankin2, 0);
                ST0541.waitPage(ST0541.this.win, 64);
            } else if (Runtime.getLeader() == 4) {
                ST0541.this.win = Window.create();
                ST0541.this.win.setSize(4, 45);
                ST0541.this.win.setLocation(15, 305);
                ST0541.this.win.print(ST0541.this.msgkankin3, 0);
                ST0541.waitPage(ST0541.this.win, 64);
            } else if (Runtime.getLeader() == 6) {
                ST0541.this.win = Window.create();
                ST0541.this.win.setSize(4, 45);
                ST0541.this.win.setLocation(15, 305);
                ST0541.this.win.print(ST0541.this.msgkankin4, 0);
                ST0541.waitPage(ST0541.this.win, 64);
            } else if (Runtime.getLeader() == 5) {
                ST0541.this.win = Window.create();
                ST0541.this.win.setSize(4, 45);
                ST0541.this.win.setLocation(15, 305);
                ST0541.this.win.print(ST0541.this.msgkankin5, 0);
                ST0541.waitPage(ST0541.this.win, 64);
            }
            Runtime.setFlags(7154, 1, 0);
            Runtime.setPlayerControl(true);
        }
    }
    ...
    class Mapunits
        ...
        void MoveD() {
            ...
            while (true) {
                if (n >= 0 && n < 60) {
                    ST0541.this.doorR2.getTranslate();
                    ST0541.this.doorL2.getTranslate();
                    ST0541.this.doorR2.setTranslate(ST0541.this.doorR2.px, ST0541.this.doorR2.py + 0.083333336f, ST0541.this.doorR2.pz);
                    ST0541.this.doorL2.setTranslate(ST0541.this.doorL2.px, ST0541.this.doorL2.py + 0.083333336f, ST0541.this.doorL2.pz);
                }
                if (n == 61) break;
                ++n;
                System.sleep(1);
        ...
        void automatic_door() {
            ...
            int n3 = 45;
            while (true) {
                ST0541.this.player.getTranslate();
                f2 = (-12.0f - ST0541.this.player.px) * (-12.0f - ST0541.this.player.px) + (0.0f - ST0541.this.player.pz) * (0.0f - ST0541.this.player.pz);
                if (f2 > 20.0f) {
                    if (ST0541.this.doormove == 1) {
                        Sound.effectPlay(196713);
                    }
                    ST0541.this.doormove = 2;
                }
                if (ST0541.this.doormove == 1 && f < (float) (n2 + n)) {
                    if (f == 0.0f) {
                        Sound.effectPlay(196713);
                    }
                    if (f == (float) n2) {
                    ...
                    if (f <= (float) n2) {
                        ST0541.this.doorR1.setRotate(0.0f, f * (float) n3 / (float) n2, 0.0f);
                        ST0541.this.doorL1.setRotate(0.0f, -f * (float) n3 / (float) n2, 0.0f);
                    }
                    if (f >= (float) n) {
                        ST0541.this.doorR2.setRotate(0.0f, (f - (float) n) * (float) n3 / (float) n2, 0.0f);
                        ST0541.this.doorL2.setRotate(0.0f, (-f + (float) n) * (float) n3 / (float) n2, 0.0f);
                    }
                    f += 1.0f;
                }
                if (ST0541.this.doormove == 2 && f > 0.0f) {
                    if ((f -= 1.0f) == 0.0f) {
                        Sound.effectStop(196713);
                    }
                    if (f <= (float) n2) {
                ...
                if (f > (float) (n2 + n)) {
                    ST0541.this.doormove = 0;
                }
                if (f <= 0.0f) {
                    ST0541.this.doormove = 0;
                }
                if (f > (float) n2) {
                    ST0541.this.tA.setTranslate(-12.0f, -5.5f, -0.5f);
                } else if (Runtime.getFlags(3038, 1) == 0 && Runtime.getFlags(3039, 1) == 0) {
                    ST0541.this.tA.setTranslate(-12.0f, -1.5f, -0.5f);
                }
                System.sleep(1);
            }
        }
