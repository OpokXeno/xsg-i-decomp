...
class ST0251
    ...
    int button_flg;
    int page;
    String[] msg_allen_0 = new String[]{"/[label(Allen)]", "Chief.\n", "The Target drones have been changed.\n", "\n", "The next target responds only to sound. It will approach you if you make a loud noise, but it won't notice you if you're just in its field of vision! I believe you can walk if you hold down the R2 Button while moving!\n", "/[waitkey(64)]/[clear()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(249, 2);
                break;
            }
            case 1: {
                Runtime.jumpCF(249, 3);
                break;
            }
            case 2: {
                Runtime.jumpCF(249, 4);
                break;
            }
        }
    }
