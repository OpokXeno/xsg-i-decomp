...
class ST0320
    ...
    String[] Tomiyama_0 = new String[]{"/[label(Shion)]", "What in the world is going on?!", "/[waitkey(64)]/[close()]"};
    ...
    void EV_Camera00() {
        this.camEV = Camera.create(1);
        this.camEV.setTranslate(11.65f, 2.187f, -11.282f);
        this.camEV.setRotate(-10.815f, 21.959f, 0.0f);
    ...
    void init() {
        ...
        this.player.setTranslate(10.0f, 0.0f, -13.5f);
    }
    ...
    class Mapunits
        ...
        void Evt() {
            Runtime.setPlayerControl(false);
            ST0320.this.cam0.setMode(-1);
            ST0320.this.EV_Camera00();
            Runtime.setFlags(3012, 1, 1);
            Runtime.enable(65536);
            ST0320.this.player.rotY(1, 180.0f, true);
            System.sleep(6);
            ST0320.this.player.mtn(10, 1, 1.0f, true);
            ST0320.this.win = Window.create();
            ST0320.this.win.setSize(4, 45);
            ST0320.this.win.setLocation(15, 305);
            ST0320.this.win.print(ST0320.this.Tomiyama_0, 0);
            System.waitFor(ST0320.this.win);
            System.sleep(30);
            ST0320.this.cam0.setMode(0);
            Runtime.setPlayerControl(true);
            Runtime.disable(65536);
        }
    }
