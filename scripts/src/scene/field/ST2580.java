...
class ST2580
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                System.println("地下改札口【MC_KAS18】・６");
                Runtime.jumpCF(2520, 6);
                break;
            }
        }
    }
    ...
    void init() {
        ...
        this.item1 = new Uwamono(28680, 0.0f, 0.0f, -3.0f, 180.0f, 321);
