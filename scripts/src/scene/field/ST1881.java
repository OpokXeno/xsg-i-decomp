...
class ST1881
    ...
    void init() {
        ...
        this.itembox = new Uwamono(28677, 1.0f, 0.0f, -3.0f, 180.0f, 464);
    ...
    void itemget(int n) {
        switch (n) {
            case 1: {
                ...
                Runtime.setFlags(3076, 1, 1);
                Runtime.setFlags(1017, 1, 0);
                Runtime.setShootFlag(true);
                System.sleep(1);
                Runtime.removeItem(10, 70);
                break;
            }
        }
    }
