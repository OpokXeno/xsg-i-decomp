...
class ST2570
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                System.println("公園【MC_KAS31】・４");
                Runtime.jumpCF(2560, 4);
                break;
            }
        }
    }
    ...
    void init() {
        ...
        this.item1 = new Uwamono(28680, 0.0f, 0.0f, -3.0f, 180.0f, 320);
        this.item1.SetSymbol(28727);
