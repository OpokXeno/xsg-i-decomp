...
class ST0596
    ...
    String[] msg00B87CC5 = new String[]{"/[label(Allen)]", "Chief, please follow proper procedures and contact company headquarters. No more acting on your own, okay?", "/[waitkey(64)]/[clear()]"};
    ...
    String[] Not_SHION_00 = new String[]{"/[label(Cherenkov)]", "Intruders? Damn, I never thought they'd get in this far.", "/[waitkey(1)]/[clear()]", "I'll hold them off here. You guys take care of the enemy down there.", "/[waitkey(64)]/[close()]"};
    ...
    String[] msgziggy1 = new String[]{"/[label(Shion)]", "Oh, MOMO!\n", "Have you seen Ziggy?", "/[waitkey(64)]/[clear()]"};
    ...
    String[] msgziggy6 = new String[]{"/[label(chaos)]", "MOMO,\n", "have you seen Ziggy?", "/[waitkey(64)]/[clear()]"};
    ...
    void Talk_npc8_3(Window window) {
        ...
        window.print(this.Not_SHION_00, 0);
        ST0596.waitPage(window, 64);
    }
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(66206, 3);
                break;
            }
            case 1: {
                Runtime.jumpCF(66206, 4);
                break;
            }
        }
    }
    ...
    class NPC_NORMAL
        ...
        void ANNAI() {
            ...
            Runtime.enable(65536);
            ST0596.this.cam0.setMode(-1);
            ST0596.this.EV_Camera01();
            ST0596.this.npc10.kickEnepc(0, 10);
            ST0596.this.npc6.kickEnepc(1, 27);
            ST0596.this.npc7.kickEnepc(1, 27);
            ST0596.this.npc6.setVisible(true);
            ST0596.this.npc7.setVisible(true);
            ST0596.this.npc10.setVisible(true);
            System.sleep(10);
            ST0596.this.win = Window.create();
            ST0596.this.win.setSize(4, 45);
            ST0596.this.win.setLocation(15, 305);
            ST0596.this.win.print(ST0596.this.msg0436E83C, 0);
            ST0596.waitPage(ST0596.this.win, 64);
            ST0596.this.npc10.moveEnepc(17, 180.0f, 0.1f, 20);
            ST0596.this.npc10.kickEnepc(0, 9);
            ST0596.this.win.print(ST0596.this.msg1436E83C, 0);
            ST0596.waitPage(ST0596.this.win, 64);
            ST0596.this.npc6.kickEnepc(0, 9);
            ST0596.this.npc6.moveEnepc(17, 60.0f, -0.1f, 20);
            ST0596.this.win.print(ST0596.this.msg0436E83E, 0);
            ST0596.waitPage(ST0596.this.win, 64);
            ST0596.this.npc10.kickEnepc(0, 10);
            ST0596.this.win.print(ST0596.this.msg0436E840, 0);
            ST0596.waitPage(ST0596.this.win, 64);
            System.sleep(10);
            ST0596.this.fade.call(0);
            System.sleep(30);
            ST0596.this.npc6.setVisible(false);
            ST0596.this.npc7.setVisible(false);
            ST0596.this.npc10.setVisible(false);
            ST0596.this.player.setTranslate(0.26f, 0.0f, -0.86f);
            ST0596.this.cam0.setMode(0);
