...
class ST2550
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                System.println("教会内部・３");
                Runtime.jumpCF(2450, 3);
                break;
            }
        }
    }
    ...
    void init() {
        ...
        this.light01 = new Effect(1630, 0.0f, 2.0f, -3.0f, 0.0f);
        ...
        this.cam0.setCFAngle(1, -28.0f, 0.0f, 0.0f, 10.0f, 47.5f);
        this.cam0.setCFHokan(1, 100.0f, 100.0f);
        this.item1 = new Uwamono(28677, 0.0f, 0.0f, -2.2f, 180.0f, 319);
        this.item1.SetSymbol(28684);
        this.doorA = new Uwamono(33, 40, '\u0001');
