...
class ST1823
    ...
    String[] SHI_00 = new String[]{"/[label(Shion)]", "I said some awful things to Allen that I shouldn't have.\n", "I won't feel right until I apologize to him in person.", "/[waitkey(64)]/[close()]"};
    ...
    public void KickEvent(int n, int n2) {
        block32:
        {
            block31:
            {
                ...
                if (n2 == 4) {
                    switch (n) {
                        case 100: {
                            if (Runtime.mailArriveCheck(67) != 1 || Runtime.getFlags(3174, 1) != 0) break;
                            Runtime.setPlayerControl(false);
                            this.win = Window.create();
                            this.win.setSize(4, 45);
                            this.win.setLocation(15, 305);
                            this.win.print(this.msgMAIL1, 0);
                            Runtime.mailArriveSet(77);
                            Runtime.setFlags(3174, 1, 1);
                            System.waitFor(this.win);
                            System.sleep(15);
                            Runtime.setPlayerControl(true);
                            Runtime.mailExec(1);
        ...
        switch (n) {
            case 100: {
                if (Runtime.getFlags(3172, 1) != 0) return;
                Runtime.setPlayerControl(false);
                this.win = Window.create();
                this.win.setSize(4, 45);
                this.win.setLocation(15, 305);
                this.win.print(this.msgMAIL1, 0);
                Runtime.mailArriveSet(72);
                Runtime.setFlags(3172, 1, 1);
                System.waitFor(this.win);
                System.sleep(15);
                Runtime.setPlayerControl(true);
                Runtime.mailExec(1);
    ...
    class Mapunits
        ...
        void Chijimi() {
            int n = 0;
            ST1823.this.Step.getTranslate();
            while (true) {
                if (n >= 0 && n < 60) {
                    ST1823.this.Step.setTranslate(ST1823.this.Step.px - 0.016666668f, ST1823.this.Step.py, ST1823.this.Step.pz);
                }
                if (n == 60) break;
                ++n;
                System.sleep(1);
        ...
        void Evt1() {
            ...
            Runtime.disable(524288);
            Runtime.setPlayerControl(false);
            ST1823.this.EXP0.setTranslate(13.0f, -1.0f, -45.0f);
            ST1823.this.cam0.setMode(-1);
            Sound.effectPlay(196742);
            ST1823.this.EV_Camera01();
            System.sleep(1);
            ST1823.this.EXP0.kickEnepc(4, 1);
            ST1823.this.win = Window.create();
            ST1823.this.win.setSize(4, 45);
            ST1823.this.win.setLocation(15, 305);
            ST1823.this.win.print("Bridge");
            int n = 0;
            int n2 = 150;
            float f = -45.0f;
            ...
            while (n < n2) {
                ...
                ST1823.this.EXP0.getTranslate();
                ST1823.this.EXP0.setTranslate(ST1823.this.EXP0.px, ST1823.this.EXP0.py, ST1823.this.EXP0.pz + f3);
                ++n;
                System.sleep(1);
            }
            ST1823.this.win.close();
            ST1823.this.player.setLocation(1, 3);
            ST1823.this.EXP0.kickEnepc(0, 1);
            ST1823.this.Step.start(1, "Nobi");
            System.sleep(30);
            ST1823.this.doorA.DoorOpen();
            System.sleep(15);
            ST1823.this.EXP0.kickEnepc(3, 1, 45, 45, 1, 100);
            Runtime.enable(65536);
            ST1823.this.player.mtn(2, 9, 1.0f, true);
            ST1823.this.player.move(90, 7.0f, 1.0f, true);
            System.sleep(30);
            ST1823.this.Step.start(1, "Chijimi");
            ST1823.this.EXP0.kickEnepc(0, 2);
            System.sleep(45);
            ST1823.this.EXP0.kickEnepc(4, 0);
            ST1823.this.EXP0.kickEnepc(4, 2);
            ST1823.this.doorA.DoorClose();
            System.sleep(15);
            Runtime.disable(65536);
            System.sleep(15);
            ST1823.this.cam0.setMode(0);
        ...
        void Evt2() {
            ST1823.this.player.setRotateY(0.0f);
            Runtime.setPlayerControl(false);
            ST1823.this.player.setLocation(1, 2);
            Sound.effectPlay(196745);
            ST1823.this.ele0.setArgs(12, 0.0f);
            System.sleep(200);
            Sound.effectPlay(196746);
            System.sleep(40);
            ST1823.this.doorB.SetDoorType('\u0002');
            ST1823.this.doorB.DoorOpen();
            System.sleep(30);
            Runtime.enable(65536);
            ST1823.this.player.mtn(2, 9, 1.0f, true);
            ST1823.this.player.move(60, -6.5f, -0.5f, true);
            System.sleep(60);
            ST1823.this.doorB.DoorClose();
            ST1823.this.doorB.SetDoorType('\u0004');
            Runtime.setFlags(3067, 1, 0);
            Runtime.disable(65536);
            Runtime.setPlayerControl(true);
            if (Runtime.getFlags(3173, 1) == 0) {
                Runtime.setPlayerControl(false);
                ST1823.this.win = Window.create();
                ST1823.this.win.setSize(4, 45);
                ST1823.this.win.setLocation(15, 305);
                ST1823.this.win.print(ST1823.this.msgMAIL1, 0);
                Runtime.mailArriveSet(74);
                Runtime.setFlags(3173, 1, 1);
                System.waitFor(ST1823.this.win);
                System.sleep(15);
                Runtime.setPlayerControl(true);
                Runtime.mailExec(1);
            }
