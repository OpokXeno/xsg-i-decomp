...
class ST2800
    ...
    String[] sys_2 = new String[]{"Learned Ether, \"Starlight.\"", "/[waitkey(64)]/[close()]", "/[waitkey(64)]/[close()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(68335, 1);
                break;
            }
            case 1: {
                Runtime.jumpCF(68335, 2);
                break;
            }
            case 2: {
                Runtime.jumpCF(68335, 3);
                break;
            }
            case 3: {
                Runtime.jumpCF(68335, 6);
                break;
            }
            case 4: {
                Runtime.jumpCF(68335, 8);
                break;
            }
            case 5: {
                Runtime.jumpCF(68335, 9);
                break;
            }
            case 6: {
                Runtime.jumpCF(68335, 10);
                break;
            }
        }
    }
