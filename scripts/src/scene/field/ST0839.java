...
class ST0830
    ...
    Effect fade;
    int page;
    String[] z8 = new String[]{"It seems to be an emblem with an upside down cross and an elm tree that was used as a symbol for an ancient religion.", "/[waitkey(64)]/[close()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                ...
                Runtime.jumpCF(829, 2);
                break;
            }
            case 1: {
                Runtime.jumpCF(849, 1);
                break;
            }
            case 2: {
                Runtime.jumpCF(869, 2);
                break;
            }
        }
    }
