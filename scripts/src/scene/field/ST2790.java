...
class ST2790
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(68336, 1);
                break;
            }
            case 1: {
                Runtime.jumpCF(68336, 2);
                break;
            }
            case 2: {
                Runtime.jumpCF(68336, 3);
                break;
            }
            case 3: {
                Runtime.jumpCF(2870, 7);
                break;
            }
            case 4: {
                Runtime.jumpCF(2870, 5);
                break;
            }
            case 5: {
                Runtime.jumpCF(68336, 4);
                break;
            }
            case 6: {
                Runtime.jumpCF(68346, 1);
                break;
            }
            case 7: {
                Runtime.jumpCF(68336, 5);
                break;
            }
            case 8: {
                Runtime.jumpCF(68336, 6);
                break;
            }
            case 9: {
                Runtime.jumpCF(68336, 7);
                break;
            }
            case 10: {
                Runtime.jumpCF(2870, 6);
                break;
            }
        }
    }
    ...
    void init() {
        ...
        new Uwamono(28678, 1.6f, 29.0f, 0.0f);
