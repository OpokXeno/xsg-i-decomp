...
class ST1490
    ...
    String[] inf2 = new String[]{"/[label(Information)]", "This elevator is currently in emergency shut-off mode.\n", "/[waitkey(1)]/[clear()]", "Please confirm the safety of the surrounding area and disarm the six safety devices located on each floor if you wish to reactivate it./[waitkey(64)]/[close()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                ...
                Runtime.jumpCF(1509, 2);
                break;
            }
            case 1: {
                Runtime.jumpCF(1509, 3);
                break;
            }
            case 2: {
                Runtime.setFlags(6040, 1, 1);
                Runtime.jumpCF(1509, 4);
                break;
            }
            case 3: {
                Runtime.jumpCF(1509, 5);
                break;
            }
            case 4: {
                Runtime.jumpCF(1489, 1);
                break;
            }
        }
    }
