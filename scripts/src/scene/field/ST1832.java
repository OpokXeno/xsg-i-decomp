...
class ST1832
    ...
    String[] POL_M_00 = new String[]{"This area is secure.", "/[waitkey(1)]/[clear()]", "Don't worry about this area. Please go rescue the Foundation.", "/[waitkey(64)]/[close()]"};
    ...
    String[] POL_M_02 = new String[]{"Hello Sir. There's no unusual activity. Please rest assured.", "/[waitkey(64)]/[close()]"};
    String[] POL_W_00 = new String[]{"What's the situation over on the Foundation?", "/[waitkey(1)]/[clear()]", "Please let us know if there is anything we can do.", "/[waitkey(64)]/[close()]"};
    String[] POL_W_01 = new String[]{"You are a V.I.P., correct? Please go right ahead.", "/[waitkey(64)]/[close()]"};
    String[] POL_W_02 = new String[]{"Please do not worry. No matter what happens, we will guard this door with our lives!", "/[waitkey(1)]/[clear()]", "Little Master, please proceed with your own duties.", "/[waitkey(64)]/[close()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            ...
            case 1: {
                Runtime.jumpCF(1832, 3);
                break;
            }
            case 2: {
                Runtime.jumpCF(1832, 2);
                break;
            }
        }
    }
    ...
    class Mapunits
        ...
        void Chijimi() {
            int n = 0;
            ST1832.this.Step.getTranslate();
            while (true) {
                if (n >= 0 && n < 60) {
                    ST1832.this.Step.setTranslate(ST1832.this.Step.px + 0.016666668f, ST1832.this.Step.py, ST1832.this.Step.pz);
                }
                if (n == 60) break;
                ++n;
                System.sleep(1);
        ...
        void Evt() {
            ...
            Runtime.disable(524288);
            Runtime.setPlayerControl(false);
            ST1832.this.EXP0.setTranslate(-13.0f, -1.0f, -45.0f);
            ST1832.this.cam0.setMode(-1);
            Sound.effectPlay(196742);
            ST1832.this.EV_Camera01();
            System.sleep(1);
            ST1832.this.EXP0.kickEnepc(4, 1);
            ST1832.this.win = Window.create();
            ST1832.this.win.setSize(4, 45);
            ST1832.this.win.setLocation(15, 305);
            ST1832.this.win.print("Isolation Area");
            int n = 0;
            int n2 = 150;
            float f = -45.0f;
            ...
            while (n < n2) {
                ...
                ST1832.this.EXP0.getTranslate();
                ST1832.this.EXP0.setTranslate(ST1832.this.EXP0.px, ST1832.this.EXP0.py, ST1832.this.EXP0.pz + f3);
                ++n;
                System.sleep(1);
            }
            ST1832.this.win.close();
            ST1832.this.player.setVisible(true);
            ST1832.this.EXP0.kickEnepc(0, 1);
            ST1832.this.Step.start(1, "Nobi");
            System.sleep(30);
            ST1832.this.doorA.DoorOpen();
            System.sleep(15);
            ST1832.this.EXP0.kickEnepc(3, 1, 45, 45, 1, 100);
            Runtime.enable(65536);
            ST1832.this.player.mtn(2, 9, 1.0f, true);
            ST1832.this.player.move(90, -7.0f, -1.0f, true);
            System.sleep(30);
            ST1832.this.Step.start(1, "Chijimi");
            ST1832.this.EXP0.kickEnepc(0, 2);
            System.sleep(45);
            ST1832.this.EXP0.kickEnepc(4, 0);
            ST1832.this.EXP0.kickEnepc(4, 2);
            ST1832.this.doorA.DoorClose();
            System.sleep(15);
            Runtime.disable(65536);
            System.sleep(15);
            ST1832.this.cam0.setMode(0);
