...
class ST2750
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(68265, 4);
                break;
            }
            case 1: {
                this.super_setFlags(8042, 3, 4);
