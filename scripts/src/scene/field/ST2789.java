...
class ST2780
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(68265, 7);
                break;
            }
            case 1: {
                this.super_setFlags(8042, 3, 7);
                Runtime.jumpCF(68265, 8);
                break;
            }
        }
    }
    ...
    void init() {
        ...
        this.enemy2 = new NpcEnemy(18434, 2, 2, 11, 3, -6.7f, 0.0f, 1.7f, 270.0f, fArray4);
        this.enemy2.setGroup(9, 9, 10, 10);
        if (Runtime.getFlags(8079, 1) == 0) {
            ...
            this.enemy3 = new NpcEnemy(16648, 3, 2, 16, 7, 0.0f, 0.0f, 10.0f, 270.0f, fArray6);
            this.enemy3.setGroup(12, 12, 12, 12);
        }
        if (Runtime.getFlags(8079, 1) == 0) {
            new Uwamono(54, 4, this.enemy3);
        } else {
            new Uwamono(54, 4);
        }
