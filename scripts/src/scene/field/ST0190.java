...
class ST0190
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                if (Runtime.getFlags(3046, 1) == 1) {
                    Runtime.setFlags(3046, 1, 0);
                    Runtime.jumpCF(411, 8);
                    break;
                }
                if (Runtime.getFlags(3047, 1) == 1) {
                    Runtime.setFlags(3047, 1, 0);
                    Runtime.jumpCF(412, 8);
                    break;
                }
                if (Runtime.getFlags(3048, 1) != 1) break;
                Runtime.setFlags(3048, 1, 0);
                Runtime.jumpCF(413, 8);
                break;
            }
        }
    }
