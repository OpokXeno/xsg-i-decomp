...
class ST1802
    ...
    String[] P1_00 = new String[]{"People are not handling the realization that the Gnosis exist very well.", "/[waitkey(64)]/[close()]"};
    ...
    String[] P3_00 = new String[]{"We will prepare to take in the people of the Foundation!!", "/[waitkey(64)]/[close()]"};
    String[] P3_01 = new String[]{"Please hurry to the Foundation and guide the residents!!", "/[waitkey(64)]/[close()]"};
    ...
    String[] P7_00 = new String[]{"The Foundation is in a terrible situation!!", "/[waitkey(1)]/[clear()]", "Please direct the residents' evacuation!!", "/[waitkey(64)]/[close()]"};
    ...
    String[] ANO_03 = new String[]{"The Kukai Foundation is currently surrounded by the Federation fleet.", "/[waitkey(1)]/[clear()]", "Please wait a while to use the launch.", "/[waitkey(64)]/[close()]"};
    String[] JR_00 = new String[]{"/[label(Jr.)]", "Shion, why are you looking so down?! Let's hurry and go to the beach. I'll show you around!!", "/[waitkey(64)]/[close()]"};
    String[] ALLEN_00 = new String[]{"/[label(Allen)]", "A lot of things have happened since the Woglinde, so I can understand your brooding.", "/[waitkey(1)]/[clear()]", "But let's listen to Jr. here and forget about our worries for a while.", "/[waitkey(64)]/[close()]"};
    ...
    String[] L02_00CJ = new String[]{"Move it, move it! Oh, well if it isn't Little Master!", "/[waitkey(1)]/[clear()]", "What are you doing here?!", "/[waitkey(64)]/[close()]"};
    String[] L02_01CJ = new String[]{"You thought I didn't want to go back to the Foundation?", "/[waitkey(1)]/[clear()]", "You've got to be kidding! I can't just simply abandon the place where my little boy was born, now can I?!", "/[waitkey(64)]/[close()]"};
    ...
    String[] L04_00CN = new String[]{"Ooooooh...I abandoned my friends when I ran from the Foundation, and now I'm embarrassed to go back.", "/[waitkey(64)]/[close()]"};
    ...
    String[] L05_01CN = new String[]{"My family?", "/[waitkey(1)]/[clear()]", "...I actually live alone with my cat.", "/[waitkey(64)]/[close()]"};
    ...
    void init() {
        ...
        if (Runtime.getFlags(373, 1) == 0) {
            ...
            this.npc3 = new NPC_NORMAL(1025, 13, 0, 3, 15, -6.899f, 0.0f, 3.449f, -100.0f);
    ...
    class Mapunits
        ...
        void Chijimi() {
            int n = 0;
            ST1802.this.Step.getTranslate();
            while (true) {
                if (n >= 0 && n < 60) {
                    ST1802.this.Step.setTranslate(ST1802.this.Step.px + 0.016666668f, ST1802.this.Step.py, ST1802.this.Step.pz);
                }
                if (n == 60) break;
                ++n;
                System.sleep(1);
        ...
        void Down() {
            ...
            while (true) {
                if (n >= 0 && n < 120) {
                    ST1802.this.EXP1.setTranslate(ST1802.this.EXP1.px, ST1802.this.EXP1.py - 0.045833334f, ST1802.this.EXP1.pz);
                }
                if (n == 149) {
                    ST1802.this.player.setTranslate(6.0f, 4.95f, -22.0f);
                }
                if (n == 150) {
                    ST1802.this.EXP1.kickEnepc(0, 1);
                }
                if (n == 195) break;
                ++n;
                System.sleep(1);
            }
            ST1802.this.EXP1.kickEnepc(1, 2);
        }
        ...
        void Evt() {
            ...
            Runtime.disable(524288);
            Runtime.setPlayerControl(false);
            ST1802.this.EXP0.setTranslate(-13.0f, -1.0f, -45.0f);
            ST1802.this.cam0.setMode(-1);
            Sound.effectPlay(196742);
            ST1802.this.EV_Camera01();
            System.sleep(1);
            ST1802.this.EXP0.kickEnepc(4, 1);
            ST1802.this.win = Window.create();
            ST1802.this.win.setSize(4, 45);
            ST1802.this.win.setLocation(15, 305);
            ST1802.this.win.print("Dock");
            int n = 0;
            int n2 = 150;
            float f = -45.0f;
            ...
            while (n < n2) {
                ...
                ST1802.this.EXP0.getTranslate();
                ST1802.this.EXP0.setTranslate(ST1802.this.EXP0.px, ST1802.this.EXP0.py, ST1802.this.EXP0.pz + f3);
                ++n;
                System.sleep(1);
            }
            ST1802.this.win.close();
            ST1802.this.player.setLocation(1, 2);
            ST1802.this.EXP0.kickEnepc(0, 1);
            ST1802.this.Step.start(1, "Nobi");
            System.sleep(30);
            ST1802.this.doorB.DoorOpen();
            System.sleep(15);
            ST1802.this.EXP0.kickEnepc(3, 1, 45, 45, 1, 100);
            Runtime.enable(65536);
            ST1802.this.player.mtn(2, 9, 1.0f, true);
            ST1802.this.player.move(90, -7.0f, -1.0f, true);
            System.sleep(30);
            ST1802.this.Step.start(1, "Chijimi");
            ST1802.this.EXP0.kickEnepc(0, 2);
            System.sleep(45);
            ST1802.this.EXP0.kickEnepc(4, 0);
            ST1802.this.EXP0.kickEnepc(4, 2);
            ST1802.this.doorB.DoorClose();
            System.sleep(15);
            Runtime.disable(65536);
            System.sleep(15);
            ST1802.this.cam0.setMode(0);
        ...
        void Evt2() {
            Runtime.disable(524288);
            ST1802.this.player.setTranslate(100.0f, 100.0f, 100.0f);
            Runtime.setPlayerControl(false);
            ST1802.this.EXP1.setTranslate(4.5f, 10.0f, -21.6f);
            ST1802.this.cam0.setMode(-1);
            ST1802.this.EV_Camera02();
            Sound.streamPlay(1195009, 48000);
            System.sleep(30);
            ST1802.this.EXP1.kickEnepc(4, 1);
            ST1802.this.EXP1.getTranslate();
            this.Down();
            ST1802.this.cam0.setMode(0);
            Runtime.enable(65536);
            ST1802.this.player.mtn(2, 9, 1.0f, true);
            ST1802.this.player.move(60, 6.0f, -20.0f, true);
            System.sleep(60);
            Runtime.disable(65536);
        ...
        void Up() {
            ...
            while (true) {
                if (n == 0) {
                    ST1802.this.EXP1.kickEnepc(0, 0);
                }
                if (n == 45) {
                    ST1802.this.EXP1.kickEnepc(1, 3);
                }
                if (n == 75) {
                    ST1802.this.player.setTranslate(100.0f, 100.0f, 100.0f);
                }
                if (n >= 75 && n < 195) {
                    ST1802.this.EXP1.setTranslate(ST1802.this.EXP1.px, ST1802.this.EXP1.py + 0.083333336f, ST1802.this.EXP1.pz);
                }
                if (n == 195) break;
                ++n;
                System.sleep(1);
            }
            ST1802.this.EXP1.kickEnepc(4, 0);
            Runtime.setPlayerControl(true);
            ST1802.this.fade.call(0);
            System.sleep(30);
            Runtime.setFlags(7138, 1, 1);
            Runtime.setFlags(3191, 1, 1);
