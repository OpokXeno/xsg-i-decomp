...
class ST2450
    ...
    String[] npc1_2 = new String[]{"HP & EP restored!!", "/[waitkey(64)]/[close()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                ...
                Runtime.jumpCF(2410, 2);
                break;
            }
            case 1: {
                System.println("教会外観・３");
                Runtime.jumpCF(2410, 3);
                break;
            }
            case 2: {
                if (Runtime.getFlags(337, 1) == 1) {
                    if (Runtime.getFlags(338, 1) == 0) {
                        ...
                        Runtime.resetLockParty(1);
                        Runtime.resetLockParty(5);
                        System.println("イベントEV03026A");
                        Runtime.jumpEvent(3260);
                        break;
                    }
                    Runtime.jumpCF(2550, 1);
                    break;
                }
                Runtime.jumpCF(2550, 1);
                break;
    ...
    void init() {
        ...
        this.npc1 = new NpcEnemy(284, 1, 0, 3, 3, -3.7f, 0.6f, -10.3f, 0.0f);
        this.npc1.enableDTKFlag(1);
        this.npc1.talkto("TalkNPC1");
        this.npc2 = new NpcEnemy(274, 2, 0, 3, 3, -2.1f, 0.0f, 0.0f, 90.0f);
        this.npc2.enableDTKFlag(1);
        this.npc2.talkto("TalkNPC2");
        new Uwamono(28678, -5.6f, 0.0f, -4.6f);
