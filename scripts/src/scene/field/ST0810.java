...
class ST0810
    ...
    ST0810() {
        ...
        this.z8_1 = new String[]{"/[label(Ziggurat 8)]", "(Let's see...the mission objective is to rescue a 100-Series Realian. Now, where is she being held captive...?)", "/[waitkey(1)]/[clear()]", "(I don't want to cause a commotion until I find the Realian. It would be best to avoid unnecessary confrontations.)", "/[waitkey(64)]/[close()]"};
    ...
    public void KickEvent(int n, int n2) {
        ...
        switch (n2) {
            case 0: {
                if (Runtime.getFlags(104, 1) != 0) break;
                Runtime.enable(262144);
                System.sleep(1);
                Runtime.setPlayerControl(false);
                this.lo = 1;
                Runtime.setFlags(104, 1, 1);
                System.println("イベント2002B:しまった！　スーツが壊れた");
                this.fade.call(0);
                System.sleep(30);
                Sound.effectStop(196609);
                Runtime.jumpEvent(2021);
                this.lo = 0;
    ...
    void init() {
        ...
        this.enemy9 = new NPC_NORMAL(17153, 9, 0, 0, 3, 1.45f, 0.331f, 4.45f, 0.0f);
        this.enemy9.renderCommand(530);
        new Uwamono(28678, -2.5f, -2.0f, 11.0f);
        this.car1 = new Unit();
    ...
    class Mapunits
        ...
        void idle() {
            ...
            ST0810.this.U_TIC.setTranslate(-19.6f, 1.4f, -64.4f);
            ST0810.this.airplane.setTranslate(-19.6f, 1.4f, -64.4f);
            if (Runtime.getFlags(8047, 1) == 0) {
                Runtime.setFlags(8047, 1, 1);
                Runtime.setPlayerControl(false);
                System.sleep(15);
                ST0810.this.nwin(ST0810.this.z8_1);
                Runtime.setPlayerControl(true);
            }
            while (true) {
                ...
                if (f4 >= 0.0f && f4 < (float) n2) {
                    ST0810.this.U_TIC.setTranslate(ST0810.this.U_TIC.px + f8, ST0810.this.U_TIC.py + f9, ST0810.this.U_TIC.pz + f10);
                    ST0810.this.airplane.setTranslate(ST0810.this.airplane.px + f8, ST0810.this.airplane.py + f9, ST0810.this.airplane.pz + f10);
                }
                if ((float) n2 <= f4 && f4 < (float) (n2 + 360)) {
                    ST0810.this.U_TIC.setTranslate(-17.14f + Math.sin((f4 - (float) n2 + 360.0f) / 2.0f * 3.14f / 180.0f), ST0810.this.U_TIC.py, ST0810.this.U_TIC.pz);
                    ST0810.this.airplane.setTranslate(-17.14f + Math.sin((f4 - (float) n2 + 360.0f) / 2.0f * 3.14f / 180.0f), ST0810.this.airplane.py, ST0810.this.airplane.pz);
                }
                if (f4 == (float) (n2 + 360)) {
                    ST0810.this.move = true;
                }
                if (f4 >= 10000.0f) {
                    f4 = 9000.0f;
                }
                if (f2 < (float) n) {
                    ST0810.this.lift.setRotate(0.0f, 180.0f, 0.0f);
                    ST0810.this.lift.setTranslate(1.45f, 0.031f, 4.45f);
                    ST0810.this.enemy9.setTranslate(1.45f, 0.5f, 4.0f);
                    ST0810.this.cube1.setTranslate(1.45f, 1.2f, 5.9f);
                }
                ST0810.this.lift.getTranslate();
                if (f2 < (float) n) {
                    ST0810.this.lift.setRotate(0.0f, 180.0f, 0.0f);
                    ST0810.this.lift.setTranslate(1.45f, 0.031f, 4.45f);
                    ST0810.this.enemy9.setTranslate(1.45f, 0.5f, 4.0f);
                ...
                if ((float) n <= f2 && f2 < (float) (n + 300)) {
                    ST0810.this.lift.setRotate(0.0f, 180.0f, 0.0f);
                    ST0810.this.lift.setTranslate(1.45f, 0.031f, ST0810.this.lift.pz + 0.032f);
                    ST0810.this.enemy9.setTranslate(1.45f, 0.5f, ST0810.this.lift.pz - 0.45f + 0.032f);
                    ST0810.this.cube1.setTranslate(1.45f, 1.2f, ST0810.this.lift.pz + 1.45f + 0.032f);
                }
                if ((float) (n + 300) <= f2 && f2 < (float) (n + 330)) {
                    ST0810.this.cube1.getTranslate();
                    ST0810.this.lift.setRotate(0.0f, 180.0f, 0.0f);
                    ST0810.this.lift.setTranslate(1.45f, 0.031f, ST0810.this.lift.pz);
                    ST0810.this.enemy9.setTranslate(1.45f, 0.5f, ST0810.this.lift.pz - 0.45f);
                    ST0810.this.cube1.setTranslate(1.45f, ST0810.this.cube1.py - 0.005f, ST0810.this.lift.pz + 1.45f);
                }
                if ((float) (n + 330) <= f2 && f2 < (float) (n + 390)) {
                    ST0810.this.cube1.getTranslate();
                    ST0810.this.lift.setRotate(0.0f, 180.0f, 0.0f);
                    ST0810.this.lift.setTranslate(1.45f, 0.031f, ST0810.this.lift.pz);
                    ST0810.this.enemy9.setTranslate(1.45f, 0.5f, ST0810.this.lift.pz - 0.45f);
                    ST0810.this.cube1.setTranslate(1.45f, ST0810.this.cube1.py, ST0810.this.lift.pz + 1.45f);
                }
                if ((float) (n + 390) <= f2 && f2 < (float) (n + 450)) {
                    ST0810.this.lift.setRotate(0.0f, 180.0f, 0.0f);
                    ST0810.this.lift.setTranslate(1.45f, 0.031f, ST0810.this.lift.pz - 0.032f);
                    ST0810.this.enemy9.setTranslate(1.45f, 0.5f, ST0810.this.lift.pz - 0.45f - 0.032f);
                }
                if ((float) (n + 450) <= f2 && f2 < (float) (n + 480)) {
                    ST0810.this.lift.setRotate(0.0f, 180.0f, 0.0f);
                    ST0810.this.lift.setTranslate(1.45f, 0.031f, ST0810.this.lift.pz);
                    ST0810.this.enemy9.setTranslate(1.45f, 0.5f, ST0810.this.lift.pz - 0.45f);
                }
                if ((float) (n + 480) <= f2 && f2 < (float) (n + 570)) {
                    ST0810.this.lift.getRotate();
                    ST0810.this.enemy9.getRotate();
                    ST0810.this.lift.setRotate(0.0f, ST0810.this.lift.ry + 1.0f, 0.0f);
                    ST0810.this.enemy9.setTranslate(ST0810.this.lift.px + 0.45f * Math.sin((f2 - ((float) n + 390.0f)) * 3.14f / 180.0f), 0.5f, ST0810.this.lift.pz - 0.45f * Math.cos((f2 - ((float) n + 390.0f)) * 3.14f / 180.0f));
                    ST0810.this.enemy9.setRotate(0.0f, f2 - ((float) n + 480.0f), 0.0f);
                }
                if ((float) (n + 570) <= f2 && f2 < (float) (n + 600)) {
                    ST0810.this.lift.setRotate(0.0f, 270.0f, 0.0f);
                    ST0810.this.lift.setTranslate(ST0810.this.lift.px, 0.031f, ST0810.this.lift.pz);
                    ST0810.this.enemy9.setRotate(0.0f, 90.0f, 0.0f);
                    ST0810.this.enemy9.setTranslate(ST0810.this.lift.px - 0.45f, 0.5f, ST0810.this.lift.pz);
                }
                if ((float) (n + 600) <= f2 && f2 < (float) (n + 750)) {
                    ST0810.this.lift.setRotate(0.0f, 270.0f, 0.0f);
                    ST0810.this.lift.setTranslate(ST0810.this.lift.px + 0.032f, 0.031f, ST0810.this.lift.pz);
                    ST0810.this.enemy9.setRotate(0.0f, 90.0f, 0.0f);
                    ST0810.this.enemy9.setTranslate(ST0810.this.lift.px - 0.45f + 0.032f, 0.5f, ST0810.this.lift.pz);
                }
                if (f2 >= 10000.0f) {
                    f2 = (float) n + 810.0f;
                }
