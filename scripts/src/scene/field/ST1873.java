...
class ST1873
    ...
    String[] D00_00 = new String[]{"well, greetings to yoU!", "/[waitkey(1)]/[clear()]", "i heard from directoR gaignuN! to think that you really are the captaiN!", "/[waitkey(64)]/[close()]"};
    String[] D00_01 = new String[]{"the captaiN's friendS? don't make the captaiN work too harD!", "/[waitkey(64)]/[close()]"};
