...
class ST0412
    ...
    String[] Npc_2 = new String[]{"She's dead.", "/[waitkey(64)]/[close()]"};
    ...
    void init() {
        ...
        this.EF05 = new Effect(1527, 22.61f, 0.0f, 20.21f, -45.0f);
        this.EF05.disp(true);
        this.EF05.setClip(true);
        Stage.setVisible(-1, true);
        this.Kidou = new Mapunits();
        this.Kidou.mapUnit(35);
        this.Kidou.start(4, null);
        this.Kidou.start(1, "Turn");
        ...
        if (Runtime.getFlags(3018, 1) == 0) {
            ...
            this.enemy1.init(16385, 6, -18.41f, 0.0f, 21.76f, 45.0f);
            this.enemy1.id = 1;
        ...
        this.npc3 = new NPC_NORMAL(519, 13, 12, 11, 4, 22.61f, 0.0f, 20.21f, -45.0f);
        ...
        this.npc5 = new NPC_NORMAL(1592, 15, 0, 6, 13, 19.0f, 1.8f, 0.7f, 35.0f);
        ...
        this.npc6 = new NPC_NORMAL(1595, 16, 0, 6, 13, 19.0f, 1.8f, 1.3f, 110.0f);
        ...
        this.player.setTranslate(13.964627f, 0.0f, -19.062746f);
        this.player.rotY(0.0f, 180.0f, true);
    ...
    class Mapunits
        ...
        void Turn() {
            Runtime.setPlayerControl(false);
            Runtime.enable(65536);
            ST0412.this.player.rotY(1, 0.0f, true);
            System.sleep(2);
            Runtime.disable(65536);
            Runtime.setPlayerControl(true);
        }
