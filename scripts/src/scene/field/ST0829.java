...
class ST0820
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(819, 2);
                break;
            }
            case 1: {
                Runtime.jumpCF(839, 1);
                break;
            }
            case 2: {
                Runtime.jumpCF(879, 1);
                break;
            }
            case 3: {
                Runtime.setFlags(8001, 1, 1);
                System.println("サブルート");
                Runtime.jumpCF(899, 1);
                break;
            }
        }
    }
    ...
    void init() {
        ...
        this.fire01 = new Effect(1406, 8.0f, 1.3f, -5.0f, 0.0f);
        this.fire02 = new Effect(1406, 8.0f, 1.3f, 1.0f, 0.0f);
        this.fire03 = new Effect(1406, 13.0f, 1.3f, -5.0f, 0.0f);
        this.fire04 = new Effect(1406, 13.0f, 1.3f, 1.0f, 0.0f);
        this.fire05 = new Effect(1406, 21.0f, 1.3f, -5.0f, 0.0f);
        this.fire06 = new Effect(1406, 21.0f, 1.3f, 1.0f, 0.0f);
