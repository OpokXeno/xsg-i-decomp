...
class ST1850
    ...
    String[] ENG_00 = new String[]{"Huh? A little girl? Come to think of it, I saw one go up to the observation room.", "/[waitkey(64)]/[close()]"};
    String[] ENG_01 = new String[]{"She seemed really sad somehow. You're her older sister, right? You should try to be nicer to her!!", "/[waitkey(64)]/[close()]"};
    ...
    public void KickEvent(int n, int n2) {
        ...
        switch (n) {
            case 100: {
                ...
                if (Runtime.mailReplyCheck(30) == 1) {
                    if (Runtime.getFlags(3178, 1) != 0) return;
                    Runtime.setPlayerControl(false);
                    this.win = Window.create();
                    this.win.setSize(4, 45);
                    this.win.setLocation(15, 305);
                    this.win.print(this.msgMAIL1, 0);
                    Runtime.mailArriveSet(57);
                    Runtime.setFlags(3178, 1, 1);
                    System.waitFor(this.win);
                    System.sleep(15);
                    Runtime.setPlayerControl(true);
                    Runtime.mailExec(1);
                ...
                if (Runtime.mailReplyCheck(30) == 2) {
                    if (Runtime.getFlags(3178, 1) != 0) return;
                    Runtime.setPlayerControl(false);
                    this.win = Window.create();
                    this.win.setSize(4, 45);
                ...
                if (Runtime.mailReplyCheck(30) != 3) return;
                if (Runtime.getFlags(3178, 1) != 0) return;
                Runtime.setPlayerControl(false);
                this.win = Window.create();
                this.win.setSize(4, 45);
        ...
        switch (n) {
            case 0: {
                if (Runtime.getFlags(304, 1) == 0) {
                    Runtime.jumpEvent(3020);
                    break;
                }
                Runtime.jumpCF(1770, 1);
                break;
            }
            case 1: {
                if (Runtime.getFlags(304, 1) == 0) {
    ...
    void init() {
        ...
        if (Runtime.getFlags(304, 1) == 0) {
            this.npc1 = new NPC_NORMAL(527, 1, 0, 4, 8, -3.61f, 0.0f, -4.775f, 15.0f);
    ...
    class Mapunits
        ...
        void Chijimi() {
            int n = 0;
            ST1850.this.Step.getTranslate();
            while (true) {
                if (n >= 0 && n < 60) {
                    ST1850.this.Step.setTranslate(ST1850.this.Step.px + 0.016666668f, ST1850.this.Step.py, ST1850.this.Step.pz);
                }
                if (n == 60) break;
                ++n;
                System.sleep(1);
        ...
        void Evt() {
            ...
            Runtime.disable(524288);
            Runtime.setPlayerControl(false);
            ST1850.this.EXP0.setTranslate(-13.0f, -1.0f, -45.0f);
            ST1850.this.cam0.setMode(-1);
            Sound.effectPlay(196742);
            ST1850.this.EV_Camera01();
            System.sleep(1);
            ST1850.this.EXP0.kickEnepc(4, 1);
            ST1850.this.win = Window.create();
            ST1850.this.win.setSize(4, 45);
            ST1850.this.win.setLocation(15, 305);
            ST1850.this.win.print("Park");
            int n = 0;
            int n2 = 150;
            float f = -45.0f;
            ...
            while (n < n2) {
                ...
                ST1850.this.EXP0.getTranslate();
                ST1850.this.EXP0.setTranslate(ST1850.this.EXP0.px, ST1850.this.EXP0.py, ST1850.this.EXP0.pz + f3);
                ++n;
                System.sleep(1);
            }
            ST1850.this.win.close();
            ST1850.this.player.setLocation(1, 3);
            ST1850.this.EXP0.kickEnepc(0, 1);
            ST1850.this.Step.start(1, "Nobi");
            System.sleep(30);
            ST1850.this.doorA.DoorOpen();
            System.sleep(15);
            ST1850.this.EXP0.kickEnepc(3, 1, 45, 45, 1, 100);
            Runtime.enable(65536);
            ST1850.this.player.mtn(2, 9, 1.0f, true);
            ST1850.this.player.move(90, -7.0f, -1.0f, true);
            System.sleep(30);
            ST1850.this.Step.start(1, "Chijimi");
            ST1850.this.EXP0.kickEnepc(0, 2);
            System.sleep(45);
            ST1850.this.EXP0.kickEnepc(4, 0);
            ST1850.this.EXP0.kickEnepc(4, 2);
            ST1850.this.doorA.DoorClose();
            System.sleep(15);
            Runtime.disable(65536);
            System.sleep(15);
            ST1850.this.cam0.setMode(0);
