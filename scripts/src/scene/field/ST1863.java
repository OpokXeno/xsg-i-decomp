...
class ST1863
    ...
    String[] POL_01 = new String[]{"What is it?\n", "/[waitkey(1)]/[clear()]", "This is the armory. This place does not concern guests like you.", "/[waitkey(64)]/[close()]"};
    ...
    String[] U02_00CJ = new String[]{"Little Master! We finally got your A.G.W.S. repaired!", "/[waitkey(1)]/[clear()]", "Try not to wreck it again so quickly, okay?", "/[waitkey(64)]/[close()]"};
    ...
    class Mapunits
        ...
        void Chijimi() {
            int n = 0;
            ST1863.this.Step.getTranslate();
            while (true) {
                if (n >= 0 && n < 60) {
                    ST1863.this.Step.setTranslate(ST1863.this.Step.px + 0.016666668f, ST1863.this.Step.py, ST1863.this.Step.pz);
                }
                if (n == 60) break;
                ++n;
                System.sleep(1);
        ...
        void Evt() {
            ...
            Runtime.disable(524288);
            Runtime.setPlayerControl(false);
            ST1863.this.EXP0.setTranslate(-13.0f, -1.0f, -45.0f);
            ST1863.this.cam0.setMode(-1);
            Sound.effectPlay(196742);
            ST1863.this.EV_Camera01();
            System.sleep(1);
            ST1863.this.EXP0.kickEnepc(4, 1);
            ST1863.this.win = Window.create();
            ST1863.this.win.setSize(4, 45);
            ST1863.this.win.setLocation(15, 305);
            ST1863.this.win.print("Hangar");
            int n = 0;
            int n2 = 150;
            float f = -45.0f;
            ...
            while (n < n2) {
                ...
                ST1863.this.EXP0.getTranslate();
                ST1863.this.EXP0.setTranslate(ST1863.this.EXP0.px, ST1863.this.EXP0.py, ST1863.this.EXP0.pz + f3);
                ++n;
                System.sleep(1);
            }
            ST1863.this.win.close();
            ST1863.this.player.setVisible(true);
            ST1863.this.EXP0.kickEnepc(0, 1);
            ST1863.this.Step.start(1, "Nobi");
            System.sleep(30);
            ST1863.this.doorA.DoorOpen();
            System.sleep(15);
            ST1863.this.EXP0.kickEnepc(3, 1, 45, 45, 1, 100);
            Runtime.enable(65536);
            ST1863.this.player.mtn(2, 9, 1.0f, true);
            ST1863.this.player.move(90, -7.0f, -1.0f, true);
            System.sleep(30);
            ST1863.this.Step.start(1, "Chijimi");
            ST1863.this.EXP0.kickEnepc(0, 2);
            System.sleep(45);
            ST1863.this.EXP0.kickEnepc(4, 0);
            ST1863.this.EXP0.kickEnepc(4, 2);
            ST1863.this.doorA.DoorClose();
            System.sleep(15);
            Runtime.disable(65536);
            System.sleep(15);
            ST1863.this.cam0.setMode(0);
