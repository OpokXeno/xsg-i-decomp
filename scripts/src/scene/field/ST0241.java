...
class ST0241
    ...
    String moji;
    int page;
    String[] msg_shion_0 = new String[]{"/[label(Shion)]", "Now I can unlock the door!\n", "/[waitkey(64)]/[close()]"};
    ...
    String[] msg_shion_3 = new String[]{"/[label(Shion)]", "Looks like I need a /[color(0x329bbe)]Mission Key/[color(0x808080)] to open this door.\n", "/[waitkey(64)]/[close()]"};
    String[] msg_shion_4 = new String[]{"/[label(Shion)]", "It won't open from this side. I think it's locked.\n", "/[waitkey(64)]/[close()]"};
    String[] Talk02_2 = new String[]{"/[label(Shion)]", "Looks like there's nothing else.\n", "/[waitkey(64)]/[close()]"};
    String[] Talk03_1 = new String[]{"/[label(Shion)]", "Whoa!\n", "/[waitkey(64)]/[clear()]"};
    String[] msg_allen_0 = new String[]{"/[label(Allen)]", "Please insert the /[color(0x329bbe)]Mission Key/[color(0x808080)] into the card slot!", "/[waitkey(64)]/[close()]"};
    ...
    String[] sys_1 = new String[]{"Inserted the /[color(0x329bbe)]Mission Key/[color(0x808080)]!\n", "/[waitkey(64)]/[close()]"};
    ...
    void EOB(int n) {
        System.println("EOD****************************************************");
        if (n == 1) {
            if (Runtime.getFlags(1006, 1) == 0) {
                Runtime.setFlags(1006, 1, 1);
                Runtime.setPlayerControl(false);
                this.win = Window.create();
                this.win.print(this.Talk03_2, 0);
                ST0241.waitPage(this.win, 64);
                Runtime.setPlayerControl(true);
            }
            Runtime.setPlayerControl(true);
    ...
    public void KickEvent(int n, int n2) {
        ...
        switch (n2) {
            case 0: {
                ...
                this.button_flg = 1;
                System.println("Effect!!!!!!!!!");
                this.key = Runtime.getFlags(1001, 1);
                if (this.key == 1) {
                    if (this.doorswitch == 1) break;
                    Runtime.setPlayerControl(false);
                    this.Open_Mes();
                    Runtime.enable(65536);
                    this.player.setTranslate(10.32f, 0.0f, -5.26f);
            ...
            case 1: {
                ...
                if (Runtime.getFlags(1008, 1) != 0) {
                    Runtime.disable(262144);
                    return;
                }
                if (this.doorcheck_boss != 0) break;
                this.Action1();
                break;
            }
            case 2: {
                ...
                if (this.S03 == 1 && this.doorcheck_2F == 0) {
                    ...
                    this.win = Window.create();
                    Sound.effectPlay(58);
                    this.win.print("The lock has been removed./[waitkey(64)]/[close()]");
                    ST0241.waitPage(this.win, 64);
                    Runtime.disable(262144);
            ...
            case 3: {
                ...
                if (Runtime.getFlags(9, 1) == 1) {
                    Runtime.disable(262144);
                    System.println("もうこのキックは無効にしてます");
                    return;
                }
                System.println("KEYYYYY!!!!!!!!!");
                this.button_flg = 1;
                this.KeyGet();
                break;
            }
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                this.doorcheck_boss = Runtime.getFlags(1002, 1);
                if (this.doorcheck_boss == 0) {
                    System.println("フラグ立ってないよーーーーーー大丈夫？？");
                    break;
                }
                Runtime.jumpCF(260, 1);
                break;
            }
            case 1: {
                if (this.S03 == 1) {
                    Runtime.jumpCF(251, 1);
                    return;
                }
                Runtime.jumpCF(250, 1);
                break;
            }
            case 2: {
                if (this.S03 == 1) {
                    Runtime.jumpCF(251, 2);
                    return;
                }
                Runtime.jumpCF(250, 2);
                break;
            }
            case 3: {
                if (this.S03 == 1) {
                    Runtime.jumpCF(251, 3);
                    return;
                }
                Runtime.jumpCF(250, 3);
                break;
            }
            case 4: {
                if (this.S03 == 1) {
                    Runtime.jumpCF(231, 1);
                    return;
                }
                Runtime.jumpCF(230, 1);
                break;
            }
            case 5: {
                if (this.S03 == 1) {
                    Runtime.jumpCF(231, 2);
                    return;
                }
                Runtime.jumpCF(230, 2);
                break;
            }
            case 6: {
