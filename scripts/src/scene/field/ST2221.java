...
class ST2221
    ...
    String[] msg10001 = new String[]{"/[label()]", "I'm working right now...", "/[waitkey(64)]/[close()]"};
    String[] msg10002 = new String[]{"/[label()]", "What is it? Stop staring at me like that.", "/[waitkey(64)]/[close()]"};
    String[] msg20001 = new String[]{"/[label()]", "Whew, it's finally back the way it was. It really bothers me if their position gets changed even in the slightest!", "/[waitkey(1)]/[clear()]", "Oh, please don't break that!", "/[waitkey(64)]/[close()]"};
    ...
    void init() {
        ...
        new Uwamono(27, 77);
        new Uwamono(28, 77, this.item01);
        new Uwamono(26, 67);
        new Uwamono(29, 78, this.item02);
        this.npc1 = new NPC_NORMAL(1597, 1, 0, 14, 5, 12.68f, 0.0f, -5.47f, 90.0f);
        ...
        this.npc5 = new NPC_NORMAL(1558, 5, 0, 14, 14, 13.0f, 0.0f, -6.17f, 75.0f);
        this.npc6 = new NPC_NORMAL(1585, 6, 0, 14, 15, 13.05f, 0.0f, -5.0f, 120.0f);
    ...
    class Mapunits
        ...
        void Oto_Move() {
            ST2221.this.player.getTranslate();
            if (ST2221.this.player.px < 8.0f || ST2221.this.player.px > 15.0f) {
                ST2221.this.teiten1.setTranslate(0.0f, -1000.0f, 0.0f);
            }
        }
    }
