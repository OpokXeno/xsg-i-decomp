...
class ST1783
    ...
    String[] K01_00CJ = new String[]{"Hey, Little Captain. Going out on a mission?", "/[waitkey(1)]/[clear()]", "You're going to take out that huge thing, aren't you? Give it all you've got!", "/[waitkey(64)]/[close()]"};
    String[] K02_00CN = new String[]{"We'll be okay here! No need to worry about us!", "/[waitkey(64)]/[close()]"};
    String[] K02_00CJ = new String[]{"Please, just concentrate on saving Second Miltia.", "/[waitkey(64)]/[close()]"};
