...
class ST2711
    ...
    int b3;
    int page;
    String[] npc1_1 = new String[]{"/[label(MOMO)]", "The Kirschwassers are my younger sisters, even though I was the last one to be awakened. Mommy told me about it. I've always wanted to meet them.", "/[waitkey(64)]/[close()]"};
    String[] npc1_2 = new String[]{"/[label(MOMO)]", "I...I am all right. Thank you, Shion.", "/[waitkey(64)]/[close()]"};
    String[] npc2_1 = new String[]{"/[label(Jr.)]", "Look at the size of that device. Setting 10 or 20 bombs off isn't going to destroy it. We better go back and use the Foundation's main cannon. This is...something that shouldn't exist.", "/[waitkey(64)]/[close()]"};
    String[] npc2_2 = new String[]{"/[label(Jr.)]", "But why did the functions of the Song of Nephilim suddenly stop? Is it because they left? Something's not right.", "/[waitkey(64)]/[close()]"};
    String[] npc2_3 = new String[]{"/[label(Jr.)]", "Anyway, let's go back to the Foundation, Shion.", "/[waitkey(64)]/[close()]"};
    String[] npc3_1 = new String[]{"/[label(Ziggy)]", "There seem to be no more signs of the enemy. I'd like to know what's going on outside. It seems best to go back to the Foundation.", "/[waitkey(64)]/[close()]"};
    String[] npc4_1 = new String[]{"/[label(chaos)]", "...", "/[waitkey(64)]/[close()]"};
    String[] npc4_2 = new String[]{"/[label(Shion)]", "What's wrong, chaos? You have an odd look on your face.", "/[waitkey(64)]/[close()]"};
    String[] npc4_3 = new String[]{"/[label(chaos)]", "No, it's nothing. You do too, you know.", "/[waitkey(64)]/[close()]"};
    String[] npc4_4 = new String[]{"/[label(Shion)]", "Well...something's bothering me.", "/[waitkey(64)]/[close()]"};
    String[] npc4_5 = new String[]{"/[label(chaos)]", "?", "/[waitkey(64)]/[close()]"};
    String[] npc4_6 = new String[]{"/[label(Shion)]", "That person's voice...I've heard it somewhere before. I can't remember clearly, but...", "/[waitkey(64)]/[close()]"};
    String[] npc4_7 = new String[]{"/[label(chaos)]", "...", "/[waitkey(64)]/[close()]"};
    String[] npc5_1 = new String[]{"/[label(KOS-MOS)]", "The Song of Nephilim has ceased all of its activity.", "/[waitkey(64)]/[close()]"};
    String[] npc5_2 = new String[]{"/[label(KOS-MOS)]", "It is pointless to stay in this location. I suggest we return to the Foundation.", "/[waitkey(64)]/[close()]"};
    ...
    public void Talk_npc3(Enepc enepc) {
        this.nwin(this.npc3_1);
    }

    public void Talk_npc4(Enepc enepc) {
        ++this.npc4talked;
        if (this.npc4talked == 1) {
            this.nwin(this.npc4_1);
            this.nwin(this.npc4_2);
        }
        if (this.npc4talked == 2) {
            this.nwin(this.npc4_3);
            this.nwin(this.npc4_4);
        }
        if (this.npc4talked == 3) {
            this.nwin(this.npc4_5);
            this.nwin(this.npc4_6);
        }
        if (this.npc4talked == 4) {
            this.nwin(this.npc4_7);
            --this.npc4talked;
        }
    }
    ...
    public void Talk_npc5(Enepc enepc) {
        ++this.npc5talked;
        if (this.npc5talked == 1) {
            this.nwin(this.npc5_1);
        }
        if (this.npc5talked == 2) {
            this.nwin(this.npc5_2);
            --this.npc5talked;
        }
    }
    ...
    void init() {
        ...
        this.npc1 = new NpcEnemy(4, 1, 0, 3, 3, 1.5f, 0.5f, 13.2f, 330.0f);
        this.npc1.talkto("Talk_npc1");
        this.npc2 = new NpcEnemy(5, 2, 0, 3, 6, 0.0f, 0.5f, 12.3f, 0.0f);
        this.npc2.talkto("Talk_npc2");
        this.npc3 = new NpcEnemy(6, 3, 0, 3, 9, -1.5f, 0.5f, 13.0f, 180.0f);
        this.npc3.talkto("Talk_npc3");
        this.npc4 = new NpcEnemy(3, 4, 0, 3, 12, -1.7f, 0.5f, 14.6f, 90.0f);
        this.npc4.talkto("Talk_npc4");
        this.npc5 = new NpcEnemy(2, 5, 0, 3, 15, -1.4f, 0.5f, 16.0f, 90.0f);
        this.npc5.talkto("Talk_npc5");
        this.doorA = new Uwamono(119, 42, '\u0001');
        new Uwamono(120, 42, '\u0001', this.doorA);
        this.doorA.SetDoorType('\u0004');
        this.b1 = Runtime.getPartyData(1);
        this.b2 = Runtime.getPartyData(2);
        this.b3 = Runtime.getPartyData(3);
