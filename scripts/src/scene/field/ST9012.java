...
class JumpBattle
    ...
    void EOB(int n) {
        ...
        System.println("マーグリスに勝利");
        System.println("ジャンプします");
        System.println("*********VX10000を復活します**************");
        Runtime.setTakeAgws(8193);
        Runtime.jumpEvent(2071);
    }

    void EOB_Always(int n) {
        System.println("ボス戦闘後いつも呼ばれる処理");
        if (n == 0) {
            System.println("0に勝利");
        } else if (n == 1) {
            Runtime.charAllRecovery();
