...
class ST2720
    ...
    String[] locked = new String[]{"It's too steep to climb.", "/[waitkey(64)]/[close()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(2870, 2);
                break;
            }
            case 1: {
                Runtime.jumpCF(68266, 1);
                break;
            }
            case 2: {
                Runtime.jumpCF(68276, 1);
                break;
            }
            case 3: {
                Runtime.jumpCF(68286, 1);
                break;
            }
            case 4: {
                Runtime.jumpCF(68296, 1);
                break;
            }
            case 5: {
                Runtime.jumpCF(68306, 1);
                break;
            }
            case 6: {
                Runtime.jumpCF(68316, 1);
                break;
            }
        }
    }
