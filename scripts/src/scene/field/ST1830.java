...
class ST1830
    ...
    String[] POL_W_01 = new String[]{"You're a V.I.P., correct? Please go right ahead.", "/[waitkey(64)]/[close()]"};
    String[] POL_W_02 = new String[]{"You are a friend of Little Master, correct?", "/[waitkey(1)]/[clear()]", "The girl that was with you just left on the train.", "/[waitkey(64)]/[close()]"};
    String[] POL_W_03 = new String[]{"She seemed kind of sad.", "/[waitkey(1)]/[clear()]", "I would be a little concerned about leaving her alone.", "/[waitkey(64)]/[close()]"};
    ...
    public void KickEvent(int n, int n2) {
        ...
        switch (n) {
            case 100: {
                if (Runtime.getFlags(303, 1) != 1) return;
                if (Runtime.getFlags(304, 1) != 0) return;
                if (Runtime.mailReplyCheck(34) == 1) {
                    if (Runtime.getFlags(3175, 1) != 0) return;
                    Runtime.setPlayerControl(false);
                    this.win = Window.create();
                    this.win.setSize(4, 45);
                    this.win.setLocation(15, 305);
                    this.win.print(this.msgMAIL1, 0);
                    Runtime.mailArriveSet(45);
                    Runtime.setFlags(3175, 1, 1);
                    System.waitFor(this.win);
                    System.sleep(15);
                    Runtime.setPlayerControl(true);
                    Runtime.mailExec(1);
                ...
                if (Runtime.mailReplyCheck(34) == 2) {
                    if (Runtime.getFlags(3175, 1) != 0) return;
                    Runtime.setPlayerControl(false);
                    this.win = Window.create();
                    this.win.setSize(4, 45);
    ...
    public void TalkNPC2a(Enepc enepc, Window window) {
        if (this.shishi == 0) {
            window.print(this.POL_W_02, 0);
            System.waitFor(window);
            this.shishi = 1;
        } else {
            window.print(this.POL_W_03, 0);
            System.waitFor(window);
            this.shishi = 0;
        }
    }
    ...
    public void entered(int n) {
        ...
        switch (n) {
            ...
            case 1: {
                Runtime.jumpCF(1830, 3);
                break;
            }
            case 2: {
                Runtime.jumpCF(1830, 2);
                break;
            }
        }
    }
    ...
    class Mapunits
        ...
        void Chijimi() {
            int n = 0;
            ST1830.this.Step.getTranslate();
            while (true) {
                if (n >= 0 && n < 60) {
                    ST1830.this.Step.setTranslate(ST1830.this.Step.px + 0.016666668f, ST1830.this.Step.py, ST1830.this.Step.pz);
                }
                if (n == 60) break;
                ++n;
                System.sleep(1);
        ...
        void Evt() {
            ...
            Runtime.disable(524288);
            Runtime.setPlayerControl(false);
            ST1830.this.EXP0.setTranslate(-13.0f, -1.0f, -45.0f);
            ST1830.this.cam0.setMode(-1);
            Sound.effectPlay(196742);
            ST1830.this.EV_Camera01();
            System.sleep(1);
            ST1830.this.EXP0.kickEnepc(4, 1);
            ST1830.this.win = Window.create();
            ST1830.this.win.setSize(4, 45);
            ST1830.this.win.setLocation(15, 305);
            ST1830.this.win.print("Isolation Area");
            int n = 0;
            int n2 = 150;
            float f = -45.0f;
            ...
            while (n < n2) {
                ...
                ST1830.this.EXP0.getTranslate();
                ST1830.this.EXP0.setTranslate(ST1830.this.EXP0.px, ST1830.this.EXP0.py, ST1830.this.EXP0.pz + f3);
                ++n;
                System.sleep(1);
            }
            ST1830.this.win.close();
            ST1830.this.player.setVisible(true);
            ST1830.this.EXP0.kickEnepc(0, 1);
            ST1830.this.Step.start(1, "Nobi");
            System.sleep(30);
            ST1830.this.doorA.DoorOpen();
            System.sleep(15);
            ST1830.this.EXP0.kickEnepc(3, 1, 45, 45, 1, 100);
            Runtime.enable(65536);
            ST1830.this.player.mtn(2, 9, 1.0f, true);
            ST1830.this.player.move(90, -7.0f, -1.0f, true);
            System.sleep(30);
            ST1830.this.Step.start(1, "Chijimi");
            ST1830.this.EXP0.kickEnepc(0, 2);
            System.sleep(45);
            ST1830.this.EXP0.kickEnepc(4, 0);
            ST1830.this.EXP0.kickEnepc(4, 2);
            ST1830.this.doorA.DoorClose();
            System.sleep(15);
            Runtime.disable(65536);
            System.sleep(15);
            ST1830.this.cam0.setMode(0);
