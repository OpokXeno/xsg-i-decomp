...
class ST0610
        ...
        switch (n) {
            case 0: {
                if (this.S2030 == 1) {
                    ...
                    Runtime.jumpCF(520, 7);
                    break;
                }
                if (this.S2028 == 1) {
                    Runtime.setFlags(5001, 1, 1);
                    Runtime.jumpCF(670, 7);
                    break;
                }
                if (this.S2010 == 0) {
                    Runtime.setFlags(5001, 1, 1);
    ...
    void npcset_2() {
        ...
        this.npc13.disableDTKFlag(131072);
        this.npc13.disableDTKFlag(65536);
    ...
    class NPC_NORMAL
        ...
        void ANNAI() {
            ...
            Runtime.enable(65536);
            ST0610.this.cam0.setMode(-1);
            ST0610.this.EV_Camera01();
            ST0610.this.npc10.kickEnepc(0, 9);
            ST0610.this.npc6.kickEnepc(1, 10);
            ST0610.this.npc7.kickEnepc(1, 10);
            ST0610.this.npc6.setVisible(true);
            ST0610.this.npc7.setVisible(true);
            ST0610.this.npc10.setVisible(true);
            System.sleep(10);
            ST0610.this.win = Window.create();
            ST0610.this.win.setSize(4, 45);
            ST0610.this.win.setLocation(15, 305);
            ST0610.this.win.print(ST0610.this.msg0162BD8A, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            ST0610.this.win.print(ST0610.this.msg0162BD8B, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            ST0610.this.fade.call(0);
            System.sleep(30);
            ST0610.this.npc6.setVisible(false);
            ST0610.this.npc7.setVisible(false);
            ST0610.this.npc10.setVisible(false);
            ST0610.this.npc11.kickEnepc(1, 9);
            ST0610.this.npc12.kickEnepc(1, 27);
            ST0610.this.npc13.kickEnepc(0, 10);
            ST0610.this.npc11.setVisible(true);
            ST0610.this.npc12.setVisible(true);
            ST0610.this.npc13.setVisible(true);
            ST0610.this.EV_Camera02();
            System.sleep(10);
            ST0610.this.npc11.kickEnepc(1, 27);
            ST0610.this.win = Window.create();
            ST0610.this.win.setSize(4, 45);
            ST0610.this.win.setLocation(15, 305);
            ST0610.this.win.print(ST0610.this.msg1162BD8B, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            ST0610.this.win.print(ST0610.this.msg0162BD8C, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            ST0610.this.npc12.kickEnepc(0, 8);
            ST0610.this.npc11.kickEnepc(1, 0);
            ST0610.this.win.print(ST0610.this.msg0162BD8D, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            System.sleep(1);
            ST0610.this.npc12.kickEnepc(1, 27);
            ST0610.this.npc13.kickEnepc(0, 9);
            ST0610.this.win.print(ST0610.this.msg0162BD8E, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            ST0610.this.win.print(ST0610.this.msg0162BD8F, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            System.sleep(1);
            ST0610.this.npc13.kickEnepc(0, 8);
            ST0610.this.win.print(ST0610.this.msg0162BD90, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            ST0610.this.npc13.moveEnepc(17, 90.0f, 0.1f, 20);
            System.sleep(25);
            ST0610.this.npc13.kickEnepc(0, 9);
            ST0610.this.win.print(ST0610.this.msg0162BD91, 0);
            ST0610.waitPage(ST0610.this.win, 64);
            System.sleep(10);
            ST0610.this.fade.call(0);
            System.sleep(30);
            ST0610.this.npc11.setVisible(false);
            ST0610.this.npc12.setVisible(false);
            ST0610.this.npc13.setVisible(false);
            ST0610.this.npc15.setVisible(false);
            ST0610.this.player.setTranslate(0.61f, 0.0f, 1.48f);
            ST0610.this.cam0.setMode(0);
