        ...
        switch (n) {
            ...
            case 1: {
                ...
                if (Runtime.getFlags(110, 1) == 0) {
                    ...
                    this.fade.call(0);
                    System.sleep(30);
                    System.println("イベントSCE02006：モモ、ヒルベルト発動");
                    Runtime.setFlags(110, 1, 1);
                    Runtime.jumpEvent(2060);
                    break;
                }
                System.println("２周目？");
                Runtime.setPlayerControl(false);
            ...
            case 1: {
                ...
                if (Runtime.getFlags(110, 1) == 0) {
                    ...
                    if (Runtime.getFlags(8039, 1) == 0) {
                        this.enemy4.setTranslate(18.1f, 5.1f, -22.9f);
