...
class ST2730
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(68265, 2);
                break;
            }
            case 1: {
                this.super_setFlags(8042, 3, 2);
    ...
    void init() {
        ...
        this.enemy2.setGroup(0, 2, 2, 3);
        if (Runtime.getFlags(8078, 1) == 0) {
            ...
            this.enemy3.setGroup(11, 11, 11, 11);
        }
        if (Runtime.getFlags(8078, 1) == 0) {
