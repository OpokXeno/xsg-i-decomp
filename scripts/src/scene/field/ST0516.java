...
class ST0516
    ...
    String[] msg0ED1AD79 = new String[]{"/[label(Tony)]", "Hmm,\n", "I don't get it at all.", "/[waitkey(64)]/[clear()]"};
    String[] msg0ED1AD7A = new String[]{"/[label(Shion)]", "Yeah.\n", "Even I don't know exactly what happened.", "/[waitkey(64)]/[close()]"};
    String[] msg0ED1AD7B = new String[]{"/[label(Tony)]", "Well, at least you're safe. Think about it this way, good things will to happen eventually.", "/[waitkey(64)]/[close()]"};
    ...
    String[] HAM_K0 = new String[]{"/[label(Hammer)]", "Oh, KOS-MOS! It's finally your chance to kick butt! We're counting on you!", "/[waitkey(64)]/[close()]"};
    ...
    String[] T01_K = new String[]{"/[label(Tony)]", "The enemy's coming, right?", "/[waitkey(1)]/[clear()]", "Come on now, go out there and show us you're not all talk!", "/[waitkey(64)]/[close()]"};
    ...
    String[] ALLEN_00 = new String[]{"/[label(Allen)]", "I'm counting on you to protect the Chief. If something were to happen to the Chief, I'd...", "/[waitkey(64)]/[close()]"};
    ...
    String[] msg0436E83A = new String[]{"/[label(Shion)]", "I heard that on routine voyages, all the controls can be automated.", "/[waitkey(64)]/[close()]"};
    ...
    String[] msg05000001 = new String[]{"/[label(Matthews)]", "What do you want to do? Want to depart soon? Or do you want to wander around the colony still?", "/[waitkey(64)]/[close()]"};
    ...
    String[] msg0502DABF = new String[]{"/[label(Matthews)]", "Yo, glad you're safe. Hmm? Where's the Commander?", "/[waitkey(64)]/[clear()]"};
    ...
    void Talk_npc1_8() {
        ...
        this.menu.addItem("Yes, please depart\nSorry, but I want to wander around a little longer");
    ...
    void Talk_npc2_4(Window window) {
        if (Runtime.getLeader() == 2) {
            window.print(this.T01_K, 0);
            ST0516.waitPage(window, 64);
        } else {
    ...
    class NPC_NORMAL
        ...
        void ANNAI() {
            ...
            Runtime.enable(65536);
            ST0516.this.cam0.setMode(-1);
            ST0516.this.EV_Camera01();
            ST0516.this.npc10.kickEnepc(0, 9);
            ST0516.this.npc6.kickEnepc(1, 10);
            ST0516.this.npc7.kickEnepc(0, 10);
            ST0516.this.npc6.setVisible(true);
            ST0516.this.npc7.setVisible(true);
            ST0516.this.npc10.setVisible(true);
            System.sleep(10);
            ST0516.this.win = Window.create();
            ST0516.this.win.setSize(4, 45);
            ST0516.this.win.setLocation(15, 305);
            ST0516.this.win.print(ST0516.this.msg0436E835, 0);
            ST0516.waitPage(ST0516.this.win, 64);
            ST0516.this.EV_Camera02();
            System.sleep(10);
            ST0516.this.npc10.kickEnepc(1, 9);
            ST0516.this.win.print(ST0516.this.msg0436E836, 0);
            ST0516.waitPage(ST0516.this.win, 64);
            ST0516.this.npc10.moveEnepc(17, 210.0f, 0.1f, 10);
            ST0516.this.npc7.kickEnepc(0, 10);
            ST0516.this.npc7.moveEnepc(17, 160.0f, -0.1f, 30);
            ST0516.this.npc6.kickEnepc(0, 7);
            ST0516.this.win.print(ST0516.this.msg0436E837, 0);
            ST0516.waitPage(ST0516.this.win, 64);
            ST0516.this.npc10.moveEnepc(17, 120.0f, -0.1f, 20);
            ST0516.this.npc10.kickEnepc(1, 10);
            ST0516.this.win.print(ST0516.this.msg0436E838, 0);
            ST0516.waitPage(ST0516.this.win, 64);
            ST0516.this.npc10.moveEnepc(17, 270.0f, 0.1f, 20);
            ST0516.this.npc7.kickEnepc(0, 10);
            ST0516.this.npc7.moveEnepc(17, 200.0f, 0.1f, 30);
            ST0516.this.npc6.kickEnepc(1, 9);
            ST0516.this.win.print(ST0516.this.msg0436E839, 0);
            ST0516.waitPage(ST0516.this.win, 64);
            ST0516.this.npc10.kickEnepc(0, 9);
            ST0516.this.win.print(ST0516.this.msg0436E83A, 0);
            ST0516.waitPage(ST0516.this.win, 64);
            ST0516.this.npc7.moveEnepc(17, 180.0f, -0.1f, 20);
            System.sleep(10);
            ST0516.this.fade.call(0);
            System.sleep(30);
            ST0516.this.npc6.setVisible(false);
            ST0516.this.npc7.setVisible(false);
            ST0516.this.npc10.setVisible(false);
            ST0516.this.npc11.setVisible(false);
            ST0516.this.player.setTranslate(-0.02f, 0.0f, 7.31f);
            ST0516.this.cam0.setMode(0);
            Runtime.setPlayerControl(true);
            Runtime.disable(65536);
        }
    }
