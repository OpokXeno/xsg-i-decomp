...
class ST2840
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(68375, 2);
                break;
            }
            case 1: {
                Runtime.jumpCF(2879, 10);
                break;
            }
        }
    }
    ...
    void hantei(int n) {
        ...
        if (this.green == 1 && this.red == 2 && this.blue == 3 && Runtime.getFlags(8054, 1) == 0) {
            System.println("成功");
    ...
    void init() {
        ...
        this.box08.SetSe0(196753);
        this.box09.SetSe0(196754);
        this.box10.SetSe0(196750);
