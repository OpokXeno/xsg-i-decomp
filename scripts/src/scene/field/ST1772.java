...
class ST1772
    ...
    Uwamono teiten3;
    int page;
    String[] K01_00CN = new String[]{"Apparently, a large number of Gnosis are clinging on to the inside of the Foundation.", "/[waitkey(1)]/[clear()]", "With only the Federation fleet and the Durandal for offensive power, we cannot hold them off much longer.", "/[waitkey(64)]/[close()]"};
    String[] K01_01CN = new String[]{"The beautiful scenery is being destroyed by the Gnosis.", "/[waitkey(1)]/[clear()]", "Would humans become sentimental in this situation?", "/[waitkey(1)]/[clear()]", "I treat everything numerically and do not have any emotions.", "/[waitkey(64)]/[close()]"};
    String[] K01_00CJ = new String[]{"Apparently, numerous Gnosis are on the Foundation.", "/[waitkey(1)]/[clear()]", "With only the Federation fleet and the Durandal for offensive power, we cannot hold them off much longer.", "/[waitkey(64)]/[close()]"};
    String[] K01_01_CJ = new String[]{"The beautiful scenery is being destroyed by the Gnosis.", "/[waitkey(1)]/[clear()]", "Would humans become sentimental in this situation?", "/[waitkey(1)]/[clear()]", "I treat everything numerically and do not have any emotions.", "/[waitkey(64)]/[close()]"};
    String[] K02_00CN = new String[]{"Well, we're in a terrible fix! I've never seen so many Gnosis appear all at once!", "/[waitkey(1)]/[clear()]", "Oh well, panicking won't make things better.", "/[waitkey(1)]/[clear()]", "In any case, what will happen will happen.", "/[waitkey(64)]/[close()]"};
    String[] K02_01CJ = new String[]{"Oh, Little Master, are you here checking things out too? I understand. It's not everyday that you get to see something like this!", "/[waitkey(1)]/[clear()]", "Oh, but not from this spot. This seat is reserved for myself.", "/[waitkey(64)]/[close()]"};
    String[] K03_00CN = new String[]{"My goodness! It feels like a dream.", "/[waitkey(1)]/[clear()]", "The word pandemonium must have been made to describe times like this.", "/[waitkey(64)]/[close()]"};
    String[] K03_00CJ = new String[]{"Oh, Little Master. What the heck is going on here?", "/[waitkey(1)]/[clear()]", "You didn't do anything to anger the Gnosis, did you?", "/[waitkey(64)]/[close()]"};
    String[] K04_00CN = new String[]{"What the heck is going on?!", "/[waitkey(1)]/[clear()]", "There are monsters all over the place!", "/[waitkey(1)]/[clear()]", "Don't tell me they're all after the Foundation, are they?", "/[waitkey(1)]/[clear()]", "You're a soldier, right? Hurry up and do something!", "/[waitkey(64)]/[close()]"};
    String[] K04_00CJ = new String[]{"Oh, Little Master! It's dangerous here!", "/[waitkey(1)]/[clear()]", "There are monsters all over the place. Please evacuate to a safe place immediately!", "/[waitkey(64)]/[close()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(1852, 1);
                break;
            }
            case 1: {
                Runtime.jumpCF(1852, 2);
                break;
            }
        }
    }
