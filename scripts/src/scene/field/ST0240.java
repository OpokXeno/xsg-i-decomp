...
class ST0240
        ...
        switch (this.kcount) {
            case 0: {
                if (this.key == 0) {
                    ...
                    this.win = Window.create();
                    this.win.print(String.valueOf(this.moji) + "obtained!/[waitkey(64)]/[close()]");
    ...
    public void KickEvent(int n, int n2) {
        ...
        switch (n2) {
            ...
            case 2: {
                ...
                System.println("Process end message");
                break;
            }
            case 3: {
                if (this.button_flg == 1) {
    ...
    void init() {
        ...
        this.enemy1.init(17665, 5, -10.03f, 0.0f, 5.19f, 90.0f);
        this.enemy1.id = 1;
        ...
        this.enemy2.init(17665, 5, 8.468f, 0.0f, -2.261f, 0.0f);
        this.enemy2.id = 2;
        ...
        this.enemy3.init(18177, 6, -3.0f, 4.0f, -1.5f, 90.0f);
        this.enemy3.id = 3;
        this.enemy3.setGroup(0, 0, 0, 0);
        this.enemy3.setShadow(4, 16);
        ...
        this.enemy3.setParams(1, 5, 3, 6, fArray6);
        ...
        this.doorA = new Uwamono(39, 42, '\u0001');
        new Uwamono(40, 42, '\u0001', this.doorA);
