...
class ST0840
    ...
    String[] jr01 = new String[]{"/[label(Jr. (Special Appearance))]", "Okay, all that's left is to rescue MOMO and get the hell out of here.", "/[waitkey(64)]/[close()]"};
    String[] zi01 = new String[]{"/[label(Ziggy)]", "Yes, we must hurry.", "/[waitkey(64)]/[close()]"};
    String[] ke01 = new String[]{"/[label(chaos (Special Appearance))]", "Love to, but...it's already time. That's it for today.", "/[waitkey(64)]/[close()]"};
    String[] jr02 = new String[]{"/[label(Jr. (Special Appearance))]", "What?!", "/[waitkey(64)]/[close()]"};
    String[] zi02 = new String[]{"/[label(Ziggy)]", "Hmm...it can't be helped. The continuation will be in the product version....", "/[waitkey(64)]/[close()]"};
    String[] mo01 = new String[]{"/[label(MOMO)]", "No way...MOMO's going to be stuck like this for four months?", "/[waitkey(64)]/[close()]"};
    String[] ke02 = new String[]{"/[label(chaos (Special Appearance))]", "I guess so...\n", "Well, 4 months will go by in no time, so just be patient for a little while longer.", "/[waitkey(64)]/[close()]"};
    String[] ke03 = new String[]{"/[label(chaos (Special Appearance))]", "Well, see you later!", "/[waitkey(64)]/[close()]"};
    int b_flg;
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(839, 2);
                Runtime.jumpCF(839, 2);
                break;
            }
            case 1: {
                Runtime.jumpCF(859, 1);
                break;
            }
        }
    }
    ...
    void init() {
        ...
        float[] fArray2;
        int n;
        new Uwamono(28734, 8.0f, 5.0f, -9.9f);
    ...
    class Mapunits
        ...
        void kaiten() {
            ...
            System.sleep(10);
            ST0840.this.player.mtn(15, 1, 1.0f, true);
            System.sleep(20);
