...
class ST2760
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(68265, 5);
                break;
            }
            case 1: {
                this.super_setFlags(8042, 3, 5);
    ...
    void init() {
        ...
        this.enemy2.setGroup(4, 6, 6, 6);
        this.item1 = new Uwamono(28677, 0.0f, 0.0f, 0.0f, 180.0f, 423);
