...
class ST0260
    ...
    class Mapunits
        ...
        void Down() {
            ...
            int n = 0;
            while (n < 30) {
                ST0260.this.dai.getTranslate();
                ST0260.this.dai.setTranslate(this.px, this.py - 0.05f * (float) n, this.pz);
                ST0260.this.hako.getTranslate();
                ST0260.this.hako.setTranslate(this.px, this.py - 0.05f * (float) n, this.pz);
                System.sleep(1);
                ++n;
            }
            ST0260.this.hako.setVisible(false);
        }
        ...
        void Up() {
            ...
            while (n < 30) {
                ST0260.this.dai.getTranslate();
                ST0260.this.dai.setTranslate(this.px, -1.5f + 0.05f * (float) n, this.pz);
                System.sleep(1);
                ++n;
            }
        }
