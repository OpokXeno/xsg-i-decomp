...
class ST0550
    ...
    String[] msghasigo = new String[]{"/[label()]", "Go to the upper level?", "/[waitkey(64)]/[close()]"};
    ...
    void Talk_npc8_2(Window window) {
        ...
        switch (this.talkFlag8) {
            case 1: {
                ...
                ST0550.waitPage(window, 64);
                window.print(this.msg1436E834, 0);
                ST0550.waitPage(window, 64);
                window.print(this.msg1436E835, 0);
                ST0550.waitPage(window, 64);
                window.print(this.msg1436E836, 0);
                ST0550.waitPage(window, 64);
                window.print(this.msg1436E837, 0);
                ST0550.waitPage(window, 64);
                return;
            }
        }
        window.print(this.msg143747E4, 0);
        ST0550.waitPage(window, 64);
    }
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(560, 1);
                break;
            }
            case 2: {
                Runtime.setFlags(7160, 1, 1);
                Runtime.jumpCF(560, 2);
                break;
            }
            case 3: {
                Runtime.jumpCF(580, 1);
                break;
            }
            case 4: {
    ...
    void init() {
        ...
        this.enemy1.init(279, 3, 100.0f, 0.0f, 100.0f, 0.0f);
        ...
        if (Runtime.getFlags(123, 1) == 0) {
            this.npc21 = new NPC_NORMAL(279, 21, 0, 14, 3, 8.99f, 0.0f, -20.64f, 0.0f);
            this.npc21.talkto("Talk_npc21");
            this.npc21.setInvalidID(1);
            this.npc21.setVisible(false);
            this.Base03 = new Uwamono(28672, 9.0f, 0.0f, -21.3f, 0.0f);
            this.Base03.SetSize(5.0f, 2.0f, 2.0f);
        }
        Runtime.setPlayerControl(true);
    }
    ...
    void npcset_2() {
        this.npc8 = new NPC_NORMAL(279, 8, 0, 5, 3, 4.37f, 0.0f, 16.6f, 0.0f);
    ...
    class Mapunits
        ...
        void Move() {
            ...
            while (true) {
                if (n >= 0 && n < 30) {
                    ST0550.this.X1.getTranslate();
                    ST0550.this.X1.setTranslate(ST0550.this.X1.px + 0.115f, ST0550.this.X1.py, ST0550.this.X1.pz);
                    ST0550.this.X2.getTranslate();
                    ST0550.this.X2.setTranslate(ST0550.this.X2.px - 0.115f, ST0550.this.X2.py, ST0550.this.X2.pz);
                }
                if (n >= 30 && n < 90) {
                    ST0550.this.Y1.getTranslate();
                    ST0550.this.Y1.setTranslate(ST0550.this.Y1.px, ST0550.this.Y1.py + 0.016666668f, ST0550.this.Y1.pz);
                    ST0550.this.Y2.getTranslate();
                    ST0550.this.Y2.setTranslate(ST0550.this.Y2.px, ST0550.this.Y2.py + 0.016666668f, ST0550.this.Y2.pz);
                }
                if (n == 91) break;
                ++n;
                System.sleep(1);
