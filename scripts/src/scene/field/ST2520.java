...
class ST2520
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(2430, 2);
                break;
            }
            case 1: {
                Runtime.jumpCF(2530, 1);
                break;
            }
            case 2: {
                Runtime.jumpCF(2530, 2);
                break;
            }
            case 3: {
                Runtime.jumpCF(2530, 3);
                break;
            }
            case 4: {
                Runtime.jumpCF(2530, 4);
                break;
            }
            case 5: {
                Runtime.jumpCF(2580, 1);
                break;
            }
        }
    }
    ...
    void init() {
        ...
        new Uwamono(28678, -6.8f, 0.0f, 8.3f);
