...
class ST2870
    ...
    Effect fade;
    int page;
    String[] h = new String[]{"There is a button. Press it?", "/[waitkey(64)]/[close()]"};
    ...
    public void entered(int n) {
        ...
        switch (n) {
            case 0: {
                Runtime.jumpCF(2869, 4);
                break;
            }
            case 1: {
                this.super_setFlags(8042, 3, 1);
                Runtime.jumpCF(2729, 1);
                break;
            }
            case 2: {
                Runtime.jumpCF(2749, 2);
                break;
            }
            case 3: {
                Runtime.jumpCF(2779, 2);
                break;
            }
            case 4: {
                Runtime.jumpCF(2799, 5);
                break;
            }
            case 5: {
                Runtime.jumpCF(2799, 11);
                break;
            }
            case 6: {
                Runtime.jumpCF(2799, 4);
                break;
            }
            case 7: {
                Runtime.jumpCF(2829, 1);
                break;
            }
            case 8: {
                Runtime.jumpCF(2829, 4);
                break;
            }
            case 9: {
                Runtime.jumpCF(2849, 2);
                break;
            }
            case 10: {
                Runtime.jumpCF(2839, 3);
                break;
            }
            case 11: {
                Runtime.jumpCF(2829, 3);
                break;
            }
            case 12: {
                Runtime.jumpCF(2779, 3);
                break;
            }
            case 13: {
                Runtime.jumpCF(2719, 1);
                break;
            }
        }
    }
