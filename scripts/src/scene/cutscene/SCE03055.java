...
class SCE03055
    ...
    void all_hairset(int n) {
        this.shion.hairStop(0, n);
        this.shionM.hairStop(0, n);
        this.momo.hairStop(0, n);
        this.jr.hairStop(0, n);
        this.chaos.hairStop(0, n);
    }
    ...
    public void cleanup() {
        ...
        System.println("XEVEFLAG:EV03055_F");
        Runtime.setFlags(391, 1, 1);
        System.println("XEVEJNAME:CFJ3_270 XEVEJPOINT:POINT3_270");
    ...
    void init() {
        ...
        this.fade_white = new Effect(0);
        this.fade_white.args[0] = -2130706433;
        this.fade_white.args[1] = 60;
        this.fade_white.args[2] = 1;
    ...
    void playSCENE0() {
        ...
        this.momoM.setMotionFlags(0x2000000, true);
        this.jr.setMotionFlags(0x2000000, true);
        this.chaos.setMotionFlags(0x2000000, true);
        this.shion.setMotionFlags(0x400000, true);
        this.shionM.setMotionFlags(0x400000, true);
        this.momo.setMotionFlags(0x400000, true);
        this.momoM.setMotionFlags(0x400000, true);
        this.jr.setMotionFlags(0x400000, true);
        this.chaos.setMotionFlags(0x400000, true);
        this.dummy.start(1, "act1_chara");
        this.chaos.mtn(257, 0, 273, 8, 0, 1.0f, true);
        this.jr.mtn(258, 0, 273, 8, 0, 1.0f, true);
        this.momoM.mtn(259, 0, 273, 8, 0, 1.0f, true);
        this.shionM.mtn(260, 0, 273, 8, 0, 1.0f, true);
        this.chaos.start(5, null);
        this.jr.start(5, null);
        this.momoM.start(5, null);
        this.shionM.start(5, null);
        this.Fchaos.start(1, "face1_chaos");
        this.Fjr.start(1, "face1_jr");
        this.Fmomo.start(1, "face1_momo");
        this.Fshion.start(1, "face1_shion");
        this.camerawork.cut1();
        this.pc.loadCamera("c03s55cut01_02.cam");
        this.pc.init(1, 0);
        this.pc.start();
        System.sleep(144);
    ...
    void playSCENE1() {
        ...
        this.momo.mtn(261, 0, 305, 8, 0, 1.0f, true);
        this.shion.mtn(262, 0, 305, 8, 0, 1.0f, true);
        this.momo.start(5, null);
        this.shion.start(5, null);
        this.camerawork.cut3();
        this.pc.loadCamera("c03s55cut03.cam");
        this.pc.init(1, 0);
        this.pc.start();
        this.waitclear(40);
        System.sleep(70);
        ...
        this.shadow.start(1, "act_off_shadow");
        this.dummy.start(1, "act4_chara");
        this.momo.mtn(263, 0, 390, 8, 0, 1.0f, true);
        this.momo.start(5, null);
        this.Fmomo.start(1, "face4_momo");
        this.camerawork.cut4();
        this.pc.loadCamera("c03s55cut04.cam");
        this.pc.init(1, 0);
        this.pc.start();
        this.waitclear(46);
        System.sleep(32);
        ...
        this.momo.mtn(264, 0, 144, 8, 0, 1.0f, true);
        this.momo.start(5, null);
        this.MAPeff.start(1, "MAPeff_off");
        this.camerawork.cut5();
        this.pc.loadCamera("c03s55cut05.cam");
        this.pc.init(1, 0);
        this.pc.start();
        this.waitclear(144);
        this.dummy.start(1, "act6_chara");
        this.guno1.mtn(265, 0, 195, 8, 0, 1.0f, true);
        this.guno2.mtn(266, 0, 195, 8, 0, 1.0f, true);
        this.guno1.start(5, null);
        this.guno2.start(5, null);
        this.camerawork.cut6();
        this.pc.loadCamera("c03s55cut06_07.cam");
        this.pc.init(1, 0);
        this.pc.start();
        System.sleep(90);
    ...
    void playSCENE2() {
        Sound.streamPlay(1390088, 48000);
        this.shionM.renderCommand(534);
        this.momoM.renderCommand(534);
        this.shadow.start(1, "act_set_shadow");
        this.dummy.start(1, "act8_chara");
        this.chaos.mtn(267, 0, 220, 8, 0, 1.0f, true);
        this.jr.mtn(268, 0, 220, 8, 0, 1.0f, true);
        this.momoM.mtn(269, 0, 220, 8, 0, 1.0f, true);
        this.shionM.mtn(270, 0, 220, 8, 0, 1.0f, true);
        this.chaos.start(5, null);
        this.jr.start(5, null);
        this.momoM.start(5, null);
        this.shionM.start(5, null);
        this.momo.mtn(271, 0, 0, 8, 0, 1.0f, true);
        this.momo.start(5, null);
        this.MAPeff.start(1, "MAPeff_set");
        this.camerawork.cut8();
        this.pc.loadCamera("c03s55cut08.cam");
        this.pc.init(1, 0);
        this.pc.start();
        System.sleep(30);
        this.msg.print("It's just like Mommy said.\nThis is an abominable machine.");
        this.waitclear(170);
        System.sleep(20);
        this.momo.renderCommand(512);
        this.shadow.start(1, "act_off_shadow");
        this.dummy.start(1, "act9_chara");
        this.momo.mtn(271, 0, 330, 8, 0, 1.0f, true);
        this.momo.start(5, null);
        this.MAPeff.start(1, "MAPeff_off");
        this.camerawork.cut9();
        this.pc.loadCamera("c03s55cut09.cam");
        this.pc.init(1, 0);
        this.pc.start();
        System.sleep(34);
        this.msg.print("If a lot of people died because of\nmy birth, does that mean");
        this.waitclear(160);
        System.sleep(21);
        this.msg.print("I'm an abomination as well,\njust like Daddy?");
        System.sleep(115);
        this.momo.renderCommand(0);
        this.jr.renderCommand(512);
        this.chaos.mtn(272, 0, 345, 8, 0, 1.0f, true);
        this.jr.mtn(273, 0, 345, 8, 0, 1.0f, true);
        this.momo.mtn(274, 0, 345, 8, 0, 1.0f, true);
        this.chaos.start(5, null);
        this.jr.start(5, null);
        this.momo.start(5, null);
        this.Fjr.start(1, "face10_jr");
        this.Fmomo.start(1, "face10_momo");
        this.Fmomo1.start(1, "eyes10_momo");
        this.camerawork.cut10();
        this.pc.loadCamera("c03s55cut10.cam");
        this.pc.init(1, 0);
        this.pc.start();
        this.waitclear(53);
        System.sleep(45);
        ...
        this.jr.mtn(275, 0, 79, 8, 0x40000000, 1.0f, true);
        this.momo.mtn(276, 0, 79, 8, 0, 1.0f, true);
        this.shion.mtn(277, 0, 79, 8, 0, 1.0f, true);
        this.jr.start(5, null);
        this.momo.start(5, null);
        this.shion.start(5, null);
        this.MAPeff.start(1, "MAPeff_set");
        this.Fmomo.start(1, "face11_momo");
        this.camerawork.cut11();
        this.pc.loadCamera("c03s55cut11.cam");
        this.pc.init(1, 0);
        this.pc.start();
        ...
        this.shion.mtn(278, 0, 342, 8, 0, 1.0f, true);
        this.shion.start(5, null);
        this.Fshion.start(1, "face12_shion");
        this.camerawork.cut12();
        this.pc.loadCamera("c03s55cut12.cam");
        this.pc.init(1, 0);
        this.pc.start();
        this.msg.print("Even though you're a Realian,\nyou're still their child, right?");
        this.waitclear(142);
        System.sleep(48);
        this.msg.print("No parent would ever think of their\nown child as abominations.");
        this.waitclear(97);
        System.sleep(7);
        this.msg.print("Surely...");
        this.waitclear(40);
        System.sleep(8);
        this.shadow.start(1, "act_set_shadow");
        this.dummy.start(1, "act13_chara");
        this.chaos.mtn(279, 0, 136, 8, 0, 1.0f, true);
        this.jr.mtn(280, 0, 136, 8, 0, 1.0f, true);
        this.momoM.mtn(281, 0, 136, 8, 0, 1.0f, true);
        this.shionM.mtn(282, 0, 136, 8, 0, 1.0f, true);
        this.chaos.start(5, null);
        this.jr.start(5, null);
        this.momoM.start(5, null);
        this.shionM.start(5, null);
        this.camerawork.cut13();
        this.pc.loadCamera("c03s55cut13.cam");
        this.pc.init(1, 0);
        this.pc.start();
        System.sleep(28);
        this.msg.print("There can't be any...");
        this.waitclear(76);
        System.sleep(32);
    }
    ...
    class allCHARA
        ...
        public void act11_chara() {
            SCE03055.this.shion.setVisible(true);
            SCE03055.this.momo.setVisible(true);
            SCE03055.this.jr.setVisible(true);
            SCE03055.this.chaos.setVisible(false);
        }

        public void act12_chara() {
            SCE03055.this.shion.setVisible(true);
            SCE03055.this.momo.setVisible(false);
            SCE03055.this.jr.setVisible(false);
            SCE03055.this.chaos.setVisible(false);
        }

        public void act13_chara() {
            SCE03055.this.momoM.setVisible(true);
            SCE03055.this.shionM.setVisible(true);
            SCE03055.this.chaos.setVisible(true);
            SCE03055.this.jr.setVisible(true);
            SCE03055.this.shionM.face.setVisible(false);
            SCE03055.this.momo.setVisible(false);
            SCE03055.this.shion.setVisible(false);
        }

        public void act1_chara() {
            SCE03055.this.shion.setTranslate(0.0f, 0.005f, 0.0f);
            SCE03055.this.shionM.setTranslate(0.0f, 0.005f, 0.0f);
            SCE03055.this.momo.setTranslate(0.0f, 0.005f, 0.0f);
            SCE03055.this.momoM.setTranslate(0.0f, 0.005f, 0.0f);
            SCE03055.this.chaos.setTranslate(0.0f, 0.01f, 0.0f);
            SCE03055.this.jr.setTranslate(0.0f, 0.005f, 0.0f);
            SCE03055.this.shionM.setVisible(true);
            SCE03055.this.momoM.setVisible(true);
            SCE03055.this.jr.setVisible(true);
            SCE03055.this.chaos.setVisible(true);
            ...
            SCE03055.this.shion.setVisible(false);
            SCE03055.this.momo.setVisible(false);
            SCE03055.this.guno1.setVisible(false);
            SCE03055.this.guno2.setVisible(false);
        }

        public void act2_shadow() {
            SCE03055.this.shionM.shadow_map_id(29);
            SCE03055.this.momoM.shadow_map_id(29);
            SCE03055.this.chaos.shadow_map_id(29);
            SCE03055.this.jr.shadow_map_id(29);
            SCE03055.this.shionM.setShadow(8, 80);
            SCE03055.this.momoM.setShadow(8, 80);
            SCE03055.this.chaos.setShadow(8, 80);
            SCE03055.this.jr.setShadow(8, 80);
        }

        public void act3_chara() {
            SCE03055.this.momo.setVisible(true);
            SCE03055.this.shion.setVisible(true);
            SCE03055.this.momo.face.setVisible(false);
            SCE03055.this.momoM.setVisible(false);
            SCE03055.this.shionM.setVisible(false);
        }

        public void act3_shadow() {
            SCE03055.this.shion.shadow_map_id(29);
            SCE03055.this.shion.setShadow(8, 80);
            SCE03055.this.shionM.setShadow(0, 0);
            SCE03055.this.momoM.setShadow(0, 0);
            SCE03055.this.chaos.setShadow(0, 0);
            SCE03055.this.jr.setShadow(0, 0);
        }

        public void act4_chara() {
            SCE03055.this.momo.face.setVisible(true);
        }
        ...
        public void act6_chara() {
            SCE03055.this.guno1.setVisible(true);
            SCE03055.this.guno2.setVisible(true);
            SCE03055.this.momo.setVisible(false);
        }
        ...
        public void act8_chara() {
            ...
            SCE03055.this.shion.setVisible(false);
            SCE03055.this.momo.face.setVisible(false);
            SCE03055.this.jr.face.setVisible(false);
            SCE03055.this.chaos.face.setVisible(false);
            SCE03055.this.guno1.setVisible(false);
            SCE03055.this.guno2.setVisible(false);
        }
        ...
        public void act9_chara() {
            SCE03055.this.momo.setVisible(true);
            SCE03055.this.momo.face.setVisible(true);
            SCE03055.this.jr.face.setVisible(true);
            SCE03055.this.chaos.face.setVisible(true);
            SCE03055.this.shion.setVisible(false);
            SCE03055.this.shionM.setVisible(false);
            SCE03055.this.momoM.setVisible(false);
        }
        ...
        public void act_off_shadow() {
            SCE03055.this.shion.setShadow(0, 0);
            SCE03055.this.shionM.setShadow(0, 0);
            SCE03055.this.momo.setShadow(0, 0);
            SCE03055.this.momoM.setShadow(0, 0);
            SCE03055.this.chaos.setShadow(0, 0);
            SCE03055.this.jr.setShadow(0, 0);
        }

        public void act_set_shadow() {
            SCE03055.this.shionM.setShadow(8, 80);
            SCE03055.this.momoM.setShadow(8, 80);
            SCE03055.this.chaos.setShadow(8, 80);
            SCE03055.this.jr.setShadow(8, 80);
    ...
    class allFACE
        ...
        public void eyes10_momo() {
            SCE03055.this.momo.look_default();
            SCE03055.this.momo.look_eye_speed(999.0f);
            SCE03055.this.momo.look_eye_set(0.0f, 4.0f);
            System.sleep(145);
            SCE03055.this.momo.look_default();
        }
        ...
        public void face10_jr() {
            System.sleep(30);
            SCE03055.this.jr.face.mtn(7, 0, 2, 8, 0, 0.2f, false);
            SCE03055.this.jr.face.start(4, null);
            System.sleep(45);
            SCE03055.this.jr.face.mtn(7, 0, 2, 8, 0, -0.15f, false);
            SCE03055.this.jr.face.start(4, null);
            System.sleep(23);
            SCE03055.this.jr.face.mtn(7, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.jr.face.start(4, null);
            System.sleep(27);
            SCE03055.this.jr.face.mtn(8, 0, 120, 8, 9, 1.0f, false);
            SCE03055.this.jr.face.start(4, null);
            System.sleep(18);
        }

        public void face10_momo() {
            SCE03055.this.momo.face.mtn(8, 58, 58, 5, 0, 1.0f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(98);
            System.sleep(5);
            SCE03055.this.momo.face.mtn(8, 58, 60, 5, 0, 0.15f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(20);
            SCE03055.this.momo.face.mtn(8, 58, 60, 5, 0, -0.12f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(50);
            System.sleep(30);
            System.sleep(20);
            SCE03055.this.momo.face.mtn(12, 0, 120, 8, 9, 1.0f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(60);
            System.sleep(50);
        }

        public void face11_momo() {
            SCE03055.this.momo.face.mtn(7, 0, 120, 8, 9, 1.0f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(30);
            SCE03055.this.momo.face.mtn(8, 55, 60, 5, 0, 0.25f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(10);
        }

        public void face12_shion() {
            SCE03055.this.shion.face.mtn(7, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.shion.face.start(4, null);
            System.sleep(42);
            SCE03055.this.shion.face.mtn(8, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.shion.face.start(4, null);
            System.sleep(28);
            SCE03055.this.shion.face.mtn(7, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.shion.face.start(4, null);
            ...
            System.sleep(7);
            System.sleep(9);
            SCE03055.this.shion.face.mtn(7, 0, 120, 5, 0, 0.8f, false);
            SCE03055.this.shion.face.start(4, null);
            System.sleep(22);
            SCE03055.this.shion.face.mtn(8, 0, 120, 8, 9, 1.0f, false);
            SCE03055.this.shion.face.start(4, null);
            System.sleep(9);
        }

        public void face1_chaos() {
            SCE03055.this.chaos.face.mtn(8, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.chaos.face.start(4, null);
        }

        public void face1_jr() {
            SCE03055.this.jr.face.mtn(8, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.jr.face.start(4, null);
        }

        public void face1_momo() {
            SCE03055.this.momo.face.mtn(8, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.momo.face.start(4, null);
        }
        ...
        public void face4_momo() {
            SCE03055.this.momo.face.mtn(8, 53, 53, 5, 0, 1.0f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(197);
            SCE03055.this.momo.face.mtn(8, 53, 120, 5, 0, 0.15f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(20);
            System.sleep(9);
            SCE03055.this.momo.face.mtn(7, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(42);
            SCE03055.this.momo.face.mtn(8, 0, 120, 5, 9, 1.0f, false);
            SCE03055.this.momo.face.start(4, null);
            ...
            SCE03055.this.momo.face.start(4, null);
            System.sleep(30);
            SCE03055.this.momo.face.mtn(8, 0, 120, 8, 9, 1.0f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(9);
            SCE03055.this.momo.face.mtn(8, 55, 58, 5, 0, 0.15f, false);
            SCE03055.this.momo.face.start(4, null);
            System.sleep(12);
        }
    }
    ...
    class allUNIT
        ...
        public void MAPeff_off() {
            SCE03055.this.E01.disp(false);
            SCE03055.this.E02.disp(false);
        }

        public void MAPeff_set() {
            SCE03055.this.E01.disp(true);
            SCE03055.this.E02.disp(true);
        }

        public void fog_check() {
            SCE03055.this.fog.setTranslate(0.0f, 0.0f, 0.0f);
            SCE03055.this.fog.setRotate(0.0f, 0.0f, 0.0f);
            while (true) {
                SCE03055.this.cam1.setFog(1, SCE03055.this.fog.px, SCE03055.this.fog.pz, SCE03055.this.fog.py, SCE03055.this.fog.ry / 1000.0f, 128, 128, 128, 0);
                System.sleep(1);
            }
        }
        ...
        public void point_check0() {
            while (true) {
                SCE03055.this.light1.setGlobalPointLightCol(0, SCE03055.this.point0.rx / 100.0f, SCE03055.this.point0.ry / 100.0f, SCE03055.this.point0.rz / 100.0f);
                SCE03055.this.light1.setGlobalPointLightPos(0, SCE03055.this.point0.px, SCE03055.this.point0.py, SCE03055.this.point0.pz);
                System.sleep(1);
            }
        }
        ...
        public void point_check1() {
            while (true) {
                SCE03055.this.light1.setGlobalPointLightCol(1, SCE03055.this.point1.rx / 100.0f, SCE03055.this.point1.ry / 100.0f, SCE03055.this.point1.rz / 100.0f);
                SCE03055.this.light1.setGlobalPointLightPos(1, SCE03055.this.point1.px, SCE03055.this.point1.py, SCE03055.this.point1.pz);
                System.sleep(1);
            }
        }
        ...
        public void point_check2() {
            while (true) {
                SCE03055.this.light1.setGlobalPointLightCol(2, SCE03055.this.point2.rx / 100.0f, SCE03055.this.point2.ry / 100.0f, SCE03055.this.point2.rz / 100.0f);
                SCE03055.this.light1.setGlobalPointLightPos(2, SCE03055.this.point2.px, SCE03055.this.point2.py, SCE03055.this.point2.pz);
                System.sleep(1);
            }
        }
    ...
    class Camerawork
        ...
        public void cut0() {
            SCE03055.this.light.setColor(0, 0.25f, 0.25f, 0.25f);
            SCE03055.this.light.setColor(1, 0.6f, 0.6f, 0.6f);
            SCE03055.this.light.setDirection2(1, 0.0f, 0.626f, 0.78f);
            SCE03055.this.light.setColor(2, 0.5f, 0.5f, 0.5f);
            SCE03055.this.light.setDirection2(2, 0.676f, 0.707f, -0.207f);
            SCE03055.this.light.setColor(3, 0.5f, 0.5f, 0.5f);
            SCE03055.this.light.setDirection2(3, -0.544f, -0.369f, -0.753f);
        ...
        public void cut1() {
            SCE03055.this.Timechk_CutChange();
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.4f, 0.56f, 0.56f);
            SCE03055.this.light.setDirection2(1, -0.092f, 0.0f, -0.996f);
            SCE03055.this.light.setColor(2, 0.22f, 0.35f, 0.35f);
            SCE03055.this.light.setDirection2(2, 0.773f, 0.001f, 0.634f);
            SCE03055.this.light.setColor(3, 0.08f, 0.08f, 0.04f);
            SCE03055.this.light.setDirection2(3, 0.494f, -0.868f, 0.049f);
        ...
        public void cut10() {
            ...
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.4f, 0.56f, 0.56f);
            SCE03055.this.light.setDirection2(1, -0.582f, -0.322f, -0.747f);
            SCE03055.this.light.setColor(2, 0.13f, 0.26f, 0.26f);
            SCE03055.this.light.setDirection2(2, 0.745f, 0.474f, -0.47f);
            SCE03055.this.light.setColor(3, 0.17f, 0.17f, 0.13f);
            SCE03055.this.light.setDirection2(3, 0.353f, -0.897f, -0.267f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            SCE03055.this.momo.setLightMode(1);
            SCE03055.this.momo.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.momo.light.setColor(1, 0.4f, 0.56f, 0.56f);
            SCE03055.this.momo.light.setDirection2(1, -0.841f, 0.066f, -0.537f);
            SCE03055.this.momo.light.setColor(2, 0.13f, 0.24f, 0.26f);
            SCE03055.this.momo.light.setDirection2(2, 0.821f, 0.0f, -0.571f);
            SCE03055.this.momo.light.setColor(3, 0.18f, 0.18f, 0.13f);
            SCE03055.this.momo.light.setDirection2(3, 0.698f, -0.7f, 0.153f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
            Runtime.setDefocusQuick(3, 0, 0x100000, 1);
        ...
        public void cut11() {
            SCE03055.this.Timechk_CutChange();
            SCE03055.this.momo.setLightMode(0);
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.39f, 0.55f, 0.55f);
            SCE03055.this.light.setDirection2(1, 0.377f, 0.02f, -0.926f);
            SCE03055.this.light.setColor(2, 0.1f, 0.23f, 0.25f);
            SCE03055.this.light.setDirection2(2, 0.564f, 0.019f, 0.826f);
            SCE03055.this.light.setColor(3, 0.18f, 0.18f, 0.13f);
            SCE03055.this.light.setDirection2(3, 0.879f, -0.473f, 0.057f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
        ...
        public void cut12() {
            SCE03055.this.Timechk_CutChange();
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.44f, 0.63f, 0.63f);
            SCE03055.this.light.setDirection2(1, 0.66f, 0.02f, -0.751f);
            SCE03055.this.light.setColor(2, 0.13f, 0.26f, 0.26f);
            SCE03055.this.light.setDirection2(2, 0.384f, 0.025f, 0.923f);
            SCE03055.this.light.setColor(3, 0.17f, 0.17f, 0.13f);
            SCE03055.this.light.setDirection2(3, 0.583f, -0.812f, 0.039f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
        ...
        public void cut13() {
            ...
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.4f, 0.56f, 0.56f);
            SCE03055.this.light.setDirection2(1, -0.032f, 0.0f, -0.999f);
            SCE03055.this.light.setColor(2, 0.22f, 0.35f, 0.35f);
            SCE03055.this.light.setDirection2(2, 0.178f, 0.71f, 0.681f);
            SCE03055.this.light.setColor(3, 0.08f, 0.08f, 0.04f);
            SCE03055.this.light.setDirection2(3, 0.583f, -0.811f, 0.039f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
        ...
        public void cut2() {
            SCE03055.this.Timechk_CutChange();
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.23f, 0.23f, 0.13f);
            SCE03055.this.light.setDirection2(1, 0.995f, 0.028f, -0.096f);
            SCE03055.this.light.setColor(2, 0.28f, 0.5f, 0.5f);
            SCE03055.this.light.setDirection2(2, -0.009f, 0.527f, -0.85f);
            SCE03055.this.light.setColor(3, 0.27f, 0.27f, 0.17f);
            SCE03055.this.light.setDirection2(3, -0.992f, 0.0f, -0.127f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
        ...
        public void cut3() {
            ...
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.4f, 0.56f, 0.56f);
            SCE03055.this.light.setDirection2(1, 0.999f, 0.005f, -0.045f);
            SCE03055.this.light.setColor(2, 0.18f, 0.27f, 0.27f);
            SCE03055.this.light.setDirection2(2, -0.192f, 0.194f, 0.962f);
            SCE03055.this.light.setColor(3, 0.18f, 0.18f, 0.13f);
            SCE03055.this.light.setDirection2(3, -0.55f, -0.572f, 0.609f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            SCE03055.this.momo.setLightMode(1);
            SCE03055.this.momo.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.momo.light.setColor(1, 0.4f, 0.56f, 0.56f);
            SCE03055.this.momo.light.setDirection2(1, -0.998f, 0.027f, -0.057f);
            SCE03055.this.momo.light.setColor(2, 0.25f, 0.34f, 0.34f);
            SCE03055.this.momo.light.setDirection2(2, 0.194f, 0.732f, 0.653f);
            SCE03055.this.momo.light.setColor(3, 0.19f, 0.19f, 0.14f);
            SCE03055.this.momo.light.setDirection2(3, 0.845f, -0.504f, 0.179f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
            Runtime.setDefocusQuick(3, 0, 0x100000, 1);
        ...
        public void cut4() {
            ...
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.4f, 0.56f, 0.56f);
            SCE03055.this.light.setDirection2(1, -0.883f, -0.064f, -0.465f);
            SCE03055.this.light.setColor(2, 0.22f, 0.35f, 0.35f);
            SCE03055.this.light.setDirection2(2, 0.687f, 0.607f, -0.4f);
            SCE03055.this.light.setColor(3, 0.18f, 0.18f, 0.13f);
            SCE03055.this.light.setDirection2(3, 0.484f, -0.705f, -0.519f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
        ...
        public void cut5() {
            SCE03055.this.Timechk_CutChange();
            SCE03055.this.light.setColor(0, 0.05f, 0.07f, 0.1f);
            SCE03055.this.light.setColor(1, 0.63f, 0.6f, 0.52f);
            SCE03055.this.light.setDirection2(1, -0.715f, 0.611f, 0.34f);
            SCE03055.this.light.setColor(2, 0.27f, 0.29f, 0.28f);
            SCE03055.this.light.setDirection2(2, 0.933f, 0.241f, 0.267f);
            SCE03055.this.light.setColor(3, 0.15f, 0.15f, 0.15f);
            SCE03055.this.light.setDirection2(3, -0.243f, -0.415f, -0.877f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
        }
        ...
        public void cut6() {
            ...
            SCE03055.this.light.setColor(0, 0.05f, 0.07f, 0.1f);
            SCE03055.this.light.setColor(1, 0.63f, 0.6f, 0.52f);
            SCE03055.this.light.setDirection2(1, -0.348f, 0.927f, -0.141f);
            SCE03055.this.light.setColor(2, 0.38f, 0.4f, 0.4f);
            SCE03055.this.light.setDirection2(2, 0.57f, 0.024f, 0.822f);
            SCE03055.this.light.setColor(3, 0.33f, 0.33f, 0.33f);
            SCE03055.this.light.setDirection2(3, -0.221f, -0.969f, -0.108f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
        ...
        public void cut8() {
            ...
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.23f, 0.23f, 0.13f);
            SCE03055.this.light.setDirection2(1, 0.972f, 0.032f, -0.233f);
            SCE03055.this.light.setColor(2, 0.36f, 0.47f, 0.47f);
            SCE03055.this.light.setDirection2(2, 0.039f, 0.649f, 0.76f);
            SCE03055.this.light.setColor(3, 0.27f, 0.27f, 0.17f);
            SCE03055.this.light.setDirection2(3, -0.989f, 0.0f, 0.146f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
        ...
        public void cut9() {
            SCE03055.this.Timechk_CutChange();
            SCE03055.this.light.setColor(0, 0.1f, 0.1f, 0.1f);
            SCE03055.this.light.setColor(1, 0.41f, 0.56f, 0.56f);
            SCE03055.this.light.setDirection2(1, -0.962f, 0.142f, -0.233f);
            SCE03055.this.light.setColor(2, 0.2f, 0.29f, 0.28f);
            SCE03055.this.light.setDirection2(2, 0.309f, 0.245f, 0.919f);
            SCE03055.this.light.setColor(3, 0.24f, 0.24f, 0.13f);
            SCE03055.this.light.setDirection2(3, 0.752f, -0.647f, 0.127f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 0x100000, 2);
            Runtime.setDefocusQuick(1, 0, 0x100000, 1);
            Runtime.setDefocusQuick(2, 0, 0x100000, 1);
