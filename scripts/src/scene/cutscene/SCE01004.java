...
class SCE01004
    ...
    Chr Fshion1;
    Chr Fallen1;
    static final int movie_id = 9971;
    static final int movie_length = 3975;
    Movie movie;
    Spline movSPL;
    Spline rotSPL;
    Spline movSPL2;
    ...
    public void cleanup() {
        ...
        System.println("XEVEFLAG:EV01004_F");
        Runtime.setFlags(7, 1, 1);
        System.println("XEVEJNAME:SCE01005");
        Runtime.jumpEvent(1050);
    }
    ...
    void init() {
        ...
        this.togashi = new allCHARA(301);
        this.staff1 = new allCHARA(514);
        this.shion.getChild(0x1000000).setShadow(0, 0);
        this.allen.getChild(0x1000000).setShadow(0, 0);
        this.togashi.getChild(0x1000000).setShadow(0, 0);
        this.staff1.getChild(0x1000000).setShadow(0, 0);
        this.seat = new allMECHA(20583, 0.5f, 0.0f, 0.7f, 180.0f);
        this.headset0 = new allUNIT(24580);
        this.headset1 = new allUNIT(24580);
        this.headgear0 = new allUNIT(24581);
        this.headgear1 = new allUNIT(24581);
        this.glasses = new allUNIT(24643);
        this.headgear0.setTranslate(4.15f, 0.07f, -5.4f);
        this.headgear0.setRotate(6.0f, 55.0f, 175.0f);
        this.glasses.setVisible(false);
        this.Fshion = new allFACE();
        this.Fallen = new allFACE();
        this.Ftogashi = new allFACE();
        this.Fstaff1 = new allFACE();
        this.Fshion1 = new allFACE();
        this.Fallen1 = new allFACE();
        this.movie = new Movie();
        this.movie.init();
        this.movie.transparent = 0;
        this.movie.alpha = 128;
        this.movie.update();
        ...
        this.cut6_fade1 = new Effect(0);
        this.cut6_fade1.args[0] = -2130706433;
        this.cut6_fade1.args[1] = 10;
        this.cut6_fade1.args[2] = 0;
        this.cut6_fade2 = new Effect(0);
        this.cut6_fade2.args[0] = -2130706433;
        this.cut6_fade2.args[1] = 20;
        this.cut6_fade2.args[2] = 1;
        this.cut7_fade1 = new Effect(0);
        this.cut7_fade1.args[0] = -2130706433;
        this.cut7_fade1.args[1] = 20;
        this.cut7_fade1.args[2] = 0;
        this.cut7_fade2 = new Effect(0);
        this.cut7_fade2.args[0] = -2130706433;
        this.cut7_fade2.args[1] = 15;
    ...
    void play() {
        ...
        this.loadarc(this.allen.getChild(0x1000000), "FLSallen_h.fpk");
        this.loadarc(this.togashi.getChild(0x1000000), "FLStogashi.fpk");
        this.loadarc(this.staff1.getChild(0x1000000), "FLSvec_m.fpk");
        this.playSCENE1();
        this.playSCENE2();
        this.playSCENE4();
    ...
    void playAGAIN() {
        ...
        this.SETcheck("アレン", this.allen);
        this.SETcheck("ヘッドセット０", this.headgear0);
        this.SETcheck("トガシ", this.togashi);
        this.SETcheck("研究員１", this.staff1);
    }

    void playSCENE1() {
        Sound.streamPlay(0x122888, 48000);
        Stage.renderCommand(4);
        this.shion.setMotionFlags(0x2000000, true);
        this.allen.start(1, "act1_allen");
        this.togashi.setVisible(false);
        this.staff1.setVisible(false);
        this.headgear1.start(1, "act1_headgear1");
        this.headset1.start(1, "act1_headset1");
        this.Fallen.start(1, "face1_allen");
        this.Fstaff1.start(1, "face1_staff1");
        this.camerawork.cut1();
        System.sleep(5);
        this.msg_print("【アレン】", "Chief?!");
        this.waitclear(30);
        System.sleep(5);
        System.sleep(20);
        this.shion.start(1, "act2_shion");
        this.seat.start(1, "act2_seat");
        this.headset0.start(1, "act2_headset0");
        this.glasses.start(1, "act2_glasses");
        ...
        this.seat.renderCommand(22);
        this.togashi.renderCommand(22);
        this.staff1.renderCommand(22);
        this.shion.start(1, "act3_shion");
        this.allen.start(1, "act3_allen");
        this.togashi.start(1, "act3_togashi");
        this.staff1.start(1, "act3_staff1");
        this.Fallen.start(1, "face3_allen");
        this.Fshion.start(1, "face3_shion");
        this.camerawork.cut3();
        System.sleep(15);
        this.msg_print("【アレン】", "Are you...all right?");
        this.waitclear(65);
        System.sleep(10);
        this.msg_print("【シオン】", "Yeah...thanks.");
        System.sleep(25);
        this.shion.renderCommand(0);
        this.allen.renderCommand(0);
        this.shion.start(1, "act4_shion");
        this.allen.start(1, "act4_allen");
        this.togashi.start(1, "reset_mot");
        this.staff1.start(1, "reset_mot");
        this.glasses.start(1, "act4_glasses");
        this.Fshion.start(1, "face4_shion");
        this.Fshion1.start(1, "eyes4_shion");
        this.camerawork.cut4();
        this.waitclear(50);
        System.sleep(10);
        this.msg.print("Did I push my luck a little\ntoo far this time?");
        this.waitclear(90);
        System.sleep(20);
        System.sleep(40);
        this.msg_print("【シオン】", "Allen?");
        this.waitclear(30);
        System.sleep(10);
    }
    ...
    void playSCENE2() {
        ...
        this.msg_print("【アレン】", "You can't...keep doing this, Chief.");
        this.waitclear(130);
        this.msg.print("I thought I was going to have\na heart attack.");
        this.waitclear(85);
        this.msg_print("【シオン】", "Sorry about that...But I bet\nthe data's really good.");
        System.sleep(35);
        System.sleep(10);
        this.waitclear(90);
        System.sleep(10);
    ...
    void playSCENE3() {
        ...
        this.msg.print("それに────");
        System.sleep(15);
        this.camerawork.cut6_2();
        this.waitclear(20);
        System.sleep(20);
        this.cut6_fade1.call(0);
        System.sleep(10);
        this.Timechk_CutChange();
    }

    void playSCENE4() {
        Sound.streamPlay(1190066, 48000);
        this.shion.start(1, "act8_shion");
        this.Fshion.start(1, "face8_shion");
        this.Fshion1.start(1, "eyes8_shion");
        this.cut7_fade2.call(0);
        this.camerawork.cut8();
        System.sleep(5);
        System.sleep(30);
        this.msg_print("【アレン】", "Was there something else?");
        System.sleep(53);
        this.waitclear(7);
        System.sleep(15);
        ...
        this.camerawork.cut5();
        this.msg_print("【シオン】", "Hmm? Oh...it's nothing. Well, we\nbetter get started on that data.");
        System.sleep(48);
        System.sleep(10);
        this.waitclear(82);
        System.sleep(35);
        ...
        this.Fallen.start(1, "face10_allen");
        this.Fshion1.start(1, "eyes10_shion");
        this.camerawork.cut10();
        System.sleep(5);
        this.msg.print("Today's our deadline, so I'm sure\nthey'll be asking for it soon.");
        System.sleep(30);
        System.sleep(20);
        this.waitclear(75);
        System.sleep(10);
        this.msg.print("Attention, please.\nWe are scheduled to gate out");
        this.waitclear(55);
        System.sleep(5);
        this.Fshion.start(1, "face10_2_shion");
        this.msg.print("in approximately 3 minutes.\nAll hands, please return to your\ndesignated areas immediately.");
        System.sleep(20);
        this.camerawork.cut10_2();
        System.sleep(71);
        System.sleep(15);
        this.waitclear(119);
        System.sleep(15);
        this.msg.print("Once again...");
        System.sleep(35);
        System.sleep(10);
        this.waitclear(35);
    }
    ...
    void trace0(Chr chr) {
        this.unit0.transCNS(chr, 13, 0.0f, 0.0f, 0.0f);
        this.unit0.rotYCNS(chr, 13, 0.0f, 0.0f, 0.0f);
    }

    void trace1(Chr chr) {
        this.unit1.transCNS(chr, 13, 0.0f, 0.0f, 0.0f);
        this.unit1.rotYCNS(chr, 13, 0.0f, 0.0f, 0.0f);
    }

    void trace2(Chr chr) {
        this.unit2.transCNS(chr, 13, 0.0f, 0.0f, 0.0f);
        this.unit2.rotYCNS(chr, 13, 0.0f, 0.0f, 0.0f);
    }
    ...
    class allCHARA
        ...
        public void act10_allen() {
            this.setTranslate(1.75f, 0.0f, -0.2f);
        ...
        public void act10_shion() {
            this.setTranslate(0.83f, 0.0f, -0.56f);
            this.setRotate(0.0f, 84.2f, 0.0f);
            this.setVisible(10, false);
            this.mtn(272, 8, 1.0f, true);
        }

        public void act1_allen() {
            this.setTranslate(5.1f, 0.0f, -4.15f);
            this.setRotate(0.0f, 90.0f, 0.0f);
            this.mtn(257, 0, 1.0f, true);
        }

        public void act2_shion() {
            this.setTranslate(0.5f, 0.2f, 0.0f);
            this.setRotate(0.0f, 180.0f, 0.0f);
            this.getChild(0x1000000).setVisible(9, false);
            this.getChild(0x1000000).setVisible(10, false);
            this.mtn(258, 0, 1.0f, true);
        }

        public void act3_allen() {
            this.setTranslate(3.6f, 0.0f, -2.0f);
            this.setRotate(0.0f, -60.0f, 0.0f);
            this.mtn(260, 8, 1.0f, true);
        }

        public void act3_shion() {
            this.setTranslate(0.5f, 0.24f, 0.1f);
            this.setRotate(-7.0f, 180.0f, -1.0f);
            this.mtn(259, 8, 1.0f, true);
        }

        public void act3_staff1() {
            this.setTranslate(1.78f, 0.0f, -4.97f);
            this.setRotate(0.0f, 33.0f, 0.0f);
            this.setVisible(true);
            this.mtn(262, 8, 1.0f, true);
        }

        public void act3_togashi() {
            this.setTranslate(2.95f, 0.0f, -0.5f);
        ...
        public void act4_allen() {
            this.setTranslate(1.65f, 0.0f, -0.3f);
            this.setRotate(0.0f, 240.0f, 0.0f);
            this.mtn(264, 0, 1.0f, true);
        }

        public void act4_shion() {
            this.setTranslate(0.65f, 0.0f, -0.45f);
            this.setRotate(0.0f, 100.0f, 0.0f);
            this.getChild(0x1000000).setVisible(9, true);
            this.getChild(0x1000000).setVisible(10, true);
            this.mtn(263, 8, 1.0f, true);
        }

        public void act4_staff1() {
            this.mtn(1, 9, 1.0f, true);
        }

        public void act4_togashi() {
            this.mtn(1, 9, 1.0f, true);
        }
        ...
        public void act5_allen() {
            ...
            this.setVisible(4, false);
            this.mtn(266, 8, 0.9f, true);
        }

        public void act5_shion() {
            this.setTranslate(0.83f, 0.0f, -0.56f);
            this.setRotate(0.0f, 66.2f, 0.0f);
            SCE01004.this.trace0(SCE01004.this.shion);
            this.mtn(265, -2147483640, 0.9f, true);
        }
        ...
        public void act6_shion() {
            this.setTranslate(0.79f, 0.0f, -0.57f);
            this.setRotate(0.0f, 66.2f, 0.0f);
            this.setRotate(0.0f, 70.2f, 0.0f);
            this.mtn(267, -2147483640, 1.0f, true);
            this.mtn(267, -2147483640, -1.0f, true);
        }
        ...
        public void act8_shion() {
            this.setTranslate(0.79f, 0.0f, -0.57f);
            this.setRotate(0.0f, 66.2f, 0.0f);
            this.mtn(269, -2147483640, 0.9f, true);
        }
        ...
        public void act9_shion() {
            this.setTranslate(0.83f, 0.0f, -0.56f);
            this.setRotate(0.0f, 66.2f, 0.0f);
            this.mtn(270, -2147483640, 1.0f, true);
        }
    ...
    class allMECHA
        ...
        void act2_seat() {
            this.mtn(274, 200, 270, 0, 0, -1.0f, true);
            this.mtn(274, 153, 200, 0, 0, -0.65f, true);
        }
    ...
    class allFACE
        ...
        public void eyes10_shion() {
            System.sleep(5);
            System.sleep(10);
            SCE01004.this.shion.look_eye_speed(0.8f);
            SCE01004.this.shion.look_eye_set(1.0f, -1.5f);
            System.sleep(115);
            System.sleep(15);
            SCE01004.this.shion.look_eye_speed(0.8f);
            SCE01004.this.shion.look_eye_set(0.0f, -2.5f);
            System.sleep(44);
            SCE01004.this.shion.look_eye_speed(0.8f);
            SCE01004.this.shion.look_eye_set(1.0f, -0.5f);
        }

        public void eyes4_shion() {
            SCE01004.this.shion.look_default();
            SCE01004.this.shion.look_eye_speed(0.5f);
            SCE01004.this.shion.look_eye_set(2.5f, 1.0f);
            System.sleep(20);
            SCE01004.this.shion.look_eye_speed(0.45f);
            SCE01004.this.shion.look_eye_set(-2.0f, 1.0f);
            System.sleep(25);
            SCE01004.this.shion.look_eye_speed(0.6f);
            SCE01004.this.shion.look_eye_set(-0.0f, 1.0f);
            System.sleep(15);
            SCE01004.this.shion.look_eye_speed(0.35f);
            SCE01004.this.shion.look_eye_set(-6.0f, 3.0f);
            System.sleep(85);
            SCE01004.this.shion.look_eye_speed(0.7f);
            SCE01004.this.shion.look_eye_set(0.0f, 1.0f);
            System.sleep(5);
        }
        ...
        public void eyes5_shion() {
            ...
            System.sleep(40);
            SCE01004.this.shion.look_eye_speed(0.6f);
            SCE01004.this.shion.look_eye_set(0.0f, 1.5f);
            System.sleep(45);
        }
        ...
        public void eyes6_shion() {
            System.sleep(15);
            System.sleep(15);
            SCE01004.this.shion.look_eye_speed(1.5f);
            SCE01004.this.shion.look_eye_set(0.0f, -1.5f);
            System.sleep(25);
        }
        ...
        public void eyes8_shion() {
            System.sleep(5);
            System.sleep(15);
            SCE01004.this.shion.look_eye_speed(1.8f);
            SCE01004.this.shion.look_eye_set(0.0f, 1.5f);
            System.sleep(75);
        }

        public void face10_2_shion() {
            System.sleep(15);
            SCE01004.this.shion.face.mtn(1, 0, 4, 16, 0, 0.2f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(35);
            SCE01004.this.shion.face.mtn(20, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(50);
            SCE01004.this.shion.face.mtn(2, 0, 120, 16, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
        }

        public void face10_allen() {
            System.sleep(210);
            SCE01004.this.allen.face.mtn(28, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(70);
            SCE01004.this.allen.face.mtn(4, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(10);
            SCE01004.this.allen.face.mtn(3, 0, 4, 0, 0, 0.8f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(30);
            SCE01004.this.allen.face.mtn(4, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
        ...
        public void face10_shion() {
            System.sleep(5);
            System.sleep(4);
            SCE01004.this.shion.face.mtn(1, 0, 120, 0, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(26);
            SCE01004.this.shion.face.mtn(2, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(20);
            SCE01004.this.shion.face.mtn(1, 0, 120, 0, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(70);
            SCE01004.this.shion.face.mtn(2, 0, 120, 10, 9, 0.8f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(5);
        }
        ...
        public void face1_allen() {
            System.sleep(5);
            System.sleep(4);
            SCE01004.this.allen.face.mtn(9, 0, 14, 8, 0, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(15);
            SCE01004.this.allen.face.mtn(9, 15, 18, 8, 0, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(6);
            SCE01004.this.allen.face.mtn(10, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
        }

        public void face1_staff1() {
            SCE01004.this.staff1.face.mtn(2, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.staff1.face.start(4, null);
        }

        public void face1_togashi() {
            SCE01004.this.togashi.face.mtn(2, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.togashi.face.start(4, null);
        }

        public void face2_shion() {
            SCE01004.this.shion.face.mtn(2, 106, 106, 8, 0, 0.07f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(55);
            SCE01004.this.shion.face.mtn(2, 106, 108, 8, 0, 0.12f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(25);
            SCE01004.this.shion.face.mtn(2, 103, 108, 8, 0, -0.12f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(60);
            SCE01004.this.shion.face.mtn(2, 103, 108, 8, 0, 0.6f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(10);
            SCE01004.this.shion.face.mtn(2, 90, 108, 8, 0, -0.4f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(30);
            SCE01004.this.shion.face.mtn(2, 103, 120, 8, 0, 0.9f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(20);
            SCE01004.this.shion.face.mtn(2, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
        }
        ...
        public void face3_allen() {
            System.sleep(15);
            System.sleep(5);
            SCE01004.this.allen.face.mtn(25, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(20);
            SCE01004.this.allen.face.mtn(26, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(17);
            SCE01004.this.allen.face.mtn(25, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
        ...
        public void face3_shion() {
            System.sleep(90);
            System.sleep(5);
            SCE01004.this.shion.face.mtn(1, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(9);
            SCE01004.this.shion.face.mtn(2, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
        ...
        public void face4_shion() {
            SCE01004.this.shion.face.mtn(1, 0, 34, 8, 0, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(35);
            SCE01004.this.shion.face.mtn(1, 35, 43, 8, 0, 0.4f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(9);
            SCE01004.this.shion.face.mtn(2, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            ...
            System.sleep(10);
            System.sleep(6);
            SCE01004.this.shion.face.mtn(7, 0, 50, 8, 1, 0.9f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(52);
            SCE01004.this.shion.face.mtn(7, 51, 56, 8, 0, 0.2f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(6);
            SCE01004.this.shion.face.mtn(7, 0, 14, 8, 0, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(15);
            SCE01004.this.shion.face.mtn(7, 15, 19, 8, 0, 0.2f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(5);
            SCE01004.this.shion.face.mtn(8, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(6);
            System.sleep(20);
            SCE01004.this.shion.face.mtn(39, 0, 40, 8, 0, 0.2f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(40);
            System.sleep(5);
            SCE01004.this.shion.face.mtn(39, 0, 16, 8, 0, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(17);
            SCE01004.this.shion.face.mtn(39, 17, 24, 8, 0, 0.25f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(5);
            SCE01004.this.shion.face.mtn(40, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(5);
        }
        ...
        public void face5_allen() {
            System.sleep(6);
            SCE01004.this.allen.face.mtn(1, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(21);
            SCE01004.this.allen.face.mtn(2, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
            System.sleep(19);
            SCE01004.this.allen.face.mtn(1, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.allen.face.start(4, null);
        ...
        public void face5_shion() {
            SCE01004.this.shion.face.mtn(40, 0, 120, 8, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(130);
            SCE01004.this.shion.face.mtn(40, 49, 56, 0, 0, -0.3f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(20);
            SCE01004.this.shion.face.mtn(40, 49, 120, 0, 0, 0.85f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(45);
            SCE01004.this.shion.face.mtn(39, 0, 4, 0, 0, 0.85f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(20);
            SCE01004.this.shion.face.mtn(1, 0, 21, 8, 1, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(22);
            SCE01004.this.shion.face.mtn(1, 22, 25, 0, 0, 0.2f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(8);
            SCE01004.this.shion.face.mtn(2, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            ...
            SCE01004.this.shion.face.start(4, null);
            System.sleep(15);
            SCE01004.this.shion.face.mtn(2, 0, 120, 5, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(10);
            SCE01004.this.shion.face.mtn(1, 0, 120, 0, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(30);
            SCE01004.this.shion.face.mtn(2, 0, 120, 4, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(6);
            SCE01004.this.shion.face.mtn(1, 0, 120, 0, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(24);
            System.sleep(5);
            SCE01004.this.shion.face.mtn(2, 0, 120, 8, 9, 0.8f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(10);
        }
        ...
        public void face6_shion() {
            System.sleep(15);
            System.sleep(5);
            SCE01004.this.shion.face.mtn(1, 0, 14, 8, 0, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(15);
            SCE01004.this.shion.face.mtn(1, 15, 19, 8, 0, 0.2f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(5);
            SCE01004.this.shion.face.mtn(2, 0, 120, 0, 8, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(6);
        }
        ...
        public void face8_shion() {
            System.sleep(55);
            SCE01004.this.shion.face.mtn(39, 0, 4, 4, 1, 0.09f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(15);
            SCE01004.this.shion.face.mtn(39, 3, 4, 4, 1, 0.09f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(10);
        }
        ...
        public void face9_shion() {
            System.sleep(15);
            System.sleep(13);
            SCE01004.this.shion.face.mtn(1, 0, 120, 5, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(20);
            SCE01004.this.shion.face.mtn(2, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(10);
            SCE01004.this.shion.face.mtn(1, 0, 9, 8, 0, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(10);
            SCE01004.this.shion.face.mtn(1, 10, 17, 8, 0, 0.15f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(8);
            SCE01004.this.shion.face.mtn(1, 0, 54, 8, 0, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(55);
            SCE01004.this.shion.face.mtn(1, 55, 59, 8, 0, 0.2f, false);
            SCE01004.this.shion.face.start(4, null);
            System.sleep(4);
            SCE01004.this.shion.face.mtn(2, 0, 120, 8, 9, 1.0f, false);
            SCE01004.this.shion.face.start(4, null);
    ...
    class allUNIT
        ...
        void act1_headgear1() {
            ...
            this.setParent(SCE01004.this.allen, 72);
            this.setTranslate(0.08f, 0.05f, 0.12f);
            this.setRotate(-123.0f, 9.0f, -64.0f);
            SCE01004.this.ASmove(SCE01004.this.headgear1, 16, 0.05f, 0.04f, 0.09f, -60.0f, 32.0f, -138.0f);
            SCE01004.this.ASmove(SCE01004.this.headgear1, 15, 0.37f, 0.88f, 0.09f, -60.0f, 42.0f, -138.0f);
            this.setVisible(false);
        }

        public void act1_headset1() {
            this.setParent(SCE01004.this.allen, 48);
            this.setTranslate(0.03f, -0.04f, -0.085f);
            this.setRotate(-11.0f, 92.0f, 188.0f);
        }

        public void act2_glasses() {
            this.setParent(SCE01004.this.shion, 48);
            this.setTranslate(0.0947499f, -0.0489987f, 3.1E-8f);
            this.setRotate(94.13288f, 90.09844f, 86.19907f);
            this.setVisible(true);
            this.setVisible(1, false);
            this.setVisible(2, false);
        }

        public void act2_headset0() {
            this.setParent(SCE01004.this.shion, 48);
            this.setTranslate(0.0f, -0.04f, -0.09f);
            this.setRotate(-2.0f, 91.0f, 188.0f);
        }

        public void act4_glasses() {
            this.setVisible(false);
        }
    ...
    class Camerawork
        ...
        public void cut0() {
            SCE01004.this.light.setColor(0, 0.25f, 0.25f, 0.25f);
            SCE01004.this.light.setColor(1, 0.8f, 0.8f, 0.8f);
            SCE01004.this.light.setDirection2(1, 0.494f, 0.249f, 0.833f);
            SCE01004.this.light.setColor(2, 0.5f, 0.5f, 0.5f);
            SCE01004.this.light.setDirection2(2, 0.676f, 0.707f, -0.207f);
            SCE01004.this.light.setColor(3, 0.5f, 0.5f, 0.5f);
            SCE01004.this.light.setDirection2(3, -0.544f, -0.369f, -0.753f);
            ...
            Runtime.setDefocus(15, 0, null);
            SCE01004.this.cam1.setTranslate(-9.0f, 4.0f, 12.0f);
            SCE01004.this.cam1.setRotate(0.0f, 90.0f, 0.0f);
            SCE01004.this.cam1.setFov(40.0f);
        }

        public void cut1() {
            SCE01004.this.Timechk_CutChange();
            SCE01004.this.light.setColor(0, 0.15f, 0.15f, 0.15f);
            SCE01004.this.light.setColor(1, 0.63f, 0.63f, 0.63f);
            SCE01004.this.light.setDirection2(1, -0.302f, 0.413f, 0.859f);
            SCE01004.this.light.setColor(2, 0.33f, 0.33f, 0.33f);
            SCE01004.this.light.setDirection2(2, -0.988f, 0.0f, -0.155f);
            SCE01004.this.light.setColor(3, 0.31f, 0.31f, 0.31f);
            SCE01004.this.light.setDirection2(3, -0.587f, -0.526f, 0.616f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 1, 76880, 1);
            Runtime.setDefocusQuick(1, 1, 68688, 1);
            Runtime.setDefocusQuick(2, 1, 60496, 1);
            Runtime.setDefocusQuick(3, 2, 126264, 2);
            Runtime.setDefocus(15, 0, null);
            SCE01004.this.cam1.setTranslate(3.36f, 1.14f, -2.74f);
            SCE01004.this.cam1.setRotate(2.08f, -56.36f, 0.0f);
            SCE01004.this.cam1.setFov(34.4f);
        }
        ...
        public void cut10() {
            ...
            SCE01004.this.light.setColor(0, 0.15f, 0.15f, 0.15f);
            SCE01004.this.light.setColor(1, 0.63f, 0.63f, 0.63f);
            SCE01004.this.light.setDirection2(1, 0.676f, 0.233f, -0.699f);
            SCE01004.this.light.setColor(2, 0.47f, 0.47f, 0.47f);
            SCE01004.this.light.setDirection2(2, 0.205f, 0.475f, 0.856f);
            SCE01004.this.light.setColor(3, 0.28f, 0.28f, 0.28f);
            SCE01004.this.light.setDirection2(3, 0.571f, -0.808f, 0.145f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 137880, 2);
            Runtime.setDefocusQuick(1, 0, 80000, 1);
            Runtime.setDefocusQuick(2, 0, 79000, 1);
            Runtime.setDefocusQuick(3, 0, 78000, 1);
            Runtime.setDefocus(15, 0, null);
            SCE01004.this.cam1.setRotate(0.42f, 114.5f, 0.0f);
            SCE01004.this.cam1.setFov(33.2f);
            float[] fArray = new float[]{1.0f, 2.7f, 1.3f, -1.0f, 195.0f, 2.5f, 1.3f, -0.95f, 210.0f, 2.5f, 1.3f, -0.95f};
            SCE01004.this.cam1.transSPL(fArray, 1, 1, 210);
        }
        ...
        public void cut10_2() {
            ...
            SCE01004.this.cam1.rotateSPL(fArray2, 1, 2, 300);
        }

        public void cut2() {
            SCE01004.this.Timechk_CutChange();
            SCE01004.this.light.setColor(0, 0.22f, 0.22f, 0.22f);
            SCE01004.this.light.setColor(1, 0.86f, 0.86f, 0.86f);
            SCE01004.this.light.setDirection2(1, 0.79f, 0.599f, 0.132f);
            SCE01004.this.light.setColor(2, 0.4f, 0.4f, 0.4f);
            SCE01004.this.light.setDirection2(2, -0.918f, 0.194f, -0.344f);
            SCE01004.this.light.setColor(3, 0.3f, 0.3f, 0.3f);
            SCE01004.this.light.setDirection2(3, 0.133f, -0.687f, -0.715f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 1, 0x100000, 1);
            Runtime.setDefocusQuick(1, 0, 80000, 1);
            Runtime.setDefocusQuick(2, 1, 103880, 2);
            Runtime.setDefocusQuick(3, 1, 95688, 2);
            SCE01004.this.cam1.setFov(34.0f);
            float[] fArray = new float[]{1.0f, -0.31f, 1.59f, 0.27f, 35.15f, -0.25f, 1.6f, -0.07f, 100.0f, -0.03f, 1.6f, -0.65f};
            ...
            SCE01004.this.cam1.transSPL(fArray, 1, 1, 150);
            SCE01004.this.cam1.rotateSPL(fArray3, 1, 1, 150);
        }

        public void cut3() {
            SCE01004.this.Timechk_CutChange();
            SCE01004.this.light.setColor(0, 0.18f, 0.18f, 0.18f);
            SCE01004.this.light.setColor(1, 0.62f, 0.62f, 0.62f);
            SCE01004.this.light.setDirection2(1, -0.982f, 0.143f, -0.123f);
            SCE01004.this.light.setColor(2, 0.3f, 0.3f, 0.3f);
            SCE01004.this.light.setDirection2(2, 0.162f, 0.0f, 0.987f);
            SCE01004.this.light.setColor(3, 0.21f, 0.21f, 0.21f);
            SCE01004.this.light.setDirection2(3, -0.803f, -0.522f, 0.289f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 1, 0x100000, 1);
            Runtime.setDefocusQuick(0, 1, 49880, 1);
            Runtime.setDefocusQuick(2, 2, 108264, 2);
            Runtime.setDefocusQuick(3, 0, 116456, 2);
            SCE01004.this.cam1.setTranslate(-0.73f, 0.92f, 0.39f);
            SCE01004.this.cam1.setRotate(8.17f, -57.75f, 0.0f);
            SCE01004.this.cam1.setFov(33.6f);
        }

        public void cut4() {
            SCE01004.this.Timechk_CutChange();
            SCE01004.this.light.setColor(0, 0.19f, 0.19f, 0.19f);
            SCE01004.this.light.setColor(1, 0.71f, 0.71f, 0.71f);
            SCE01004.this.light.setDirection2(1, 0.263f, 0.52f, -0.813f);
            SCE01004.this.light.setColor(2, 0.29f, 0.29f, 0.29f);
            SCE01004.this.light.setDirection2(2, 0.893f, 0.001f, 0.451f);
            SCE01004.this.light.setColor(3, 0.28f, 0.28f, 0.28f);
            SCE01004.this.light.setDirection2(3, 0.693f, -0.515f, 0.504f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 0, 137880, 2);
            Runtime.setDefocusQuick(1, 0, 80000, 1);
            Runtime.setDefocusQuick(2, 0, 79000, 1);
            Runtime.setDefocusQuick(3, 0, 78000, 1);
            Runtime.setDefocus(15, 0, null);
            SCE01004.this.cam1.setTranslate(2.49f, 1.55f, -0.47f);
            SCE01004.this.cam1.setRotate(-4.85f, 98.39f, 0.0f);
            SCE01004.this.cam1.setFov(32.0f);
            float[] fArray = new float[]{1.0f, 2.49f, 1.55f, -0.47f, 100.0f, 2.48f, 1.51f, -0.54f, 270.0f, 2.48f, 1.51f, -0.54f};
            float[] fArray2 = new float[12];
            fArray2[0] = 1.0f;
            fArray2[1] = -4.85f;
            fArray2[2] = 98.4f;
            ...
            fArray2[10] = 98.4f;
            float[] fArray3 = fArray2;
            SCE01004.this.cam1.transSPL(fArray, 1, 1, 270);
            SCE01004.this.cam1.rotateSPL(fArray3, 1, 1, 270);
        }

        public void cut5() {
            SCE01004.this.Timechk_CutChange();
            SCE01004.this.light.setColor(0, 0.24f, 0.24f, 0.24f);
            SCE01004.this.light.setColor(1, 0.56f, 0.56f, 0.56f);
            SCE01004.this.light.setDirection2(1, 0.797f, 0.334f, -0.504f);
            SCE01004.this.light.setColor(2, 0.31f, 0.31f, 0.31f);
            SCE01004.this.light.setDirection2(2, -0.112f, 0.0f, 0.994f);
            SCE01004.this.light.setColor(3, 0.23f, 0.23f, 0.23f);
            SCE01004.this.light.setDirection2(3, 0.711f, -0.699f, -0.076f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 1, 19072, 1);
            Runtime.setDefocusQuick(1, 1, 19072, 1);
            Runtime.setDefocusQuick(2, 0, 79000, 1);
            Runtime.setDefocusQuick(3, 0, 78000, 1);
            Runtime.setDefocus(15, 0, null);
            SCE01004.this.cam1.setTranslate(2.59f, 0.3f, -0.9f);
            SCE01004.this.cam1.setRotate(16.33f, 113.12f, 0.0f);
            SCE01004.this.cam1.setFov(37.0f);
        }

        public void cut6() {
            SCE01004.this.Timechk_CutChange();
            SCE01004.this.light.setColor(0, 0.08f, 0.08f, 0.08f);
            SCE01004.this.light.setColor(1, 0.65f, 0.65f, 0.65f);
            SCE01004.this.light.setDirection2(1, 0.72f, 0.333f, -0.609f);
            SCE01004.this.light.setColor(2, 0.36f, 0.36f, 0.36f);
            SCE01004.this.light.setDirection2(2, 0.263f, 0.0f, 0.965f);
            SCE01004.this.light.setColor(3, 0.33f, 0.33f, 0.33f);
            SCE01004.this.light.setDirection2(3, 0.583f, -0.763f, -0.279f);
            Stage.setColor(1.0f, 1.0f, 1.0f);
            Runtime.setDefocusQuick(0, 1, 0x100000, 1);
            Runtime.setDefocusQuick(1, 1, 15880, 2);
            Runtime.setDefocusQuick(2, 1, 7688, 2);
            Runtime.setDefocusQuick(3, 0, 78000, 1);
            Runtime.setDefocus(15, 0, null);
            SCE01004.this.cam1.setTranslate(1.94f, 0.82f, -0.82f);
            SCE01004.this.cam1.setRotate(14.9f, 121.8f, 0.0f);
            SCE01004.this.cam1.setFov(29.2f);
        }
        ...
        public void cut6_2() {
            ...
            fArray[10] = 120.66f;
            float[] fArray2 = fArray;
            SCE01004.this.cam1.rotateSPL(fArray2, 1, 1, 80);
        }
        ...
        public void cut7_1() {
            ...
            Runtime.setDefocusQuick(3, 0, 78000, 1);
            Runtime.setDefocus(15, 0, null);
            float[] fArray = new float[]{1.0f, 2.45f, 1.01f, 8.6f, 100.0f, 2.89f, 1.2f, 8.36f};
            ...
            fArray2[6] = 200.92f;
            float[] fArray3 = fArray2;
            SCE01004.this.cam1.transSPL(fArray, 1, 1, 180);
            SCE01004.this.cam1.rotateSPL(fArray3, 1, 1, 180);
            SCE01004.this.cam1.setFov(41.2f);
        }

        public void cut7_2() {
            SCE01004.this.Timechk_CutChange();
            SCE01004.this.cam1.setTranslate(4.4f, 3.0f, 10.3f);
            SCE01004.this.cam1.setRotate(-25.5f, 149.4f, 0.0f);
            SCE01004.this.cam1.setFov(32.0f);
        }

        public void cut7_3() {
            SCE01004.this.Timechk_CutChange();
            float[] fArray = new float[]{1.0f, 4.07f, 2.73f, 10.34f, 60.0f, 4.07f, 2.75f, 10.35f, 80.0f, 4.07f, 2.75f, 10.36f};
            float[] fArray2 = new float[12];
            fArray2[0] = 1.0f;
            fArray2[1] = -24.0f;
            fArray2[2] = 176.86f;
            ...
            fArray2[10] = 176.86f;
            float[] fArray3 = fArray2;
            SCE01004.this.cam1.transSPL(fArray, 1, 1, 120);
            SCE01004.this.cam1.rotateSPL(fArray3, 1, 1, 120);
            SCE01004.this.cam1.setFov(36.0f);
        }
        ...
        public void cut8() {
            ...
            Runtime.setDefocus(15, 0, null);
            SCE01004.this.cam1.setTranslate(1.94f, 0.82f, -0.82f);
            SCE01004.this.cam1.setRotate(17.78f, 120.66f, 0.0f);
            SCE01004.this.cam1.setFov(29.2f);
        }
    }
