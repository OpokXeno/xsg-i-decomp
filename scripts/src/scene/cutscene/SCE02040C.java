...
class SCE02040C
    ...
    void CameraThread() {
        ...
        this.cam1.change();
        this.cam1.setTranslate(-2.34f, 0.3f, 1.12f);
        this.cam1.setRotate(7.58f, 202.99f, 0.0f);
        this.cam1.setFov(40.6f);
        this.waitCameraPlay(2);
        this.cam1.change();
        this.cam1.setTranslate(-1.2f, 1.01f, 1.73f);
        this.cam1.setRotate(-3.34f, 92.51f, 0.0f);
        this.cam1.setFov(31.2f);
        this.waitCameraPlay(3);
        this.cam1.change();
        this.cam1.setTranslate(1.95f, 4.39f, 4.87f);
        this.cam1.setRotate(-21.92f, 33.24f, 0.0f);
    ...
    public void cleanup() {
        ...
        System.println("XEVEFLAG:EV02040C_F");
        Runtime.setFlags(158, 1, 1);
        System.println("XEVEJNAME:CFJ2_160 XEVEJPOINT:POINT2_160");
        Runtime.jumpCF(510, 3);
    }
    ...
    void play() {
        this.CameraTool();
        this.Timechk();
        Sound.streamPlay(1290037, 48000);
        this.CameraPlay = 1;
        Runtime.setDefocusQuick(0, 2, 112572, 2);
        this.light.setColor(0, 0.15f, 0.15f, 0.15f);
        this.light.setColor(1, 0.36f, 0.36f, 0.36f);
        this.light.setDirection2(1, 0.536f, 0.306f, -0.787f);
        this.light.setColor(2, 0.46f, 0.46f, 0.46f);
        this.light.setDirection2(2, -0.94f, 0.312f, -0.137f);
        this.light.setColor(3, 0.23f, 0.23f, 0.23f);
        this.light.setDirection2(3, -0.049f, -0.733f, -0.679f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.hammer.start(1, "hammer_act");
        this.chaos.start(1, "chaos_act");
        this.shion.start(1, "shion_act");
        this.shion.face.mtn(264, 8, 1.0f, false);
        this.shion.face.start(4, null);
        this.chaos.face.mtn(262, 8, 1.0f, false);
        this.chaos.face.start(4, null);
        this.hammer.face.mtn(270, 8, 1.0f, false);
        this.hammer.face.start(4, null);
        System.sleep(30);
        this.msg.print("Well, in that case, we'd better go\nfind him before anything happens.");
        this.chaos.face.mtn(261, 8, 1.0f, false);
        this.chaos.face.start(4, null);
        System.sleep(33);
        this.chaos.face.mtn(262, 8, 1.0f, false);
        this.chaos.face.start(4, null);
        ...
        this.chaos.face.start(4, null);
        this.waitclear(21);
        this.msg.print("Yeah, you're right.");
        this.shion.face.mtn(263, 8, 0.7f, false);
        this.shion.face.start(4, null);
        System.sleep(21);
        this.shion.face.mtn(264, 8, 1.0f, false);
        this.shion.face.start(4, null);
        this.waitclear(9);
        this.msg.print("I'll go get Ziggy. He'll probably\ncome in handy at a time like this.");
        this.shion.face.mtn(263, 8, 0.7f, false);
        this.shion.face.start(4, null);
        System.sleep(15);
        this.shion.face.mtn(264, 8, 1.0f, false);
        ...
        this.shion.face.start(4, null);
        System.sleep(15);
        this.shion.face.mtn(264, 8, 0.7f, false);
        this.shion.face.start(4, null);
        System.sleep(12);
        this.shion.face.mtn(263, 8, 0.7f, false);
        this.shion.face.start(4, null);
        ...
        this.waitclear(12);
        System.sleep(15);
        this.msg.print("All right, I'll go with Allen, then.");
        this.hammer.face.mtn(269, 8, 1.0f, false);
        this.hammer.face.start(4, null);
        this.waitclear(66);
        this.hammer.face.mtn(270, 8, 1.0f, false);
        this.hammer.face.start(4, null);
        ...
        Stage.setColor(1.0f, 1.0f, 1.0f);
        System.sleep(15);
        this.msg.print("He doesn't look very useful, though...");
        this.hammer.face.mtn(271, 9, 1.0f, false);
        this.hammer.face.start(4, null);
        System.sleep(63);
        this.hammer.face.mtn(272, 8, 1.0f, false);
        this.hammer.face.start(4, null);
        this.waitclear(6);
        System.sleep(21);
        Runtime.setLocation(102);
    ...
    class Human
        ...
        void shion_act() {
            this.setTranslate(-1.45f, -0.49f, 3.3f);
            this.setRotate(0.0f, -168.0f, 0.0f);
