...
class SCE02013A
    ...
    public void cleanup() {
        ...
        System.println("XEVEFLAG:EV02013_F");
        Runtime.setFlags(122, 1, 1);
        System.println("XEVEJNAME:CFJ2_90 XEVEJPOINT:POINT2_90");
    ...
    void init() {
        ...
        this.Fandrew2 = new allFACE();
        this.Fandrew3 = new allFACE();
    ...
    void play() {
        ...
        this.loadarc(this.kosmos.getChild(0x1000000), "FLSkosmos_h.fpk");
        this.loadarc(this.andrew.getChild(0x1000000), "FLSandrew_h.fpk");
        Sound.streamPlay(1290074, 48000);
        this.playSCENE();
        this.playSCENE1();
        this.playSCENE2();
    ...
    void playSCENE() {
        ...
        this.Fandrew.start(1, "face1_andrew");
        this.camerawork.cut1();
        System.sleep(45);
        this.msg_print("【アンドリュー】", "Is this...");
        this.waitclear(40);
        System.sleep(30);
        this.kosmos.renderCommand(21);
        this.andrew.renderCommand(22);
        this.kosmos_tub.renderCommand(22);
        this.andrew.start(1, "act2_andrew");
        this.kosmos.start(1, "act2_kosmos");
        this.kosmos_tub.start(1, "act2_kosmos_tub");
        this.camerawork.cut2();
        System.sleep(15);
        this.msg_print("【アンドリュー】", "Is this the same archetype\nfrom before?");
        this.waitclear(70);
        System.sleep(135);
    }
    ...
    void playSCENE1() {
        ...
        this.andrew.start(1, "act3_andrew");
        this.kosmos.start(1, "act3_kosmos");
        this.handgun.start(1, "act3_handgun");
        this.Fandrew.start(1, "face3_andrew");
        this.Fandrew2.start(1, "eyes3_andrew");
        ...
        this.kosmos.start(1, "act4_kosmos");
        this.kosmos.setVisible(true);
        this.Fandrew2.start(1, "eyes4_andrew");
        this.camerawork.cut4();
        System.sleep(65);
    }

    void playSCENE2() {
        this.andrew.renderCommand(21);
        this.kosmos.renderCommand(21);
        this.andrew.start(1, "act5_andrew");
        this.kosmos.start(1, "act5_kosmos");
        this.handgun.start(1, "act5_handgun");
        this.kosmos_tub.setVisible(false);
        this.Fandrew.start(1, "face5_andrew");
        this.Fandrew2.start(1, "eyes5_andrew");
        this.camerawork.cut5();
        System.sleep(85);
        System.sleep(220);
        this.andrew.look_default();
        System.sleep(60);
        this.andrew.renderCommand(21);
        this.kosmos.renderCommand(21);
        this.andrew.start(1, "act6_andrew");
        this.kosmos.start(1, "act6_kosmos");
        this.kosmos.setVisible(23, false);
        this.kosmos_tub.start(1, "act6_kosmos_tub");
        this.kosmos_tub.setVisible(true);
        this.handgun.start(1, "act6_handgun");
        this.Fandrew.start(1, "face6_andrew");
        this.Fandrew2.start(1, "face6_andrew2");
        this.Fandrew3.start(1, "eyes6_andrew");
    ...
    class allCHARA
        ...
        public void act1_andrew() {
            ...
            this.mtn(257, 330, 450, 8, 0, 1.0f, true);
        }
        ...
        public void act2_andrew() {
            this.setTranslate(-0.01f, 0.0f, -0.06f);
            this.setRotate(0.0f, 355.0f, 0.0f);
            this.mtn(259, 0, 240, 8, 8, 1.0f, true);
        }

        public void act2_kosmos() {
            this.setVisible(true);
            this.setVisible(12, false);
            this.setVisible(15, false);
            this.setVisible(22, false);
            this.setVisible(25, false);
        }

        public void act3_andrew() {
            this.setTranslate(0.43f, 0.0f, 0.64f);
            this.setRotate(0.0f, 272.0f, 0.0f);
            this.mtn(260, 0, 395, 8, 0, 1.0f, true);
        }

        public void act3_kosmos() {
            SCE02013A.this.kosmos.setVisible(false);
            this.setVisible(12, true);
            this.setVisible(15, true);
            this.setVisible(22, true);
            this.setVisible(25, true);
        }

        public void act4_andrew() {
            this.setTranslate(0.17f, 0.02f, 0.78f);
            this.setRotate(-8.0f, 260.0f, 0.0f);
            this.setVisible(true);
            SCE02013A.this.andrew.face.setVisible(false);
            this.mtn(261, 0, 125, 8, 8, 1.0f, true);
        }

        public void act4_kosmos() {
            int n = 0;
            while (n < 26) {
                SCE02013A.this.kosmos.setVisible(n, true);
                ++n;
            }
        }

        public void act5_andrew() {
            this.setTranslate(0.16f, 0.03f, 0.57f);
            this.setRotate(-11.0f, 277.0f, -3.0f);
            SCE02013A.this.andrew.face.setVisible(true);
            this.mtn(264, 125, 255, 8, 0, 1.0f, true);
            this.mtn(264, 256, 270, 8, 0, 1.2f, true);
            this.mtn(264, 255, 269, 8, 0, -1.0f, true);
            this.mtn(264, 256, 305, 8, 0, 1.15f, true);
            this.mtn(264, 289, 304, 8, 0, -1.0f, true);
            this.mtn(264, 290, 410, 8, 0, 1.0f, true);
            this.mtn(264, 290, 409, 8, 0, -0.9f, true);
        }
        ...
        public void act5_kosmos() {
            ...
            this.setVisible(22, false);
            this.setVisible(23, false);
            this.setVisible(24, false);
            this.setVisible(25, false);
        }

        public void act6_andrew() {
            this.setTranslate(0.25f, 0.0f, 0.65f);
            this.setRotate(0.0f, 276.0f, 0.0f);
            this.mtn(262, 0, 315, 8, 0, 1.0f, true);
        }
    ...
    class allMECHA
        ...
        public void act1_kosmos_tub() {
            this.mtn(263, 171, 171, 8, 0, 1.0f, true);
        }

        public void act2_kosmos_tub() {
            int n = 2;
            while (n < 18) {
                SCE02013A.this.kosmos_tub.setVisible(n, false);
                ++n;
            }
            this.setVisible(19, false);
        }

        public void act6_kosmos_tub() {
            this.setVisible(18, false);
            this.setVisible(20, false);
        }
    }
    ...
    class allFACE
        ...
        public void eyes3_andrew() {
            SCE02013A.this.andrew.look_default();
            System.sleep(260);
            SCE02013A.this.target.setTranslate(-0.5f, 0.9f, 1.17f);
            SCE02013A.this.target.setRotate(0.0f, 0.0f, 0.0f);
            SCE02013A.this.andrew.look_speed(0.15f);
            SCE02013A.this.andrew.look_point(SCE02013A.this.target.px, SCE02013A.this.target.py, SCE02013A.this.target.pz);
            while (true) {
                SCE02013A.this.andrew.look_point(SCE02013A.this.target.px, SCE02013A.this.target.py, SCE02013A.this.target.pz);
                System.sleep(1);
            }
        ...
        public void eyes4_andrew() {
            SCE02013A.this.andrew.look_default();
        }

        public void eyes5_andrew() {
            SCE02013A.this.andrew.look_default();
        }

        public void eyes6_andrew() {
            SCE02013A.this.andrew.look_default();
            SCE02013A.this.target.setVisible(false);
            System.sleep(238);
            SCE02013A.this.target.setTranslate(-0.04f, 1.05f, 0.98f);
            SCE02013A.this.target.setRotate(0.0f, 0.0f, 0.0f);
            SCE02013A.this.andrew.look_speed(0.15f);
            SCE02013A.this.andrew.look_point(SCE02013A.this.target.px, SCE02013A.this.target.py, SCE02013A.this.target.pz);
            while (true) {
        ...
        public void face1_andrew() {
            SCE02013A.this.andrew.face.mtn(2, 50, 120, 8, 8, 0.6f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(20);
            SCE02013A.this.andrew.face.mtn(4, 0, 120, 10, 9, 1.0f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(40);
            SCE02013A.this.andrew.face.mtn(2, 0, 120, 20, 9, 1.0f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(25);
            SCE02013A.this.andrew.face.mtn(4, 0, 120, 16, 9, 1.0f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
        }

        public void face1_kosmos() {
            SCE02013A.this.kosmos.face.mtn(2, 46, 46, 0, 8, 1.0f, false);
            SCE02013A.this.kosmos.face.start(4, null);
        }

        public void face3_andrew() {
            System.sleep(135);
            SCE02013A.this.andrew.face.mtn(3, 0, 4, 5, 0, 0.4f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(3, 0, 4, 5, 0, -0.4f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(4, 50, 60, 5, 0, 0.4f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(4, 0, 120, 5, 8, 1.0f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(40);
            SCE02013A.this.andrew.face.mtn(11, 0, 4, 5, 1, 0.1f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(40);
            SCE02013A.this.andrew.face.mtn(11, 0, 4, 5, 0, -0.1f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(45);
        }

        public void face5_andrew() {
            SCE02013A.this.andrew.face.mtn(3, 40, 48, 5, 0, 0.2f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(20);
            SCE02013A.this.andrew.face.mtn(3, 48, 54, 5, 0, 0.15f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(3, 110, 112, 5, 0, 0.15f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(3, 112, 110, 5, 0, -0.04f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(60);
            SCE02013A.this.andrew.face.mtn(3, 110, 112, 5, 0, 0.04f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(3, 112, 114, 5, 0, 0.04f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(60);
            SCE02013A.this.andrew.face.mtn(11, 0, 120, 4, 9, 0.4f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(75);
            SCE02013A.this.andrew.face.mtn(3, 0, 120, 4, 9, 0.2f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(60);
            SCE02013A.this.andrew.face.mtn(15, 0, 120, 5, 9, 0.2f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(75);
        }

        public void face6_andrew() {
            SCE02013A.this.andrew.face.mtn(3, 55, 56, 5, 0, 0.1f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(3, 55, 56, 5, 0, -0.1f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(50);
            SCE02013A.this.andrew.face.mtn(3, 55, 56, 5, 0, 0.06f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(3, 111, 112, 5, 0, 0.04f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(3, 113, 114, 5, 0, 0.04f, false);
            SCE02013A.this.andrew.face.start(4, null);
            System.sleep(30);
            SCE02013A.this.andrew.face.mtn(3, 112, 114, 5, 0, -0.04f, false);
            SCE02013A.this.andrew.face.start(4, null);
    ...
    class allUNIT
        ...
        public void act3_handgun() {
            this.setParent(SCE02013A.this.andrew, 72);
            this.setTranslate(0.07f, -0.02f, 0.02f);
            this.setRotate(-10.0f, -5.0f, 7.0f);
            System.sleep(60);
            this.setVisible(true);
            SCE02013A.this.andrew.setVisible(12, false);
            SCE02013A.this.andrew.setVisible(15, true);
        }

        public void act5_handgun() {
            this.setParent(SCE02013A.this.andrew, 72);
        ...
        public void act6_handgun() {
            this.setTranslate(0.06f, -0.02f, 0.02f);
            this.setRotate(7.0f, -34.0f, 0.0f);
        }

        public void fog_check() {
            SCE02013A.this.fog.setTranslate(0.0f, 0.0f, 0.0f);
            SCE02013A.this.fog.setRotate(0.0f, 0.0f, 0.0f);
            while (true) {
                SCE02013A.this.cam1.setFog(1, SCE02013A.this.fog.px, SCE02013A.this.fog.pz, SCE02013A.this.fog.py, SCE02013A.this.fog.ry / 1000.0f, 128, 128, 128, 0);
                System.sleep(1);
            }
        }
        ...
        public void point_check1() {
            while (true) {
                SCE02013A.this.light1.setGlobalPointLightCol(0, SCE02013A.this.point.rx / 100.0f, SCE02013A.this.point.ry / 100.0f, SCE02013A.this.point.rz / 100.0f);
                SCE02013A.this.light1.setGlobalPointLightPos(0, SCE02013A.this.point.px, SCE02013A.this.point.py, SCE02013A.this.point.pz);
                System.sleep(1);
            }
        }

        public void point_check2() {
            SCE02013A.this.point.getTranslate();
            SCE02013A.this.light1.setGlobalPointLightPos(0, SCE02013A.this.point.px, SCE02013A.this.point.py, SCE02013A.this.point.pz);
            SCE02013A.this.light1.setGlobalPointLightCol(0, 0.0f, 0.0f, 0.0f);
            while (true) {
                SCE02013A.this.light1.setGlobalPointLightCol(0, SCE02013A.this.point.px, SCE02013A.this.point.ry / 100.0f, SCE02013A.this.point.pz);
                System.sleep(1);
            }
        }
    ...
    class Camerawork
        ...
        public void cut0() {
            ...
            SCE02013A.this.cam1.setTranslate(0.0f, -1.5f, 0.0f);
            SCE02013A.this.cam1.setRotate(-90.0f, 0.0f, 0.0f);
            SCE02013A.this.cam1.setFov(40.0f);
        }

        public void cut1() {
            SCE02013A.this.Timechk_CutChange();
            SCE02013A.this.light.setColor(0, 0.05f, 0.05f, 0.05f);
            SCE02013A.this.light.setColor(1, 0.17f, 0.26f, 0.29f);
            SCE02013A.this.light.setDirection2(1, -0.58f, -0.467f, 0.667f);
            SCE02013A.this.light.setColor(2, 0.1f, 0.13f, 0.17f);
            SCE02013A.this.light.setDirection2(2, 0.7f, 0.709f, 0.091f);
            SCE02013A.this.light.setColor(3, 0.09f, 0.16f, 0.22f);
            SCE02013A.this.light.setDirection2(3, -0.367f, 0.928f, 0.066f);
            Stage.setColor(0.16f, 0.23f, 0.34f);
            SCE02013A.this.cam1.setTranslate(-0.74f, 1.14f, 1.49f);
            SCE02013A.this.cam1.setRotate(15.27f, 681.33f, 0.0f);
            SCE02013A.this.cam1.setFov(32.4f);
        }
        ...
        public void cut2() {
            ...
            SCE02013A.this.light.setColor(0, 0.05f, 0.05f, 0.05f);
            SCE02013A.this.light.setColor(1, 0.17f, 0.26f, 0.29f);
            SCE02013A.this.light.setDirection2(1, 0.606f, 0.651f, -0.458f);
            SCE02013A.this.light.setColor(2, 0.17f, 0.18f, 0.22f);
            SCE02013A.this.light.setDirection2(2, -0.609f, 0.781f, -0.138f);
            SCE02013A.this.light.setColor(3, 0.14f, 0.21f, 0.27f);
            SCE02013A.this.light.setDirection2(3, -0.877f, -0.475f, -0.069f);
            Stage.setColor(0.16f, 0.23f, 0.34f);
            SCE02013A.this.cam1.setFov(31.6f);
            float[] fArray = new float[]{1.0f, -0.81f, 1.67f, 0.38f, 83.2f, -0.96f, 1.67f, 0.34f, 180.0f, -1.23f, 1.67f, 0.34f, 210.0f, -1.24f, 1.67f, 0.34f, 240.0f, -1.24f, 1.67f, 0.34f};
            ...
            SCE02013A.this.cam1.transSPL(fArray, 1);
            SCE02013A.this.cam1.rotateSPL(fArray3, 1);
        }
        ...
        public void cut3() {
            ...
            SCE02013A.this.light.setColor(0, 0.05f, 0.05f, 0.05f);
            SCE02013A.this.light.setColor(1, 0.17f, 0.26f, 0.29f);
            SCE02013A.this.light.setDirection2(1, -0.58f, -0.468f, 0.667f);
            SCE02013A.this.light.setColor(2, 0.1f, 0.13f, 0.17f);
            SCE02013A.this.light.setDirection2(2, 0.373f, 0.685f, -0.626f);
            SCE02013A.this.light.setColor(3, 0.09f, 0.16f, 0.22f);
            SCE02013A.this.light.setDirection2(3, -0.869f, 0.403f, -0.286f);
            Stage.setColor(0.16f, 0.23f, 0.34f);
            SCE02013A.this.cam1.setTranslate(-1.55f, 0.85f, 1.05f);
            SCE02013A.this.cam1.setRotate(11.31f, 649.77f, 0.0f);
            SCE02013A.this.cam1.setFov(40.0f);
        }
        ...
        public void cut4() {
            SCE02013A.this.Timechk_CutChange();
            SCE02013A.this.light.setColor(0, 0.05f, 0.05f, 0.05f);
            SCE02013A.this.light.setColor(1, 0.16f, 0.25f, 0.28f);
            SCE02013A.this.light.setDirection2(1, 0.941f, 0.24f, -0.238f);
            SCE02013A.this.light.setColor(2, 0.12f, 0.16f, 0.23f);
            SCE02013A.this.light.setDirection2(2, -0.779f, 0.419f, -0.466f);
            SCE02013A.this.light.setColor(3, 0.1f, 0.17f, 0.23f);
            SCE02013A.this.light.setDirection2(3, -0.307f, 0.873f, -0.379f);
            Stage.setColor(0.16f, 0.23f, 0.34f);
            Runtime.setDefocusQuick(0, 0, 116880, 1);
            Runtime.setDefocusQuick(1, 0, 80000, 1);
            Runtime.setDefocusQuick(2, 0, 79000, 1);
            Runtime.setDefocusQuick(3, 0, 78000, 1);
            Runtime.setDefocus(15, 0, null);
            SCE02013A.this.cam1.setTranslate(-1.13f, 1.12f, 0.53f);
            SCE02013A.this.cam1.setRotate(-10.28f, 593.84f, 0.0f);
            SCE02013A.this.cam1.setFov(25.33f);
        }
        ...
        public void cut5() {
            ...
            SCE02013A.this.light.setColor(0, 0.05f, 0.05f, 0.05f);
            SCE02013A.this.light.setColor(1, 0.16f, 0.25f, 0.28f);
            SCE02013A.this.light.setDirection2(1, -0.631f, -0.708f, 0.316f);
            SCE02013A.this.light.setColor(2, 0.12f, 0.16f, 0.23f);
            SCE02013A.this.light.setDirection2(2, 0.644f, 0.546f, 0.536f);
            SCE02013A.this.light.setColor(3, 0.11f, 0.18f, 0.24f);
            SCE02013A.this.light.setDirection2(3, -0.725f, 0.6f, -0.339f);
            Stage.setColor(0.16f, 0.23f, 0.34f);
            Runtime.setDefocusQuick(0, 2, 485264, 1);
            Runtime.setDefocusQuick(1, 2, 493456, 1);
            Runtime.setDefocusQuick(2, 2, 501648, 1);
            Runtime.setDefocusQuick(3, 2, 509840, 1);
            SCE02013A.this.cam1.setTranslate(-0.75f, 0.86f, 1.16f);
            SCE02013A.this.cam1.setRotate(34.3f, 647.59f, 0.0f);
            SCE02013A.this.cam1.setFov(45.7f);
        }
        ...
        public void cut6() {
            ...
            SCE02013A.this.light.setColor(0, 0.05f, 0.05f, 0.05f);
            SCE02013A.this.light.setColor(1, 0.17f, 0.26f, 0.29f);
            SCE02013A.this.light.setDirection2(1, 0.3f, -0.597f, 0.744f);
            SCE02013A.this.light.setColor(2, 0.1f, 0.13f, 0.17f);
            SCE02013A.this.light.setDirection2(2, 0.598f, 0.54f, -0.592f);
            SCE02013A.this.light.setColor(3, 0.09f, 0.16f, 0.22f);
            SCE02013A.this.light.setDirection2(3, 0.272f, 0.93f, 0.247f);
            Stage.setColor(0.16f, 0.23f, 0.34f);
            Runtime.setDefocusQuick(0, 0, 116880, 1);
            Runtime.setDefocusQuick(1, 0, 80000, 1);
            Runtime.setDefocusQuick(2, 0, 79000, 1);
            Runtime.setDefocusQuick(3, 0, 78000, 1);
            Runtime.setDefocus(15, 0, null);
            SCE02013A.this.cam1.setFov(35.19f);
            float[] fArray = new float[]{1.0f, 0.95f, 1.56f, 1.47f, 15.0f, 0.95f, 1.56f, 1.47f, 145.4f, 0.92f, 1.46f, 1.52f, 310.0f, 0.85f, 1.36f, 1.61f, 315.0f, 0.85f, 1.36f, 1.61f};
            float[] fArray2 = new float[20];
            fArray2[0] = 1.0f;
            fArray2[1] = -9.54f;
            fArray2[2] = 420.95f;
