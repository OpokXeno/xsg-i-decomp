...
class SCE03013
    ...
    void CameraThread() {
        ...
        this.cam1.change();
        this.cam1.setTranslate(0.55f, 1.27f, -0.18f);
        this.cam1.setRotate(17.83f, 50.41f, 0.0f);
        this.cam1.setFov(27.2f);
        this.waitCameraPlay(2);
        this.cam1.change();
        float[] fArray = new float[]{1.0f, 9.4f, 1.22f, 2.83f, 100.0f, 9.4f, 1.22f, 2.83f};
        ...
        this.cam1.setFov(34.87f);
        this.waitCameraPlay(3);
        this.cam1.change();
        this.cam1.setTranslate(4.16f, 0.78f, 1.96f);
        this.cam1.setRotate(1.59f, -39.2f, 0.0f);
        this.cam1.setFov(24.67f);
        this.waitCameraPlay(103);
        float[] fArray4 = new float[]{1.0f, 4.16f, 0.78f, 1.96f, 100.0f, 4.16f, 0.78f, 1.96f};
        ...
        this.cam1.transSPL(fArray4, 0, 3, 300);
        this.cam1.rotateSPL(fArray6, 0, 3, 300);
        this.cam1.setFov(24.67f);
        this.waitCameraPlay(4);
        this.cam1.change();
        this.cam1.setTranslate(0.02f, 1.17f, 1.62f);
        this.cam1.setRotate(8.59f, 21.43f, 0.0f);
        this.cam1.setFov(25.84f);
        this.waitCameraPlay(5);
        this.cam1.change();
        float[] fArray7 = new float[]{1.0f, 2.24f, 2.07f, 2.45f, 100.0f, 2.52f, 2.03f, 2.07f};
        ...
        this.cam1.transSPL(fArray7, 0, 2, 300);
        this.cam1.rotateSPL(fArray9, 0, 2, 300);
        this.cam1.setFov(28.83f);
        this.waitCameraPlay(6);
        this.cam1.change();
        this.cam1.setTranslate(4.53f, 1.08f, -1.14f);
        this.cam1.setRotate(5.98f, -60.74f, 0.0f);
        this.cam1.setFov(27.52f);
        this.waitCameraPlay(7);
        this.cam1.change();
        this.cam1.setTranslate(4.14f, 0.97f, 1.81f);
        this.cam1.setRotate(0.15f, 174.19f, 0.0f);
    ...
    public void cleanup() {
        ...
        System.println("XEVEFLAG:EV03013_F");
        Runtime.setFlags(324, 1, 1);
        System.println("XEVEJNAME:SCE03014");
        Runtime.jumpEvent(3140);
    }
    ...
    void init() {
        ...
        this.allen.init(0x1000107, 3.96f, -0.0f, 3.78f, -184.0f);
    ...
    void play() {
        this.CameraTool();
        this.Timechk();
        Sound.streamPlay(1390015, 48000);
        this.CameraPlay = 1;
        this.light.setColor(0, 0.2f, 0.2f, 0.2f);
        this.light.setColor(1, 0.4f, 0.4f, 0.4f);
        this.light.setDirection2(1, 0.989f, 0.0f, -0.145f);
        this.light.setColor(2, 0.2f, 0.2f, 0.2f);
        this.light.setDirection2(2, 0.634f, -0.649f, 0.42f);
        this.light.setColor(3, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(3, 0.259f, 0.243f, 0.935f);
        ...
        this.jr.start(1, "jr_act1");
        this.ziggy.face.mtn(295, 8, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(30);
        this.msg.print("It's all orchestrated too well...");
        this.ziggy.face.mtn(294, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(45);
        this.ziggy.face.mtn(295, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        ...
        this.light.setDirection2(1, 0.255f, 0.235f, 0.938f);
        this.light.setColor(2, 0.26f, 0.26f, 0.26f);
        this.light.setDirection2(2, 0.672f, 0.571f, -0.472f);
        this.light.setColor(3, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(3, 0.585f, -0.343f, -0.735f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        Runtime.setDefocusQuick(0, 0, 44880, 1);
        Runtime.setDefocusQuick(1, 0, 36688, 2);
        this.chaos.start(1, "chaos_act2");
        this.momo.start(1, "momo_act2");
        this.jr.start(1, "jr_act2");
        this.shion.start(1, "shion_act2");
        this.chaos.face.mtn(277, 9, 1.0f, false);
        this.chaos.face.start(4, null);
        this.shion.face.mtn(291, 9, 1.0f, false);
        ...
        this.msg.print("Huh?");
        this.waitclear(45);
        this.msg.print("The fleet deployment\ncame too quickly.");
        this.ziggy.face.mtn(294, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        this.waitclear(60);
        this.ziggy.face.mtn(295, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(15);
        this.msg.print("They must have been prepared");
        this.ziggy.face.mtn(294, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        this.waitclear(60);
        this.ziggy.face.mtn(295, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(15);
        this.msg.print("to ensure that\nMOMO would return to them\nregardless of what happened...");
        this.ziggy.face.mtn(294, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        this.waitclear(120);
        this.ziggy.face.mtn(295, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(15);
        this.msg.print("Or perhaps ensnaring Second Miltia\nwas part of their plan from the\nvery beginning.");
        this.ziggy.face.mtn(294, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        this.waitclear(195);
        this.ziggy.face.mtn(295, 9, 1.0f, false);
        ...
        Runtime.setDefocusQuick(1, 0, 46880, 1);
        this.light.setColor(0, 0.2f, 0.2f, 0.2f);
        this.light.setColor(1, 0.4f, 0.4f, 0.4f);
        this.light.setDirection2(1, 0.284f, 0.278f, 0.917f);
        this.light.setColor(2, 0.2f, 0.2f, 0.2f);
        this.light.setDirection2(2, -0.217f, 0.92f, -0.326f);
        this.light.setColor(3, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(3, -0.844f, -0.199f, 0.498f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.chaos.setVisible(false);
        this.jr.start(1, "jr_act3");
        this.momo.start(1, "momo_act3");
        this.msg.print("As a neutral territory,\nSecond Miltia was invested\nwith a whole bunch of rights");
        ...
        this.jr.face.start(4, null);
        this.waitclear(9);
        this.msg.print("and legal privileges after the\nMiltian Conflict. There are\na whole lot of folks who");
        this.jr.face.mtn(280, 9, 1.0f, false);
        this.jr.face.start(4, null);
        System.sleep(39);
        this.jr.face.mtn(281, 9, 1.0f, false);
        ...
        this.waitclear(9);
        System.sleep(21);
        this.msg.print("still have problems with that,\neven outside of the\nU-TIC Organization.");
        this.jr.face.mtn(280, 9, 1.0f, false);
        this.jr.face.start(4, null);
        System.sleep(51);
        this.jr.face.mtn(281, 9, 1.0f, false);
        ...
        this.CameraPlay = 103;
        System.sleep(10);
        this.msg.print("The asteroid where\nMOMO was imprisoned...");
        this.waitclear(75);
        System.sleep(12);
        this.msg.print("I wondered where the information\nabout that place came from...");
        this.waitclear(135);
        this.momo.look_char(this.ziggy);
        this.momo.look_speed(0.03f);
        this.msg.print("Now it seems like it was all\npart of the plan");
        this.waitclear(81);
        System.sleep(15);
        this.msg.print("from the very beginning.");
        this.waitclear(60);
        this.msg.print("Do you mean...");
        ...
        this.momo.face.start(4, null);
        this.waitclear(9);
        this.msg.print("from when Mommy sent you\nto rescue me?");
        this.momo.face.mtn(284, 9, 1.0f, false);
        this.momo.face.start(4, null);
        System.sleep(30);
        this.waitclear(66);
        ...
        this.light.setDirection2(1, 0.943f, 0.332f, -0.021f);
        this.light.setColor(2, 0.2f, 0.2f, 0.2f);
        this.light.setDirection2(2, 0.298f, -0.607f, 0.737f);
        this.light.setColor(3, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(3, -0.294f, 0.019f, 0.956f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        ...
        this.chaos.start(1, "chaos_act4");
        this.ziggy.face.mtn(295, 9, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(9);
        this.msg.print("You don't think there are\nU-TIC members within\nthe Subcommittee itself...?");
        this.chaos.face.mtn(276, 9, 1.0f, false);
        this.chaos.face.start(4, null);
        System.sleep(21);
        this.chaos.face.mtn(277, 9, 1.0f, false);
        this.chaos.face.start(4, null);
        System.sleep(18);
        this.chaos.face.mtn(276, 9, 1.2f, false);
        this.chaos.face.start(4, null);
        System.sleep(39);
        this.chaos.face.mtn(277, 9, 1.0f, false);
        this.chaos.face.start(4, null);
        ...
        this.light.setColor(0, 0.2f, 0.2f, 0.2f);
        this.light.setColor(1, 0.45f, 0.45f, 0.45f);
        this.light.setDirection2(1, -0.727f, 0.681f, -0.091f);
        this.light.setColor(2, 0.23f, 0.23f, 0.23f);
        this.light.setDirection2(2, 0.315f, 0.001f, -0.949f);
        this.light.setColor(3, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(3, -0.356f, -0.786f, -0.506f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.chaos.setVisible(false);
        this.ziggy.setVisible(false);
        this.jr.setVisible(false);
        this.allen.start(1, "allen_act5");
        this.allen.face.mtn(271, 9, 1.0f, false);
        this.allen.face.start(4, null);
        System.sleep(30);
        this.msg.print("It's not inconceivable.");
        this.allen.face.mtn(270, 9, 1.0f, false);
        this.allen.face.start(4, null);
        System.sleep(60);
        this.allen.face.mtn(271, 9, 1.0f, false);
        this.allen.face.start(4, null);
        this.waitclear(15);
        System.sleep(15);
        this.msg.print("Perhaps it was the very person\nwho arranged for MOMO's\nrescue, Dr. Juli Mizrahi herself...");
        this.allen.face.mtn(270, 9, 1.0f, false);
        this.allen.face.start(4, null);
        System.sleep(60);
        this.allen.face.mtn(271, 9, 1.0f, false);
        ...
        this.allen.face.start(4, null);
        this.shion.start(1, "shion_act6_1");
        this.waitclear(15);
        this.CameraPlay = 6;
        this.light.setColor(0, 0.2f, 0.2f, 0.2f);
        this.light.setColor(1, 0.4f, 0.4f, 0.4f);
        this.light.setDirection2(1, 0.216f, 0.0f, 0.976f);
        this.light.setColor(2, 0.2f, 0.2f, 0.2f);
        this.light.setDirection2(2, -0.311f, 0.824f, 0.473f);
        this.light.setColor(3, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(3, -0.892f, -0.331f, 0.309f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        Runtime.setDefocusQuick(0, 1, 42880, 1);
        this.momo.start(1, "momo_act6");
        this.shion.start(1, "shion_act6");
        this.msg.print("No! Mommy would never\ndo something like that!");
        this.momo.face.mtn(288, 8, 1.0f, false);
        this.momo.face.start(4, null);
        System.sleep(18);
        this.momo.face.mtn(289, 8, 1.0f, false);
        this.momo.face.start(4, null);
        System.sleep(18);
        this.momo.face.mtn(288, 8, 1.2f, false);
        this.momo.face.start(4, null);
        System.sleep(60);
        this.momo.face.mtn(289, 8, 1.0f, false);
        this.momo.face.start(4, null);
        this.waitclear(3);
        this.shion.face.mtn(291, 8, 1.0f, false);
        this.shion.face.start(4, null);
        System.sleep(15);
        this.msg.print("Allen!");
        this.shion.face.mtn(290, 8, 1.0f, false);
        this.shion.face.start(4, null);
        System.sleep(21);
        this.shion.face.mtn(291, 8, 1.0f, false);
        this.shion.face.start(4, null);
        ...
        this.light.setDirection2(1, -0.235f, 0.124f, -0.964f);
        this.light.setColor(2, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(2, -0.686f, 0.679f, -0.261f);
        this.light.setColor(3, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(3, 0.312f, -0.7f, -0.642f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.allen.start(1, "allen_act7");
        System.sleep(39);
        this.msg.print("I...uh...sorry...");
        this.allen.face.mtn(270, 8, 1.0f, false);
        this.allen.face.start(4, null);
        System.sleep(18);
        this.allen.face.mtn(271, 8, 1.0f, false);
        this.allen.face.start(4, null);
    ...
    class Human
        ...
        void jr_act1() {
            this.mtn(259, 0, 1, 0, 0, 0.9f, true);
        }

        void jr_act2() {
            this.mtn(259, 0, 0.9f, true);
        }

        void jr_act3() {
            this.mtn(262, 15, 959, 1, 0, 1.0f, true);
        }
        ...
        void shion_act2() {
            ...
            this.mtn(261, 0, -0.8f, true);
            this.mtn(261, 0, 0.7f, true);
        }

        void shion_act6() {
            this.mtn(267, 0, 1.1f, true);
        }

        void shion_act6_1() {
            this.mtn(267, 0, 1, 0, 0, 1.1f, true);
        }

        void ziggy_act1() {
            this.look_char(SCE03013.this.momo);
