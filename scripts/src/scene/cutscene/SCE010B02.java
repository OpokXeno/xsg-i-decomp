...
class SCE010B02
    ...
    void CameraThread() {
        ...
        this.cam1.change();
        float[] fArray = new float[]{1.0f, 12.73f, 1.66f, -20.98f, 100.0f, 12.73f, 1.66f, -20.98f};
        ...
        this.cam1.setFov(48.28f);
        this.waitCameraPlay(101);
        this.cam1.change();
        this.cam1.setTranslate(10.12f, 1.14f, -21.68f);
        this.cam1.setRotate(10.63f, 142.83f, 0.0f);
        this.cam1.setFov(24.12f);
        this.waitCameraPlay(102);
        this.cam1.change();
        float[] fArray4 = new float[]{1.0f, 9.23f, 1.78f, -20.88f, 100.0f, 8.81f, 1.94f, -22.59f};
        ...
        this.cam1.transSPL(fArray4, 0, 1, 60);
        this.cam1.rotateSPL(fArray6, 0, 1, 60);
        this.cam1.setFov(40.76f);
        this.waitCameraPlay(2);
        this.cam1.change();
        float[] fArray7 = new float[]{1.0f, 9.87f, 1.25f, -20.27f, 100.0f, 9.87f, 1.25f, -20.27f};
        ...
        this.cam1.transSPL(fArray7, 1, 2, 21);
        this.cam1.rotateSPL(fArray9, 1, 2, 21);
        this.cam1.setFov(44.28f);
        this.waitCameraPlay(3);
        this.cam1.change();
        float[] fArray10 = new float[]{1.0f, 10.83f, 2.65f, -23.25f, 100.0f, 9.9f, 2.04f, -21.49f};
        ...
        this.cam1.transSPL(fArray10, 0, 0, 21);
        this.cam1.rotateSPL(fArray12, 0, 0, 21);
        this.cam1.setFov(28.92f);
        this.waitCameraPlay(4);
        this.cam1.change();
        float[] fArray13 = new float[]{1.0f, 7.05f, 0.35f, -22.56f, 100.0f, 7.09f, 0.77f, -22.63f};
        ...
        this.cam1.transSPL(fArray13, 0, 0, 69);
        this.cam1.rotateSPL(fArray15, 0, 0, 69);
        this.cam1.setFov(42.04f);
        this.waitCameraPlay(5);
        this.cam1.change();
        float[] fArray16 = new float[]{1.0f, 8.6f, 1.09f, -21.01f, 100.0f, 8.6f, 1.09f, -21.01f};
        ...
        this.cam1.transSPL(fArray16, 0, 2, 30);
        this.cam1.rotateSPL(fArray18, 0, 2, 30);
        this.cam1.setFov(42.04f);
        this.waitCameraPlay(6);
        this.cam1.change();
        this.cam1.setTranslate(10.27f, 0.16f, -28.92f);
        this.cam1.setRotate(14.13f, 514.6f, 0.0f);
        this.cam1.setFov(34.68f);
        this.waitCameraPlay(7);
        this.cam1.change();
        this.cam1.setTranslate(10.49f, 0.16f, -27.42f);
        this.cam1.setRotate(18.61f, 387.94f, 0.0f);
        this.cam1.setFov(43.0f);
        this.waitCameraPlay(8);
        this.cam1.change();
        float[] fArray19 = new float[]{1.0f, 4.94f, 3.27f, -45.26f, 100.0f, 4.94f, 4.68f, -45.26f};
        ...
        this.cam1.transSPL(fArray19, 0, 2, 120);
        this.cam1.rotateSPL(fArray21, 0, 2, 120);
        this.cam1.setFov(35.64f);
        this.waitCameraPlay(9);
        this.cam1.change();
        this.cam1.setTranslate(6.46f, 3.18f, -49.9f);
        this.cam1.setRotate(-1.07f, 499.86f, 0.0f);
        this.cam1.setFov(35.64f);
        this.waitCameraPlay(109);
        this.cam1.change();
        float[] fArray22 = new float[]{1.0f, 6.46f, 3.18f, -49.9f, 100.0f, 6.46f, 3.18f, -49.9f};
        ...
        this.cam1.transSPL(fArray22, 1, 1, 30);
        this.cam1.rotateSPL(fArray24, 1, 1, 30);
        this.cam1.setFov(35.64f);
        this.waitCameraPlay(10);
        this.cam1.change();
        this.cam1.setTranslate(6.39f, 6.03f, -43.72f);
        this.cam1.setRotate(18.33f, 506.57f, 0.0f);
        this.cam1.setFov(35.64f);
        this.waitCameraPlay(11);
        this.cam1.change();
        float[] fArray25 = new float[]{1.0f, 6.11f, 3.18f, -50.04f, 100.0f, 6.11f, 3.18f, -50.04f};
        ...
        this.cam1.transSPL(fArray25, 1, 2, 90);
        this.cam1.rotateSPL(fArray27, 1, 2, 90);
        this.cam1.setFov(41.08f);
        this.waitCameraPlay(12);
        this.cam1.change();
        this.cam1.setTranslate(7.45f, 2.7f, -40.38f);
        this.cam1.setRotate(-4.89f, 518.19f, 0.0f);
        this.cam1.setFov(41.08f);
        this.waitCameraPlay(13);
        this.cam1.change();
        this.cam1.setTranslate(6.62f, 3.26f, -47.06f);
        this.cam1.setRotate(3.89f, 418.11f, 0.0f);
        this.cam1.setFov(24.76f);
        this.waitCameraPlay(14);
        this.cam1.change();
        this.cam1.setTranslate(7.9f, 2.62f, -44.36f);
        this.cam1.setRotate(-6.44f, 523.59f, 0.0f);
        this.cam1.setFov(30.52f);
        this.waitCameraPlay(15);
        this.cam1.change();
        float[] fArray28 = new float[]{1.0f, 5.04f, 1.72f, -30.05f, 100.0f, 6.26f, 1.72f, -30.11f};
        ...
        this.cam1.transSPL(fArray28, 0, 2, 270);
        this.cam1.rotateSPL(fArray30, 0, 2, 270);
        this.cam1.setFov(30.52f);
    }
    ...
    public void cleanup() {
        ...
        System.println("XEVEFLAG:EV01B02_F");
        Runtime.setFlags(51, 1, 1);
        System.println("XEVEJNAME:CFJ1_150 XEVEJPOINT:POINT_150");
    ...
    void init() {
        ...
        Runtime.setLocation(48);
        System.methodSignal(1);
        this.thread1 = Thread.create(this, "CameraThread");
        this.thread1.start();
        this.shion = new Human();
        this.shion.init(0x100001E, 9.24f, 0.0f, -22.03f, 187.0f);
        this.shion.start(4, null);
        this.shion.face = this.shion.getChild(0x1000000);
        this.shion.setMotionFlags(0x2000000, true);
        this.guno1 = new Enemy();
        this.guno1.init(16385, 10.89f, 0.0f, -23.7f, -23.0f);
        this.guno1.start(4, null);
        this.guno1.setShadow(0, 0);
        this.guno2 = new Enemy();
        this.guno2.init(16385, 5.98f, 0.0f, -24.09f, 46.0f);
        this.guno2.start(4, null);
        this.guno2.setShadow(0, 0);
        this.door1 = new Mapunit();
        this.door1.init(65);
        this.door1.start(4, null);
        this.door1.setTranslate(0.0f, 0.0f, 0.0f);
        this.door1.setRotate(0.0f, 0.0f, 0.0f);
        this.door2 = new Mapunit();
        this.door2.init(66);
        this.door2.start(4, null);
        this.door2.setTranslate(0.0f, 0.0f, 0.0f);
        this.door2.setRotate(0.0f, 0.0f, 0.0f);
        this.claw1 = new Mapunit();
        this.claw1.init(129);
        this.claw1.start(4, null);
        this.claw1.setTranslate(0.0f, 0.0f, 0.0f);
        this.claw1.setRotate(0.0f, 0.0f, 0.0f);
        this.claw2 = new Mapunit();
        this.claw2.init(130);
        this.claw2.start(4, null);
        this.claw2.setTranslate(0.0f, 0.0f, 0.0f);
        this.claw2.setRotate(0.0f, 0.0f, 0.0f);
        this.bar = new Mapunit();
        this.bar.init(136);
        this.bar.start(4, null);
        this.bar.setTranslate(0.0f, 0.0f, 0.0f);
        this.bar.setRotate(0.0f, 0.0f, 0.0f);
        this.tray1 = new Mapunit();
        this.tray1.init(135);
        this.tray1.start(4, null);
        this.tray1.setTranslate(0.0f, 0.0f, 0.0f);
        this.tray1.setRotate(0.0f, 0.0f, 0.0f);
        this.tray2 = new Mapunit();
        this.tray2.init(137);
        this.tray2.start(4, null);
        this.tray2.setTranslate(0.0f, 0.0f, 0.0f);
        this.tray2.setRotate(0.0f, 0.0f, 0.0f);
        this.tray3 = new Mapunit();
        this.tray3.init(138);
        this.tray3.start(4, null);
        this.tray3.setTranslate(0.0f, 0.0f, 0.0f);
        this.tray3.setRotate(0.0f, 0.0f, 0.0f);
        this.tank1 = new Mapunit();
        this.tank1.init(196);
        this.tank1.start(4, null);
        this.tank1.setTranslate(0.0f, 0.0f, 0.0f);
        this.tank1.setRotate(0.0f, 0.0f, 0.0f);
        this.tank2 = new Mapunit();
        this.tank2.init(197);
        this.tank2.start(4, null);
        this.tank2.setTranslate(0.0f, 0.0f, 0.0f);
        this.tank2.setRotate(0.0f, 0.0f, 0.0f);
        ...
        this.monitor1.setMonitorPrio(1);
        Stage.setVisible(119, false);
        this.eft = new Effect(628, 6.14f, 1.34f, -41.18f, 187.0f);
        this.eft.setScale(2.0f, 2.0f, 2.0f);
        this.eft.disp(false);
        this.eft2 = new Effect(628, 4.64f, 1.34f, -41.18f, 187.0f);
        ...
        this.eft4 = new Effect(1516, 4.4f, 1.34f, -41.18f, 187.0f);
        this.eft4.setScale(0.2f, 0.2f, 0.2f);
        ...
        this.eft6 = new Effect(1011, 4.881f, 3.257f, -48.376f, 146.0f);
        this.eft6.setScale(1.0f, 1.0f, 1.0f);
        this.eft6.disp(false);
    }
    ...
    void play() {
        this.CameraTool();
        System.sleep(1);
        Sound.streamPlay(1190056, 48000);
        this.CameraPlay = 1;
        Runtime.setDefocusQuick(0, 1, 19880, 1);
        Runtime.setDefocusQuick(1, 1, 11688, 1);
        this.light.setColor(0, 0.15f, 0.15f, 0.15f);
        this.light.setColor(1, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(1, 0.662f, 0.447f, -0.602f);
        this.light.setColor(2, 0.65f, 0.65f, 0.65f);
        this.light.setDirection2(2, 0.303f, 0.524f, 0.796f);
        this.light.setColor(3, 0.27f, 0.27f, 0.27f);
        this.light.setDirection2(3, 0.693f, -0.709f, 0.13f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.guno1.renderCommand(22);
        this.guno2.renderCommand(22);
        this.shion.start(1, "shion_act1");
        this.guno1.start(1, "guno1_act1");
        this.guno2.start(1, "guno2_act1");
        this.shion.face.mtn(275, 9, 1.0f, false);
        this.shion.face.start(4, null);
        System.sleep(75);
        this.eft6.disp(true);
        this.CameraPlay = 101;
        Runtime.setDefocusQuick(0, 1, 39880, 1);
        Runtime.setDefocusQuick(1, 1, 31688, 1);
        this.light.setColor(0, 0.13f, 0.13f, 0.13f);
        this.light.setColor(1, 0.69f, 0.69f, 0.69f);
        this.light.setDirection2(1, 0.844f, 0.435f, -0.313f);
        this.light.setColor(2, 0.39f, 0.39f, 0.39f);
        this.light.setDirection2(2, -0.655f, 0.141f, -0.742f);
        this.light.setColor(3, 0.24f, 0.24f, 0.24f);
        this.light.setDirection2(3, 0.174f, -0.701f, -0.692f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        System.sleep(45);
        this.CameraPlay = 102;
        ...
        Stage.setColor(1.0f, 1.0f, 1.0f);
        Runtime.setDefocusQuick(0, 2, 16264, 1);
        Runtime.setDefocusQuick(1, 2, 24456, 1);
        this.shion.face.mtn(274, 9, 1.5f, false);
        this.shion.face.start(4, null);
        System.sleep(60);
        this.CameraPlay = 2;
        Runtime.setDefocusQuick(0, 0, 16264, 1);
        Runtime.setDefocusQuick(1, 0, 24456, 1);
        this.light.setColor(0, 0.25f, 0.25f, 0.25f);
        this.light.setColor(1, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(1, 0.494f, 0.249f, 0.833f);
        this.light.setColor(2, 0.5f, 0.5f, 0.5f);
        ...
        this.light.setDirection2(1, 0.679f, 0.452f, -0.579f);
        this.light.setColor(2, 0.39f, 0.39f, 0.39f);
        this.light.setDirection2(2, -0.653f, 0.698f, -0.294f);
        this.light.setColor(3, 0.25f, 0.25f, 0.25f);
        this.light.setDirection2(3, 0.174f, -0.701f, -0.692f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.shion.start(1, "shion_act5");
        System.sleep(21);
        this.CameraPlay = 4;
        Runtime.setDefocus(0, 0, null);
        this.light.setColor(0, 0.13f, 0.13f, 0.13f);
        this.light.setColor(1, 0.58f, 0.58f, 0.58f);
        this.light.setDirection2(1, 0.17f, 0.23f, -0.958f);
        this.light.setColor(2, 0.61f, 0.61f, 0.61f);
        this.light.setDirection2(2, -0.953f, 0.196f, -0.23f);
        this.light.setColor(3, 0.25f, 0.25f, 0.25f);
        this.light.setDirection2(3, -0.507f, -0.679f, -0.53f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        Runtime.setDefocusQuick(0, 1, 63880, 1);
        Runtime.setDefocusQuick(1, 1, 55688, 1);
        this.shion.start(1, "shion_act6");
        this.shion.face.mtn(276, 9, 1.0f, false);
        this.shion.face.start(4, null);
        this.guno1.setVisible(true);
        this.guno1.start(1, "guno1_act6");
        System.sleep(6);
        System.sleep(45);
        this.CameraPlay = 5;
        ...
        this.light.setDirection2(1, 0.862f, 0.447f, 0.237f);
        this.light.setColor(2, 0.37f, 0.37f, 0.37f);
        this.light.setDirection2(2, -0.505f, 0.624f, 0.597f);
        this.light.setColor(3, 0.16f, 0.16f, 0.16f);
        this.light.setDirection2(3, -0.206f, -0.636f, 0.743f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.guno2.start(1, "guno2_act7");
        System.sleep(30);
        System.sleep(14);
        System.sleep(1);
        this.CameraPlay = 6;
        ...
        this.light.setColor(0, 0.15f, 0.15f, 0.15f);
        this.light.setColor(1, 0.77f, 0.77f, 0.77f);
        this.light.setDirection2(1, 0.765f, 0.279f, -0.581f);
        this.light.setColor(2, 0.65f, 0.65f, 0.65f);
        this.light.setDirection2(2, -0.737f, 0.41f, -0.537f);
        this.light.setColor(3, 0.23f, 0.23f, 0.23f);
        this.light.setDirection2(3, 0.543f, -0.772f, -0.33f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.shion.start(1, "shion_act8");
        this.guno1.start(1, "guno1_act8");
        System.sleep(45);
        this.CameraPlay = 7;
        this.light.setColor(0, 0.15f, 0.15f, 0.15f);
        this.light.setColor(1, 0.77f, 0.77f, 0.77f);
        this.light.setDirection2(1, 0.916f, 0.336f, 0.22f);
        this.light.setColor(2, 0.65f, 0.65f, 0.65f);
        this.light.setDirection2(2, -0.657f, 0.514f, 0.552f);
        this.light.setColor(3, 0.3f, 0.3f, 0.3f);
        this.light.setDirection2(3, 0.235f, -0.678f, 0.696f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        Runtime.setDefocusQuick(0, 1, 4880, 1);
        Runtime.setDefocusQuick(1, 0, 11688, 1);
        this.shion.start(1, "shion_act9");
        System.sleep(75);
        this.guno1.start(1, "guno1_act9");
        System.sleep(30);
        this.CameraPlay = 8;
        this.shion.start(1, "shion_act10");
        this.guno2.start(1, "guno2_act10");
        this.light.setColor(0, 0.15f, 0.15f, 0.15f);
        this.light.setColor(1, 0.74f, 0.74f, 0.74f);
        this.light.setDirection2(1, -0.376f, 0.279f, -0.884f);
        this.light.setColor(2, 0.58f, 0.58f, 0.58f);
        this.light.setDirection2(2, 0.862f, 0.492f, -0.122f);
        this.light.setColor(3, 0.19f, 0.19f, 0.19f);
        this.light.setDirection2(3, -0.137f, -0.81f, -0.57f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        System.sleep(120);
        this.CameraPlay = 9;
        this.shion.face.mtn(272, 9, 1.0f, false);
        this.shion.face.start(4, null);
        this.shion.setShadow(0, 0);
        this.light.setColor(0, 0.14f, 0.14f, 0.14f);
        this.light.setColor(1, 0.36f, 0.36f, 0.36f);
        this.light.setDirection2(1, -0.2f, 0.0f, -0.98f);
        this.light.setColor(2, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(2, 0.894f, 0.433f, -0.119f);
        ...
        Runtime.setDefocusQuick(1, 1, 13688, 1);
        Runtime.setDefocusQuick(2, 1, 5496, 1);
        this.light.setColor(0, 0.25f, 0.25f, 0.25f);
        this.light.setColor(1, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(1, 0.494f, 0.249f, 0.833f);
        this.light.setColor(2, 0.5f, 0.5f, 0.5f);
        ...
        System.sleep(12);
        this.bar.start(1, "bar_down");
        this.tray1.start(1, "tray1_down");
        this.tray2.start(1, "tray2_down");
        this.tray3.start(1, "tray3_down");
        this.tank1.start(1, "tank_down");
        this.tank2.start(1, "tank_down");
        System.sleep(21);
        this.tray1.rotX(9, 18.0f, true);
        this.tray2.rotX(9, -18.0f, true);
        this.tray3.rotX(9, 18.0f, true);
        System.sleep(9);
        this.tank1.start(1, "tank_down2");
        this.tank2.start(1, "tank2_down2");
        System.sleep(3);
        this.tank1.setVisible(false);
        this.eft.disp(true);
        System.sleep(4);
        this.tank2.setVisible(false);
        this.eft2.disp(true);
        System.sleep(22);
        this.CameraPlay = 12;
        Runtime.setDefocusQuick(0, 1, 73880, 1);
        Runtime.setDefocusQuick(1, 1, 65688, 1);
        Runtime.setDefocusQuick(2, 1, 57496, 1);
        this.light.setColor(0, 0.25f, 0.25f, 0.25f);
        this.light.setColor(1, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(1, 0.494f, 0.249f, 0.833f);
        this.light.setColor(2, 0.5f, 0.5f, 0.5f);
        ...
        this.light.setDirection2(3, -0.544f, -0.369f, -0.753f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.guno1.start(1, "guno1_act12");
        this.guno2.start(1, "guno2_act12");
        System.sleep(26);
        System.sleep(1);
        this.CameraPlay = 13;
        Runtime.setDefocusQuick(0, 1, 107880, 1);
        Runtime.setDefocusQuick(1, 0, 65688, 1);
        Runtime.setDefocusQuick(2, 0, 57496, 1);
        this.light.setColor(0, 0.14f, 0.14f, 0.14f);
        this.light.setColor(1, 0.51f, 0.43f, 0.43f);
        this.light.setDirection2(1, -0.186f, 0.03f, 0.982f);
        this.light.setColor(2, 0.55f, 0.55f, 0.55f);
        this.light.setDirection2(2, 0.933f, 0.282f, 0.224f);
        this.light.setColor(3, 0.15f, 0.15f, 0.15f);
        this.light.setDirection2(3, 0.464f, -0.641f, 0.611f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.shion.start(1, "shion_act15");
        this.shion.face.mtn(273, 9, 1.0f, false);
        this.shion.face.start(4, null);
        this.eft3.disp(true);
        this.eft4.disp(true);
        this.eft5.disp(true);
        System.sleep(60);
        this.CameraPlay = 14;
        Runtime.setDefocusQuick(0, 0, 95880, 1);
        Runtime.setDefocusQuick(1, 0, 87688, 1);
        Runtime.setDefocusQuick(2, 0, 79496, 1);
        this.light.setColor(0, 0.25f, 0.25f, 0.25f);
        this.light.setColor(1, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(1, 0.494f, 0.249f, 0.833f);
        this.light.setColor(2, 0.5f, 0.5f, 0.5f);
        ...
        System.sleep(75);
        this.CameraPlay = 15;
        Runtime.setDefocusQuick(0, 1, 90880, 1);
        Runtime.setDefocusQuick(1, 1, 82688, 1);
        Runtime.setDefocusQuick(2, 0, 79496, 1);
        this.light.setColor(0, 0.1f, 0.1f, 0.1f);
        this.light.setColor(1, 0.44f, 0.44f, 0.44f);
        this.light.setDirection2(1, -0.304f, 0.411f, 0.859f);
        this.light.setColor(2, 0.69f, 0.69f, 0.69f);
        this.light.setDirection2(2, 0.424f, 0.236f, 0.875f);
        this.light.setColor(3, 0.12f, 0.12f, 0.12f);
        this.light.setDirection2(3, 0.013f, -0.395f, 0.919f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        Stage.setEffectRender(0);
        System.sleep(90);
        this.shion.start(1, "shion_act17");
        System.sleep(30);
        this.door1.start(1, "door1_open");
        this.door2.start(1, "door2_open");
        System.sleep(60);
    ...
    class Human
        ...
        void shion_act1() {
            SCE010B02.this.shion.setShadow(5, 18);
            this.mtn(257, 8, 0.9f, true);
        }

        void shion_act10() {
            this.setCollision(true);
            this.mtn(262, 8, 1.0f, false);
            this.move(75, 6.01f, -44.99f, true);
        }

        void shion_act11() {
            this.setTranslate(5.97f, 2.0f, -46.69f);
            this.setRotate(0.0f, 213.03f, 0.0f);
            this.mtn(260, 8, 1.0f, true);
        }

        void shion_act12() {
            this.setTranslate(5.47f, 2.0f, -47.98f);
            this.setRotate(0.0f, 213.03f, 0.0f);
            this.mtn(261, 0, 1, 0, 0, 0.1f, true);
        }

        void shion_act13() {
            this.mtn(261, 0, 0.1f, true);
        }

        void shion_act15() {
            this.mtn(261, 9, 72, 0, 0, 0.4f, true);
        }

        void shion_act16() {
            this.setTranslate(5.12f, 2.0f, -56.81f);
            this.setRotate(0.0f, 180.33f, 0.0f);
            this.mtn(262, 8, 0.7f, false);
            this.move(60, 5.12f, -61.28f, true);
        }

        void shion_act17() {
            this.mtn(262, 8, 0.7f, false);
            this.rotY(15, 176.87f, false);
            this.move(75, 4.79f, -62.18f, true);
        }

        void shion_act4() {
            this.setTranslate(9.24f, 0.0f, -19.93f);
        ...
        void shion_act8() {
            this.setTranslate(8.32f, 0.0f, -24.58f);
            this.setRotate(0.0f, 172.03f, 0.0f);
            this.mtn(262, 8, 1.0f, false);
            this.move(30, 9.01f, -28.61f, true);
        }

        void shion_act9() {
            this.setTranslate(9.03f, 0.0f, -27.61f);
            this.setRotate(0.0f, 190.29f, 0.0f);
            this.setCollision(true);
            this.mtn(262, 8, 1.0f, false);
            this.move(120, 6.73f, -39.31f, true);
        }
    }

    class Enemy
            extends Chr {
        Spline moveSPL = Spline.create();

        Enemy() {
        }

        void guno1_act1() {
            SCE010B02.this.gnoFilter[0] = 0.24f;
            SCE010B02.this.gnoFilter[1] = 38.0f;
            SCE010B02.this.gnoFilter[2] = 50.0f;
            SCE010B02.this.gnoFilter[3] = 0.85f;
            SCE010B02.this.guno1.setFilterParam(SCE010B02.this.gnoFilter);
            SCE010B02.this.guno1.setFilter(2);
            this.mtn(265, 8, 1.0f, true);
        }

        void guno1_act12() {
            this.setTranslate(6.47f, 0.0f, -37.04f);
            this.setRotate(0.0f, -163.02f, 0.0f);
            this.mtn(269, 0, 14, 0, 0, 0.9f, true);
            this.mtn(269, 15, 50, 0, 0, 0.1f, true);
        }

        void guno1_act4() {
            this.mtn(266, 0, 21, 1, 1, 1.0f, true);
        }

        void guno1_act6() {
            this.mtn(266, 17, 23, 0, 0, 1.0f, true);
            this.mtn(266, 24, 40, 0, 0, 0.18f, true);
        }

        void guno1_act8() {
            this.setTranslate(10.39f, 0.0f, -23.67f);
            this.setRotate(0.0f, -17.0f, 0.0f);
            this.mtn(270, 1, 0.4f, false);
            this.rotY(30, -49.0f, true);
        }

        void guno1_act9() {
            this.setTranslate(9.49f, 0.0f, -27.57f);
            this.setRotate(0.0f, -169.0f, 0.0f);
            this.mtn(264, 8, 0.6f, false);
            this.move(180, 7.58f, -33.81f, true);
        }

        void guno2_act1() {
            SCE010B02.this.gnoFilter[0] = 0.24f;
            SCE010B02.this.gnoFilter[1] = 8.0f;
            SCE010B02.this.gnoFilter[2] = 7.0f;
            SCE010B02.this.gnoFilter[3] = 0.85f;
            SCE010B02.this.guno2.setFilterParam(SCE010B02.this.gnoFilter);
            SCE010B02.this.guno2.setFilter(2);
            this.mtn(265, 8, 1.0f, true);
        }

        void guno2_act10() {
            this.setTranslate(5.98f, 0.0f, -24.09f);
            this.setRotate(0.0f, 176.0f, 0.0f);
            this.mtn(264, 8, 0.6f, false);
            this.move(90, 5.48f, -28.19f, true);
        }

        void guno2_act12() {
            this.setTranslate(3.64f, 0.0f, -35.06f);
            this.setRotate(0.0f, 193.92f, 0.0f);
            this.mtn(268, 0, 9, 0, 0, 0.7f, true);
            this.mtn(268, 10, 50, 0, 0, 0.05f, true);
        }

        void guno2_act7() {
            this.mtn(267, 1, 0.6f, true);
        }
    }
    ...
    class Mapunit
        ...
        void bar_down() {
            ...
            this.move1SPL.setCtrlVertex(fArray2, 1, 16, 30);
            this.rotX(36, -7.0f, false);
            this.rotY(36, 1.0f, false);
            this.rotZ(36, -19.0f, false);
            this.move(this.move1SPL, true);
        }

        void claw1_open() {
            this.rotX(9, 10.0f, false);
            this.rotY(9, 1.0f, false);
            this.rotZ(9, -87.0f, true);
        }

        void claw2_open() {
            this.rotX(9, 28.0f, false);
            this.rotY(9, 0.0f, false);
            this.rotZ(9, 88.0f, true);
        }
        ...
        void door1_open() {
            ...
            fArray[5] = -1.99f;
            float[] fArray2 = fArray;
            this.move1SPL.setCtrlVertex(fArray2, 1, 18, 30);
            this.setRotateY(0.01f);
            this.rotY(36, 0.0f, false);
            this.move(this.move1SPL, true);
        }
        ...
        void tank2_down2() {
            ...
            fArray[7] = 0.33f;
            float[] fArray2 = fArray;
            this.move1SPL.setCtrlVertex(fArray2, 1, 18, 6);
            this.rotX(6, 12.0f, false);
            this.rotY(6, -8.0f, false);
            this.rotZ(6, -10.0f, false);
            this.move(this.move1SPL, true);
        }
        ...
        void tank_down2() {
            ...
            fArray[11] = 0.43f;
            float[] fArray2 = fArray;
            this.move1SPL.setCtrlVertex(fArray2, 1, 16, 6);
            this.rotX(15, 24.0f, false);
            this.rotY(15, -8.0f, false);
            this.rotZ(15, 7.0f, false);
            this.move(this.move1SPL, true);
        }
