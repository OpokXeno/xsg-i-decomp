...
class SCE03024
    ...
    void MotionPack_serv1(int n) {
        ...
        this.light.setDirection2(1, 0.653f, 0.746f, 0.13f);
        this.light.setColor(2, 0.18f, 0.21f, 0.2f);
        this.light.setDirection2(2, -0.887f, 0.41f, 0.212f);
        this.light.setColor(3, 0.22f, 0.27f, 0.27f);
        this.light.setDirection2(3, 0.444f, -0.521f, 0.729f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 0: {
                    Sound.streamPlay(1390040, 48000);
                    this.allen.setShadow(1, 100);
                    this.chaos.setShadow(1, 100);
                    this.shion.setShadow(1, 100);
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv10a(int n) {
        this.Timechk_CutChange();
        this.light.setColor(0, 0.07f, 0.08f, 0.08f);
        this.light.setColor(1, 0.29f, 0.31f, 0.31f);
        this.light.setDirection2(1, -0.596f, 0.339f, -0.728f);
        this.light.setColor(2, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(2, 0.978f, 0.129f, 0.164f);
        this.light.setColor(3, 0.25f, 0.25f, 0.25f);
        this.light.setDirection2(3, 0.599f, -0.342f, -0.724f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 0: {
                    this.MSG(45, this.shion_h.face, 23, 36, "There would have to be some other,");
                }
                case 45: {
                    this.MSG(52, this.shion_h.face, 23, 42, "external force...");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv10b(int n) {
        this.elly.start(1, "elly_act");
        this.camerawork.cut_0();
        this.Timechk_CutChange();
        this.light.setColor(0, 0.06f, 0.03f, 0.05f);
        this.light.setColor(1, 0.54f, 0.4f, 0.16f);
        this.light.setDirection2(1, -0.879f, 0.013f, 0.477f);
        ...
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 20: {
                    this.MSG(95, this.elly.face, 1, 84, "I've been waiting a long time\nfor all of you...");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv11(int n) {
        ...
        this.light.setColor(0, 0.07f, 0.08f, 0.08f);
        this.light.setColor(1, 0.29f, 0.31f, 0.31f);
        this.light.setDirection2(1, -0.605f, 0.247f, -0.756f);
        this.light.setColor(2, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(2, 0.978f, 0.129f, 0.164f);
        this.light.setColor(3, 0.25f, 0.25f, 0.25f);
        this.light.setDirection2(3, 0.599f, -0.342f, -0.724f);
    ...
    void MotionPack_serv12(int n) {
        ...
        this.light.setColor(1, 0.29f, 0.31f, 0.31f);
        this.light.setDirection2(1, -0.605f, 0.25f, -0.756f);
        this.light.setColor(2, 0.65f, 0.65f, 0.65f);
        this.light.setDirection2(2, 0.978f, 0.129f, 0.164f);
        this.light.setColor(3, 0.25f, 0.25f, 0.25f);
        this.light.setDirection2(3, 0.425f, -0.609f, -0.67f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                ...
                case 20: {
                    this.MSG(105, this.chaos.face, 1, 96, "Regardless of how we got here,\nthis is KOS-MOS' mainframe.");
                    break;
                }
                case 146: {
                    this.MSG(52, this.chaos.face, 1, 42, "Our memories found a");
                    break;
                }
                case 200: {
                    this.MSG(120, this.chaos.face, 1, 111, "common resonance within her,\nand resulted in the creation\nof this world...");
                    break;
                }
                case 335: {
                    this.MSG(35, this.chaos.face, 1, 25, "That's what it feels like to me.");
                    break;
                }
                case 390: {
                    this.MSG(75, "アレンOFF", "But, I don't remember\never being in a place like this.");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv13(int n) {
        this.Timechk_CutChange();
        this.light.setColor(0, 0.06f, 0.07f, 0.07f);
        this.light.setColor(1, 0.23f, 0.26f, 0.26f);
        this.light.setDirection2(1, 0.269f, -0.411f, 0.871f);
        this.light.setColor(2, 0.61f, 0.61f, 0.61f);
        this.light.setDirection2(2, 0.815f, 0.404f, 0.415f);
        this.light.setColor(3, 0.22f, 0.22f, 0.22f);
        this.light.setDirection2(3, 0.148f, -0.339f, -0.929f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 0: {
                    this.MSG(30, this.chaos.face, 1, 20, "I wonder if perhaps");
                    break;
                }
                case 48: {
                    this.MSG(80, this.chaos.face, 1, 66, "memories -- in other words, events\nthat occurred in the past --");
                    break;
                }
                case 129: {
                    this.MSG(110, this.chaos.face, 1, 100, "become stronger, more selective,\nand gain a higher priority ");
                    break;
                }
                case 246: {
                    this.MSG(135, this.chaos.face, 1, 120, "when they resonate with others\nthat share identical axes\nin time and space.");
                    break;
                }
                case 393: {
                    this.MSG(35, this.chaos.face, 1, 25, "If you think about it in those terms,");
                    break;
                }
                case 435: {
                    this.MSG(115, this.chaos.face, 1, 105, "it isn't quite so odd that both my\nmemories and those of Allen are\n not reflected here.");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv14(int n) {
        this.Timechk_CutChange();
        this.light.setColor(0, 0.07f, 0.08f, 0.08f);
        this.light.setColor(1, 0.31f, 0.33f, 0.33f);
        this.light.setDirection2(1, -0.179f, 0.338f, -0.924f);
        this.light.setColor(2, 0.8f, 0.8f, 0.8f);
        this.light.setDirection2(2, 0.858f, 0.242f, 0.453f);
        this.light.setColor(3, 0.25f, 0.25f, 0.25f);
        this.light.setDirection2(3, 0.462f, -0.885f, 0.055f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 0: {
                    this.MSG(60, "ziggy", "So,");
                    break;
                }
                case 78: {
                    this.MSG(150, "ziggy", "what you're saying is,\nthis world is constantly changing\nbased on the experiences");
                    break;
                }
                case 243: {
                    this.MSG(70, "ziggy", "people share in time and space?");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv15(int n) {
        this.Timechk_CutChange();
        this.light.setColor(0, 0.09f, 0.1f, 0.1f);
        this.light.setColor(1, 0.23f, 0.26f, 0.26f);
        this.light.setDirection2(1, 0.269f, -0.411f, 0.871f);
        this.light.setColor(2, 0.7f, 0.7f, 0.7f);
        this.light.setDirection2(2, 0.848f, 0.34f, 0.406f);
        this.light.setColor(3, 0.22f, 0.22f, 0.22f);
        this.light.setDirection2(3, 0.005f, -0.676f, -0.737f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                ...
                case 15: {
                    this.MSG(80, this.jr.face, 5, 72, "A world made up of our past,");
                    break;
                }
                case 102: {
                    this.MSG(90, this.jr.face, 5, 81, "as glimpsed through\nthe mind of KOS-MOS...");
                    break;
                }
                case 240: {
                    this.MSG(75, this.momo.face, 7, 70, "So...it's all an illusion...?");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv16(int n) {
        ...
        this.light.setColor(1, 0.21f, 0.23f, 0.23f);
        this.light.setDirection2(1, -0.909f, 0.026f, 0.416f);
        this.light.setColor(2, 0.7f, 0.7f, 0.7f);
        this.light.setDirection2(2, 0.555f, 0.198f, -0.808f);
        this.light.setColor(3, 0.23f, 0.23f, 0.23f);
        this.light.setDirection2(3, -0.334f, -0.56f, -0.758f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 0: {
                    this.FACE(this.shion_h.face, 8);
                    break;
                }
                case 25: {
                    this.MSG(140, this.shion_h.face, 7, 130, "There's no difference between\nillusion and reality to the\nperson experiencing it.");
                    break;
                }
                case 229: {
                    this.MSG(25, this.shion_h.face, 7, 18, "This is...");
                    break;
                }
                case 301: {
                    this.MSG(45, this.shion_h.face, 7, 39, "no illusion...");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv17(int n) {
        ...
        this.light.setColor(0, 0.09f, 0.1f, 0.1f);
        this.light.setColor(1, 0.23f, 0.26f, 0.26f);
        this.light.setDirection2(1, 0.139f, 0.0f, 0.99f);
        this.light.setColor(2, 0.7f, 0.7f, 0.7f);
        this.light.setDirection2(2, 0.921f, 0.377f, 0.097f);
        this.light.setColor(3, 0.22f, 0.22f, 0.22f);
        this.light.setDirection2(3, -0.113f, -0.827f, -0.55f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
    ...
    void MotionPack_serv18(int n) {
        this.Timechk_CutChange();
        this.light.setColor(0, 0.03f, 0.04f, 0.04f);
        this.light.setColor(1, 0.23f, 0.26f, 0.26f);
        this.light.setDirection2(1, 0.269f, -0.411f, 0.871f);
        this.light.setColor(2, 0.7f, 0.7f, 0.7f);
        this.light.setDirection2(2, 0.815f, 0.404f, 0.415f);
        ...
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                ...
                case 30: {
                    this.MSG(30, this.allen.face, 7, 20, "Chief...");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv19(int n) {
        ...
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 15: {
                    this.MSG(140, "elly", "All of you must accept\nthe entirety of your memories.");
                    break;
                }
                case 195: {
                    this.MSG(50, "shion_h", "So that's what she meant...");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv3(int n) {
        this.Timechk_CutChange();
        this.light.setColor(0, 0.06f, 0.07f, 0.07f);
        this.light.setColor(1, 0.27f, 0.3f, 0.3f);
        this.light.setDirection2(1, 0.866f, 0.137f, 0.481f);
        this.light.setColor(2, 0.6f, 0.6f, 0.6f);
        this.light.setDirection2(2, 0.263f, 0.303f, 0.916f);
        this.light.setColor(3, 0.22f, 0.22f, 0.22f);
        this.light.setDirection2(3, 0.809f, -0.399f, -0.432f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                ...
                case 45: {
                    this._MSG(30, "shion_h", "Is that...");
                    this.shion_h.face.mtn(23, 0, 120, 8, 1, 1.0f, false);
                    this.shion_h.face.start(4, null);
                    System.sleep(20);
                    this.shion_h.face.mtn(24, 0, 120, 8, 1, 1.0f, false);
                    this.shion_h.face.start(4, null);
                    break;
                }
            }
    ...
    void MotionPack_serv5(int n) {
        this.Timechk_CutChange();
        this.light.setColor(0, 0.09f, 0.1f, 0.1f);
        this.light.setColor(1, 0.26f, 0.29f, 0.29f);
        this.light.setDirection2(1, -0.261f, -0.34f, 0.904f);
        this.light.setColor(2, 0.7f, 0.7f, 0.7f);
        this.light.setDirection2(2, 0.822f, 0.567f, 0.062f);
        this.light.setColor(3, 0.22f, 0.22f, 0.22f);
        this.light.setDirection2(3, 0.646f, -0.76f, -0.068f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
    ...
    void MotionPack_serv6(int n) {
        ...
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 0: {
                    this.MSG(40, this.shion_h.face, 9, 30, "Jr.?!");
                    break;
                }
                case 75: {
                    this.shion_h.face.mtn(22, 0, 120, 8, 1, 0.5f, false);
                    this.shion_h.face.start(4, null);
                    break;
                }
                case 126: {
                    this.MSG(85, this.shion_h.face, 21, 75, "How did you all get here...?");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv7(int n) {
        ...
        this.light.setColor(0, 0.09f, 0.1f, 0.1f);
        this.light.setColor(1, 0.26f, 0.29f, 0.29f);
        this.light.setDirection2(1, 0.363f, -0.249f, 0.898f);
        this.light.setColor(2, 0.7f, 0.7f, 0.7f);
        this.light.setDirection2(2, 0.798f, 0.471f, 0.375f);
        this.light.setColor(3, 0.22f, 0.22f, 0.22f);
        this.light.setDirection2(3, -0.968f, 0.005f, 0.251f);
        Stage.setColor(1.0f, 1.0f, 1.0f);
        this.Timechk_srv_totaltime = 0;
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 60: {
                    this.MSG(40, this.jr.face, 7, 33, "Beats me.");
                    break;
                }
                case 144: {
                    this.MSG(95, this.jr.face, 7, 87, "As soon as you dived,\neverything went all hazy,");
                    break;
                }
                case 240: {
                    this.MSG(65, this.jr.face, 7, 54, "and the next thing I knew,\nwe were here.");
                    break;
                }
                case 330: {
                    this.MSG(80, this.jr.face, 7, 70, "After that, there were\nall sorts of visions...");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv8(int n) {
        ...
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 65: {
                    this.MSG(120, this.allen.face, 1, 110, "Did we all get pulled into the\nChief's Encephalon dive?");
                    break;
                }
                case 215: {
                    this.MSG(40, this.shion_h.face, 23, 25, "That's impossible.");
                }
                case 275: {
                    this.MSG(67, this.shion_h.face, 23, 57, "None of you were connected.");
                    break;
                }
            }
            System.sleep(1);
    ...
    void MotionPack_serv9(int n) {
        ...
        while (this.Timechk_srv_totaltime != n) {
            switch (this.Timechk_srv_totaltime) {
                case 10: {
                    this.MSG(120, this.allen.face, 1, 110, "If KOS-MOS' oscillation pulse\ncaused a counter-current\nto flow through");
                    break;
                }
                case 131: {
                    this.MSG(60, this.allen.face, 1, 50, "the Dive Unit,\nit's not inconceivable.");
                    break;
                }
                case 205: {
                    this.MSG(80, this.allen.face, 1, 70, "The ones we use are non-contact\ntypes, after all.");
                    break;
                }
                case 300: {
                    this.MSG(35, this.shion_h.face, 21, 25, "Even if that were the case,");
                    break;
                }
                case 342: {
                    this.MSG(82, this.shion_h.face, 21, 72, "the Simple Dive Unit couldn't\nhandle that great a load.");
                    break;
                }
            }
            System.sleep(1);
    ...
    public void cleanup() {
        ...
        System.println("XEVEFLAG:EV03024_F");
        Runtime.setFlags(336, 1, 1);
        System.println("XEVEJNAME:CFJ3_120 XEVEJPOINT:POINT3_120");
        Runtime.jumpCF(2410, 4);
    }
    ...
    void init() {
        ...
        Runtime.setLocation(1201);
        this.pc = PlayControl.create();
        this.pc.loadCamera("c03s24cut01.cam");
        this.pc.init(1, 0);
    ...
    void play() {
        ...
        this.FACE(this.elly.face, 2);
        this.allen.mtn(257, 0, 150, 8, 0, 1.0f, true);
        this.chaos.mtn(258, 0, 150, 8, 0, 1.0f, true);
        this.shion_h.mtn(259, 0, 150, 8, 0, 1.0f, true);
        this.allen.start(5, null);
        this.chaos.start(5, null);
        this.shion_h.start(5, null);
        this.pc.start();
        this.MotionPack_serv1(150);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut02.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(false);
        this.chaos.setVisible(false);
        this.shion_h.setVisible(false);
        this.pc.start();
        this.MotionPack_serv2(90);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut03.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(true);
        this.chaos.setVisible(true);
        this.shion_h.setVisible(true);
        this.allen.mtn(260, 0, 90, 8, 0, 1.0f, true);
        this.chaos.mtn(261, 0, 90, 8, 0, 1.0f, true);
        this.shion_h.mtn(262, 0, 90, 8, 0, 1.0f, true);
        this.allen.start(5, null);
        this.chaos.start(5, null);
        this.shion_h.start(5, null);
        this.pc.start();
        this.MotionPack_serv3(90);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut04.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(false);
        this.chaos.setVisible(false);
        this.shion_h.setVisible(false);
        this.pc.start();
        this.MotionPack_serv4(90);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut05.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(false);
        this.chaos.setVisible(false);
        ...
        this.jr.mtn(263, 0, 84, 8, 0, 1.0f, true);
        this.momo.mtn(264, 0, 84, 8, 0, 1.0f, true);
        this.shion_h.mtn(265, 0, 84, 8, 0, 1.0f, true);
        this.ziggy.mtn(266, 0, 84, 8, 0, 1.0f, true);
        this.jr.start(5, null);
        this.momo.start(5, null);
        this.shion_h.start(5, null);
        this.ziggy.start(5, null);
        this.pc.start();
        this.MotionPack_serv5(84);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut06.cam");
        this.pc.init(1, 0);
        this.chaos.setVisible(true);
        this.jr.setVisible(false);
        this.momo.setVisible(false);
        this.ziggy.setVisible(false);
        this.chaos.mtn(267, 0, 216, 8, 0, 1.0f, true);
        this.shion_h.mtn(268, 0, 216, 8, 0, 1.0f, true);
        this.chaos.start(5, null);
        this.shion_h.start(5, null);
        this.pc.start();
        this.MotionPack_serv6(216);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut07.cam");
        this.pc.init(1, 0);
        this.chaos.setVisible(false);
        this.jr.setVisible(true);
        this.momo.setVisible(true);
        this.ziggy.setVisible(true);
        this.jr.mtn(269, 0, 440, 8, 0, 1.0f, true);
        this.momo.mtn(270, 0, 440, 8, 0, 1.0f, true);
        this.shion_h.mtn(271, 0, 440, 8, 0, 1.0f, true);
        this.ziggy.mtn(272, 0, 440, 8, 0, 1.0f, true);
        this.jr.start(5, null);
        this.momo.start(5, null);
        this.shion_h.start(5, null);
        this.ziggy.start(5, null);
        this.pc.start();
        this.MotionPack_serv7(440);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut08.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(true);
        this.chaos.setVisible(true);
        this.shion.setVisible(true);
        this.shion_h.setVisible(false);
        this.allen.mtn(273, 0, 356, 8, 0, 1.0f, true);
        this.chaos.mtn(274, 0, 356, 8, 0, 1.0f, true);
        this.jr.mtn(275, 0, 356, 8, 0, 1.0f, true);
        this.momo.mtn(276, 0, 356, 8, 0, 1.0f, true);
        this.shion.mtn(277, 0, 356, 8, 0, 1.0f, true);
        this.ziggy.mtn(278, 0, 356, 8, 0, 1.0f, true);
        this.allen.start(5, null);
        this.chaos.start(5, null);
        this.jr.start(5, null);
        this.momo.start(5, null);
        ...
        this.ziggy.start(5, null);
        this.pc.start();
        this.MotionPack_serv8(356);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut09.cam");
        this.pc.init(1, 0);
        this.elly.setMotNoUpdate(0);
        this.shion_h.setMotNoUpdate(0);
        this.allen.mtn(279, 0, 435, 8, 0, 1.0f, true);
        this.chaos.mtn(280, 0, 435, 8, 0, 1.0f, true);
        this.jr.mtn(281, 0, 435, 8, 0, 1.0f, true);
        this.momo.mtn(282, 0, 435, 8, 0, 1.0f, true);
        this.shion.mtn(283, 0, 435, 8, 0, 1.0f, true);
        this.ziggy.mtn(284, 0, 435, 8, 0, 1.0f, true);
        this.shion_h.mtn(285, 0, 0, 8, 0, 1.0f, true);
        this.shion_h.start(5, null);
        this.allen.start(5, null);
        this.chaos.start(5, null);
        this.jr.start(5, null);
        ...
        this.ziggy.start(5, null);
        this.pc.start();
        this.MotionPack_serv9(435);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut10a.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(false);
        this.chaos.setVisible(false);
        this.jr.setVisible(false);
        ...
        this.ziggy.setVisible(false);
        this.elly.setVisible(false);
        this.shion_h.mtn(285, 0, 135, 8, 0, 1.0f, true);
        this.elly.setTranslate(12.67f, -0.43f, -4.03f);
        this.elly.setRotate(0.5f, -89.8f, 0.0f);
        this.elly.mtn(286, 0, 120, 8, 0, 1.0f, true);
        this.shion_h.start(5, null);
        this.pc.start();
        this.MotionPack_serv10a(135);
        this.pc.stop();
        Runtime.setLocation(1230);
        this.elly.setVisible(true);
        this.shion_h.setVisible(false);
        this.MotionPack_serv10b(120);
        this.pc.loadCamera("c03s24cut11.cam");
        this.pc.init(1, 0);
        Runtime.setLocation(1201);
        ...
        this.elly.setVisible(false);
        this.pc.start();
        this.MotionPack_serv11(45);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut12.cam");
        this.pc.init(1, 0);
        this.chaos.setVisible(true);
        this.chaos.mtn(288, 0, 510, 8, 0, 1.0f, true);
        this.shion_h.mtn(289, 0, 510, 8, 0, 1.0f, true);
        this.chaos.start(5, null);
        this.shion_h.start(5, null);
        this.pc.start();
        this.MotionPack_serv12(510);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut13.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(true);
        this.jr.setVisible(true);
        this.momo.setVisible(true);
        ...
        this.shion.setVisible(true);
        this.shion_h.setVisible(false);
        this.allen.mtn(290, 0, 540, 8, 0, 1.0f, true);
        this.chaos.mtn(291, 0, 540, 8, 0, 1.0f, true);
        this.jr.mtn(292, 0, 540, 8, 0, 1.0f, true);
        this.momo.mtn(293, 0, 540, 8, 0, 1.0f, true);
        this.shion.mtn(294, 0, 540, 8, 0, 1.0f, true);
        this.ziggy.mtn(295, 0, 540, 8, 0, 1.0f, true);
        this.allen.start(5, null);
        this.chaos.start(5, null);
        this.jr.start(5, null);
        this.momo.start(5, null);
        ...
        this.ziggy.start(5, null);
        this.pc.start();
        this.MotionPack_serv13(555);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut14.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(false);
        this.momo.setVisible(false);
        this.chaos.mtn(296, 0, 330, 8, 0, 1.0f, true);
        this.jr.mtn(297, 0, 330, 8, 0, 1.0f, true);
        this.shion_h.mtn(298, 0, 330, 8, 0, 1.0f, true);
        this.ziggy.mtn(299, 0, 330, 8, 0, 1.0f, true);
        this.chaos.start(5, null);
        this.jr.start(5, null);
        this.shion_h.start(5, null);
        this.ziggy.start(5, null);
        this.pc.start();
        this.MotionPack_serv14(330);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut15.cam");
        this.pc.init(1, 0);
        this.chaos.setVisible(false);
        this.momo.setVisible(true);
        this.shion.setVisible(false);
        this.ziggy.setVisible(false);
        this.shion_h.mtn(302, 0, 1, 0, 0, 1.0f, true);
        this.shion_h.start(5, null);
        this.jr.mtn(300, 0, 345, 8, 0, 1.0f, true);
        this.momo.mtn(301, 0, 345, 8, 0, 1.0f, true);
        this.jr.start(5, null);
        this.momo.start(5, null);
        this.pc.start();
        this.MotionPack_serv15(345);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut16.cam");
        this.pc.init(1, 0);
        this.jr.setVisible(false);
        this.momo.setVisible(false);
        this.shion_h.setVisible(true);
        this.shion_h.mtn(302, 0, 390, 0, 0, 1.0f, true);
        this.shion_h.start(5, null);
        this.pc.start();
        this.MotionPack_serv16(390);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut17.cam");
        this.pc.init(1, 0);
        this.jr.setVisible(true);
        this.momo.setVisible(true);
        this.shion_h.setVisible(false);
        this.jr.mtn(303, 0, 60, 8, 0, 1.0f, true);
        this.momo.mtn(304, 0, 60, 8, 0, 1.0f, true);
        this.jr.start(5, null);
        this.momo.start(5, null);
        this.pc.start();
        this.MotionPack_serv17(60);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut18.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(true);
        this.chaos.setVisible(true);
        this.jr.setVisible(false);
        this.momo.setVisible(false);
        this.allen.mtn(305, 0, 90, 8, 0, 1.0f, true);
        this.chaos.mtn(306, 0, 90, 8, 0, 1.0f, true);
        this.allen.start(5, null);
        this.chaos.start(5, null);
        this.pc.start();
        this.MotionPack_serv18(90);
        this.pc.stop();
        this.pc.loadCamera("c03s24cut19.cam");
        this.pc.init(1, 0);
        this.allen.setVisible(false);
        this.chaos.setVisible(false);
        this.pc.start();
        this.MotionPack_serv19(270);
        this.pc.stop();
    ...
    class human
        ...
        public void elly_act() {
            SCE03024.this.elly.setTranslate(12.67f, -0.43f, -4.03f);
            SCE03024.this.elly.setRotate(0.5f, -89.8f, 0.0f);
            SCE03024.this.elly.mtn(286, 0, 120, 8, 0, 1.0f, true);
        }
    }
    ...
    class Camerawork
        ...
        public void cut1() {
            SCE03024.this.Timechk_CutChange();
        }

        public void cut_0() {
            SCE03024.this.Timechk_CutChange();
            SCE03024.this.cam1.setTranslate(12.14f, 0.67f, -4.02f);
            SCE03024.this.cam1.setRotate(-3.58f, -90.0f, 0.0f);
            SCE03024.this.cam1.setFov(35.0f);
        }
    }
