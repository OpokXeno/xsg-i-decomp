...
class SCE02004B
    ...
    void CameraThread() {
        ...
        this.cam1.setTranslate(12.73f, 6.15f, -4.69f);
        this.cam1.setRotate(-24.16f, -41.28f, 0.0f);
        this.cam1.setFov(29.2f);
        this.waitCameraPlay(2);
        this.cam1.setTranslate(9.91f, 5.12f, -3.78f);
        this.cam1.setRotate(9.82f, -60.7f, 0.0f);
        this.cam1.setFov(26.6f);
        this.waitCameraPlay(3);
        float[] fArray = new float[]{1.0f, 12.46f, 7.02f, -4.76f, 100.0f, 12.52f, 6.8f, -5.79f};
        ...
        this.cam1.transSPL(fArray, 1, 1, 280);
        this.cam1.rotateSPL(fArray3, 1, 1, 280);
        this.cam1.setFov(32.8f);
        this.waitCameraPlay(4);
        float[] fArray4 = new float[]{1.0f, 12.31f, 6.07f, -7.94f, 100.0f, 12.31f, 6.07f, -7.94f};
        ...
        this.cam1.transSPL(fArray4, 1, 1, 120);
        this.cam1.rotateSPL(fArray6, 1, 1, 120);
        this.cam1.setFov(24.8f);
        this.waitCameraPlay(5);
        float[] fArray7 = new float[]{1.0f, 12.64f, 6.67f, -6.4f, 100.0f, 12.64f, 6.63f, -6.53f};
        ...
        this.cam1.transSPL(fArray7, 0, 1, 120);
        this.cam1.rotateSPL(fArray9, 0, 1, 120);
        this.cam1.setFov(30.8f);
        this.waitCameraPlay(6);
        this.cam1.setTranslate(11.79f, 6.26f, -6.24f);
        this.cam1.setRotate(21.58f, -126.23f, 0.0f);
        this.cam1.setFov(26.8f);
        this.waitCameraPlay(7);
        this.cam1.setTranslate(11.93f, 6.1f, -6.6f);
        this.cam1.setRotate(6.18f, -42.32f, 0.0f);
        this.cam1.setFov(24.2f);
        this.waitCameraPlay(8);
        this.cam2.change();
        float[] fArray10 = new float[]{1.0f, 11.86f, 7.83f, -2.82f, 100.0f, 13.16f, 7.83f, -2.78f};
        ...
        this.cam2.transSPL(fArray10, 1, 2, 450);
        this.cam2.rotateSPL(fArray12, 1, 2, 450);
        this.cam2.setFov(24.0f);
        this.waitCameraPlay(9);
        float[] fArray13 = new float[]{1.0f, 13.33f, 6.2f, -8.52f, 51.79f, 12.58f, 6.2f, -8.58f, 100.0f, 11.97f, 6.2f, -8.42f};
        ...
        this.cam1.transSPL(fArray13, 1, 1, 800);
        this.cam1.rotateSPL(fArray15, 1, 1, 800);
        this.cam1.setFov(28.02f);
        System.sleep(15);
        this.cam1.change();
    }
    ...
    public void cleanup() {
        ...
        System.println("XEVEFLAG:EV02004B_F");
        Runtime.setFlags(106, 1, 1);
        System.println("XEVEJNAME:CFJ2_30 XEVEJPOINT:POINT2_30");
    ...
    void init() {
        ...
        Runtime.setDefocusQuick(0, 0, 149264, 2);
        Runtime.setDefocusQuick(1, 0, 157456, 2);
        Runtime.setDefocusQuick(2, 0, 149264, -2);
        Runtime.setDefocusQuick(3, 0, 157456, -2);
        this.ziggy = new Human();
        this.ziggy.init(0x1000006, 12.22f, 4.95f, -4.45f, 162.0f);
        this.ziggy.start(4, null);
        this.ziggy.face = this.ziggy.getChild(0x1000000);
        this.momo = new Human();
        this.momo.init(0x1000021, 12.62f, 5.0f, -7.4f, 0.0f);
        ...
        this.usoldB.init(778, 10.7f, 4.99f, -3.57f, 0.0f);
        this.usoldB.start(4, null);
        this.usoldC = new Usold();
        this.usoldC.init(778, 13.47f, 4.97f, -5.6f, 0.0f);
    ...
    void play() {
        ...
        this.Timechk();
        this.CameraPlay = 1;
        Sound.streamPlay(1191009, 48000);
        this.light.setColor(0, 0.08f, 0.08f, 0.08f);
        this.light.setColor(1, 0.65f, 0.65f, 0.65f);
        this.light.setDirection2(1, -0.582f, 0.358f, 0.73f);
        this.light.setColor(2, 0.4f, 0.4f, 0.4f);
        this.light.setDirection2(2, -0.413f, 0.624f, 0.663f);
        this.light.setColor(3, 0.57f, 0.57f, 0.59f);
        this.light.setDirection2(3, 0.04f, -0.63f, -0.776f);
        this.usoldC.start(1, "c_down");
        System.sleep(60);
        this.CameraPlay = 2;
        Runtime.setDefocusQuick(0, 2, 149264, 2);
        Runtime.setDefocusQuick(1, 2, 157456, 2);
        Runtime.setDefocusQuick(2, 2, 149264, -2);
        Runtime.setDefocusQuick(3, 2, 157456, -2);
        this.ziggy.start(1, "ziggy_act2");
        System.sleep(30);
        System.sleep(60);
        this.usoldB.start(1, "b_down");
        System.sleep(30);
        this.ziggy.setVisible(false);
        this.CameraPlay = 3;
        this.usoldB.start(1, "b_yarare");
        this.usoldC.start(1, "c_yarare");
        this.momo.start(1, "momo_act3");
        this.momo.face.mtn(281, 8, 1.0f, false);
        this.momo.face.start(4, null);
        System.sleep(30);
        this.msg.print("Who...are you?");
        ...
        System.sleep(1);
        this.CameraPlay = 4;
        Runtime.setDefocusQuick(0, 2, 89264, -1);
        Runtime.setDefocusQuick(1, 2, 97456, -1);
        Runtime.setDefocusQuick(2, 2, 105648, -1);
        Runtime.setDefocusQuick(3, 2, 113840, -1);
        this.ziggy.setVisible(true);
        this.ziggy.start(1, "ziggy_act4");
        this.ziggy.face.mtn(273, 8, 1.0f, false);
        this.ziggy.face.start(4, null);
        this.ziggy.look_speed(0.0f);
        this.ziggy.look_char(this.momo);
        System.sleep(15);
        this.msg.print("The Contact Subcommittee\nsent me here to rescue you.");
        ...
        System.sleep(15);
        this.CameraPlay = 5;
        Runtime.setDefocusQuick(0, 0, 89264, -1);
        Runtime.setDefocusQuick(1, 0, 97456, -1);
        Runtime.setDefocusQuick(2, 0, 105648, -1);
        Runtime.setDefocusQuick(3, 0, 113840, -1);
        this.momo.start(1, "momo_act5");
        this.ziggy.look_default();
        this.msg.print("The Contact Subcommittee?\nMommy?!");
        this.momo.face.mtn(278, 8, 1.3f, false);
        this.momo.face.start(4, null);
        System.sleep(45);
        this.momo.face.mtn(279, 9, 1.0f, false);
        this.momo.face.start(4, null);
        System.sleep(15);
        this.momo.face.mtn(276, 9, 1.3f, false);
        this.momo.face.start(4, null);
        System.sleep(21);
        ...
        this.ziggy.setHand(this.Lhand | this.Close);
        this.msg.print("Stand away from the door.");
        this.ziggy.face.mtn(272, 8, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(21);
        this.ziggy.face.mtn(273, 8, 1.0f, false);
        this.ziggy.face.start(4, null);
        this.waitclear(21);
        this.msg.print("I'm going to break it in.");
        this.ziggy.face.mtn(272, 8, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(42);
        this.ziggy.face.mtn(273, 8, 1.0f, false);
        ...
        this.msg.print("Wait -- you can't.");
        this.momo.face.mtn(278, 9, 1.0f, false);
        this.momo.face.start(4, null);
        System.sleep(9);
        this.momo.face.mtn(274, 9, 1.3f, false);
        this.momo.face.start(4, null);
        System.sleep(24);
        this.momo.face.mtn(275, 9, 1.0f, false);
        this.momo.face.start(4, null);
        this.waitclear(9);
        this.msg.print("They said an alarm would go off\nif I tried to force it open.");
        this.momo.face.mtn(274, 9, 1.2f, false);
        this.momo.face.start(4, null);
        System.sleep(75);
        this.momo.face.mtn(275, 9, 1.0f, false);
        this.momo.face.start(4, null);
        ...
        this.CameraPlay = 8;
        System.sleep(30);
        this.msg.print("Hmm...I guess looks\ncan be deceiving...");
        this.waitclear(111);
        this.msg.print("There should be a master key\nheld somewhere in this block.");
        ...
        this.waitclear(12);
        System.sleep(21);
        this.msg.print("If you can find it...");
        this.momo.face.mtn(274, 9, 1.0f, false);
        this.momo.face.start(4, null);
        System.sleep(30);
        this.momo.face.mtn(275, 9, 1.0f, false);
        ...
        System.sleep(1);
        Runtime.setDefocusQuick(0, 2, 78264, -1);
        Runtime.setDefocusQuick(1, 2, 86456, -1);
        Runtime.setDefocusQuick(2, 2, 94648, -1);
        Runtime.setDefocusQuick(3, 2, 102840, -1);
        ...
        this.ziggy.face.start(4, null);
        this.waitclear(18);
        this.msg.print("I'll be right back.");
        this.ziggy.face.mtn(272, 8, 1.0f, false);
        this.ziggy.face.start(4, null);
        System.sleep(42);
        this.ziggy.face.mtn(273, 8, 1.0f, false);
    ...
    class Human
        ...
        void momo_act3() {
            SCE02004B.this.momo.setLightMode(1);
            SCE02004B.this.momo.light.setColor(0, 0.07f, 0.07f, 0.07f);
            SCE02004B.this.momo.light.setColor(1, 0.59f, 0.59f, 0.59f);
            SCE02004B.this.momo.light.setDirection2(1, -0.248f, 0.73f, 0.637f);
            SCE02004B.this.momo.light.setColor(2, 0.32f, 0.32f, 0.32f);
            SCE02004B.this.momo.light.setDirection2(2, 0.16f, -0.673f, 0.722f);
            SCE02004B.this.momo.light.setColor(3, 0.19f, 0.19f, 0.19f);
            SCE02004B.this.momo.light.setDirection2(3, -0.827f, -0.551f, -0.112f);
            this.mtn(260, 0, 0.7f, true);
        }

        void momo_act4() {
            this.mtn(262, 0, 0.7f, true);
        }

        void momo_act5() {
            this.setTranslate(12.62f, 5.0f, -7.3f);
            this.setRotate(0.0f, -2876.89f, 0.0f);
            this.mtn(263, 0, 0.68f, true);
        }

        void momo_act7() {
            this.setTranslate(12.63f, 5.0f, -7.42f);
            this.setRotate(0.0f, -2885.88f, 0.0f);
            this.mtn(265, 0, 0.7f, true);
            this.mtn(265, 0, -0.7f, true);
        }

        void momo_act8() {
            this.setRotate(0.0f, -2877.86f, 0.0f);
            this.mtn(262, 0, 0.7f, true);
        }

        void momo_act9() {
            SCE02004B.this.momo.light.setColor(0, 0.15f, 0.15f, 0.15f);
            SCE02004B.this.momo.light.setColor(1, 0.35f, 0.35f, 0.39f);
            SCE02004B.this.momo.light.setDirection2(1, -0.007f, 0.795f, 0.606f);
            SCE02004B.this.momo.light.setColor(2, 0.28f, 0.28f, 0.29f);
            SCE02004B.this.momo.light.setDirection2(2, 0.13f, 0.954f, 0.269f);
            SCE02004B.this.momo.light.setColor(3, 0.42f, 0.42f, 0.42f);
            SCE02004B.this.momo.light.setDirection2(3, -0.11f, -0.628f, 0.771f);
        }

        void ziggy_act2() {
            SCE02004B.this.ziggy.setLightMode(1);
            SCE02004B.this.ziggy.light.setColor(0, 0.11f, 0.11f, 0.11f);
            SCE02004B.this.ziggy.light.setColor(1, 0.47f, 0.47f, 0.47f);
            SCE02004B.this.ziggy.light.setDirection2(1, -0.365f, 0.909f, -0.199f);
            SCE02004B.this.ziggy.light.setColor(2, 0.29f, 0.29f, 0.29f);
            SCE02004B.this.ziggy.light.setDirection2(2, -0.768f, 0.446f, -0.46f);
            SCE02004B.this.ziggy.light.setColor(3, 0.2f, 0.2f, 0.2f);
            SCE02004B.this.ziggy.light.setDirection2(3, -0.451f, -0.618f, -0.644f);
            this.mtn(259, 0, 0.7f, true);
        }

        void ziggy_act4() {
            this.setTranslate(12.52f, 5.02f, -4.99f);
            this.setRotate(0.0f, 349.0f, 0.0f);
            this.mtn(261, 0, 0.7f, true);
        }

        void ziggy_act6() {
            this.setTranslate(12.64f, 5.02f, -5.46f);
            this.setRotate(0.0f, 542.99f, 0.0f);
            SCE02004B.this.ziggy.light.setColor(0, 0.11f, 0.11f, 0.11f);
            SCE02004B.this.ziggy.light.setColor(1, 0.83f, 0.83f, 0.83f);
            SCE02004B.this.ziggy.light.setDirection2(1, -0.825f, 0.368f, 0.428f);
            SCE02004B.this.ziggy.light.setColor(2, 0.17f, 0.17f, 0.17f);
            SCE02004B.this.ziggy.light.setDirection2(2, -0.514f, -0.0f, -0.858f);
            SCE02004B.this.ziggy.light.setColor(3, 0.1f, 0.1f, 0.1f);
            SCE02004B.this.ziggy.light.setDirection2(3, 0.114f, -0.724f, -0.681f);
            this.mtn(264, 8, 1.0f, true);
        }

        void ziggy_act8() {
            SCE02004B.this.ziggy.light.setColor(0, 0.14f, 0.14f, 0.14f);
            SCE02004B.this.ziggy.light.setColor(1, 0.5f, 0.5f, 0.5f);
            SCE02004B.this.ziggy.light.setDirection2(1, -0.206f, 0.745f, 0.634f);
            SCE02004B.this.ziggy.light.setColor(2, 0.56f, 0.56f, 0.56f);
            SCE02004B.this.ziggy.light.setDirection2(2, -0.95f, 0.0f, 0.311f);
            SCE02004B.this.ziggy.light.setColor(3, 0.18f, 0.18f, 0.2f);
            SCE02004B.this.ziggy.light.setDirection2(3, -0.037f, -0.524f, -0.851f);
