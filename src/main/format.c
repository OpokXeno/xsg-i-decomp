...
INCLUDE_ASM("asm/main/nonmatchings/format", Java_xeno_util_Format_floatToIntBits__F);

INCLUDE_ASM("asm/main/nonmatchings/format", Java_xeno_util_Format_intBitsToFloat__I);
